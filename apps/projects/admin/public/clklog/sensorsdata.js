!(function (e, t) {
  ...
  function b(e, t, r, n) {
    function i(e) {
      return (
        e &&
          ((e.preventDefault = i.preventDefault), (e.stopPropagation = i.stopPropagation), (e._getPath = i._getPath)),
        e
      )
    }
    function a(e, t, r, n) {
  ...
  function k(e, t, r) {
    ...
    else for (var a in e) ea.call(e, a) && t.call(r, e[a], a, e)
  }
  function P(e) {
    return (
      ...
      for (var i = '.' + n.splice(n.length - 1, 1); n.length > 0; )
        if (
          ...
          return (
            ...
            (document.cookie = t + '=true; expires=' + a.toGMTString() + '; path=/; SameSite=Lax; domain=' + i),
            i
          )
        }
    return ''
    ...
    return (
      ...
      p(e)
        ? ((e = d(e)),
          ...
          (e = e.slice(0, pa.max_referrer_string_length)),
          p(e) ? e : '')
  ...
  function Ue(e, t) {
    ...
    if (pa.cross_subdomain === !1) {
      ...
      r =
        'string' == typeof r && '' !== r
          ? 'sajssdk_2015_' + pa.sdk_id + e + '_' + r.replace(/\./g, '_')
          : 'sajssdk_2015_root_' + pa.sdk_id + e
  ...
  function Re() {
    var e = 'new_user'
    return ma.isSupport()
      ? null !== ma.get('sensorsdata_is_new_user') || null !== ma.get(Ue(e))
  ...
  function Be() {
    ...
    var t = '(' + pa.source_type.utm.join('|') + ')\\=[^&]+',
      r = pa.source_type.search,
      n = pa.source_type.social,
      i = document.referrer || '',
      a = ba.pageProp.url
    if (a) {
  ...
  function Fe(e) {
    ...
    r(e.properties) &&
      ...
      ('$referrer' in e.properties &&
        (e.properties.$referrer_host = '' === e.properties.$referrer ? '' : q(e.properties.$referrer, n)),
      pa.preset_properties.latest_referrer &&
        pa.preset_properties.latest_referrer_host &&
        (e.properties.$latest_referrer_host =
          '' === e.properties.$latest_referrer ? '' : q(e.properties.$latest_referrer, n)))
  }
  function Ve(e) {
    var t = !e.type || 'profile' !== e.type.slice(0, 7),
      r = pa.preset_properties && t
    r && pa.preset_properties.url && h(e.properties.$url) && (e.properties.$url = Z()),
      r && pa.preset_properties.title && h(e.properties.$title) && (e.properties.$title = document.title)
  }
  function We(e) {
  ...
  function ct(e, t) {
    ...
    return (
      ...
      (e.type && 'profile' === e.type.slice(0, 7)) ||
        ((a.properties = P({}, ba.properties(), $a.getProps(), $a.getSessionProps(), ba.currentProps, a.properties)),
  ...
  function vt(e, t, r) {
    if (Fi.is_first_visitor && r) {
      var n = {}
      Fi.para.preset_properties.search_keyword_baidu &&
        xe(document.referrer) &&
        Ie() &&
        ((n.$search_keyword_id = va.id()),
        (n.$search_keyword_id_type = va.type()),
  ...
  function wt(e, t) {
    ...
    if (l) {
      ;($a._state.identities[a] = n),
        $a.set('history_login_id', { name: a, value: n }),
        o || $a.set('first_id', s),
        t(n, '$SignUp', {}, i)
  ...
  function kt(e, t) {
    ...
    if (r($a._state.identities) && $a._state.identities.hasOwnProperty(e) && $a._state.identities[e] === t) {
      ...
      n &&
        e + '+' + t === n &&
        (($a._state.distinct_id = $a._state.first_id),
        ($a._state.first_id = ''),
        $a.set('history_login_id', { name: '', value: '' })),
  ...
  function Ct(e) {
    ...
    'string' != typeof Fi.para.web_url ||
      ('://' !== Fi.para.web_url.slice(0, 3) && '//' !== Fi.para.web_url.slice(0, 2)) ||
      ('://' === Fi.para.web_url.slice(0, 3)
        ? (Fi.para.web_url = location.protocol.slice(0, -1) + Fi.para.web_url)
        : (Fi.para.web_url = location.protocol + Fi.para.web_url)),
      ya.protocol.serverUrl(),
      Fi.bridge && Fi.bridge.initPara()
    ...
    'object' == typeof Fi.para.source_type &&
      ((Fi.para.source_type.utm = v(Fi.para.source_type.utm) ? Fi.para.source_type.utm.concat(a) : a),
      (Fi.para.source_type.search = v(Fi.para.source_type.search) ? Fi.para.source_type.search.concat(o) : o),
      (Fi.para.source_type.social = v(Fi.para.source_type.social) ? Fi.para.source_type.social.concat(s) : s),
      (Fi.para.source_type.keyword = r(Fi.para.source_type.keyword) ? P(l, Fi.para.source_type.keyword) : l))
    var u = { div: !1 },
      c = ['mark', '/mark', 'strong', 'b', 'em', 'i', 'u', 'abbr', 'ins', 'del', 's', 'sup']
    if ((Fi.para.heatmap && !r(Fi.para.heatmap) && (Fi.para.heatmap = {}), r(Fi.para.heatmap))) {
      ;(Fi.para.heatmap.clickmap = Fi.para.heatmap.clickmap || 'default'),
        (Fi.para.heatmap.scroll_notice_map = Fi.para.heatmap.scroll_notice_map || 'default'),
        (Fi.para.heatmap.scroll_delay_time = Fi.para.heatmap.scroll_delay_time || 4e3),
        (Fi.para.heatmap.scroll_event_duration = Fi.para.heatmap.scroll_event_duration || 18e3),
        (Fi.para.heatmap.renderRefreshTime = Fi.para.heatmap.renderRefreshTime || 1e3),
        (Fi.para.heatmap.loadTimeout = Fi.para.heatmap.loadTimeout || 1e3),
        Fi.para.heatmap.get_vtrack_config !== !0 && (Fi.para.heatmap.get_vtrack_config = !1)
      var p = v(Fi.para.heatmap.track_attr)
        ? U(Fi.para.heatmap.track_attr, function (e) {
            return e && 'string' == typeof e
          })
        : []
      if ((p.push('data-sensors-click'), (Fi.para.heatmap.track_attr = p), r(Fi.para.heatmap.collect_tags)))
        if (Fi.para.heatmap.collect_tags.div === !0) Fi.para.heatmap.collect_tags.div = { ignore_tags: c, max_level: 1 }
        else if (r(Fi.para.heatmap.collect_tags.div)) {
          if (
            (Fi.para.heatmap.collect_tags.div.ignore_tags
              ? v(Fi.para.heatmap.collect_tags.div.ignore_tags) ||
                (Ne('ignore_tags \u53c2\u6570\u5fc5\u987b\u662f\u6570\u7ec4\u683c\u5f0f'),
                (Fi.para.heatmap.collect_tags.div.ignore_tags = c))
              : (Fi.para.heatmap.collect_tags.div.ignore_tags = c),
            Fi.para.heatmap.collect_tags.div.max_level)
          ) {
            var d = [1, 2, 3]
            re(d, Fi.para.heatmap.collect_tags.div.max_level) === -1 && (Fi.para.heatmap.collect_tags.div.max_level = 1)
          }
        } else Fi.para.heatmap.collect_tags.div = !1
      else Fi.para.heatmap.collect_tags = u
    }
    ;(Fi.para.server_url = Ge(Fi.para.server_url)),
      Fi.para.noCache === !0 ? (Fi.para.noCache = '?' + new Date().getTime()) : (Fi.para.noCache = ''),
      Fi.para.callback_timeout > Fi.para.datasend_timeout && (Fi.para.datasend_timeout = Fi.para.callback_timeout),
      Fi.para.heatmap &&
        Fi.para.heatmap.collect_tags &&
        r(Fi.para.heatmap.collect_tags) &&
        k(Fi.para.heatmap.collect_tags, function (e, t) {
  ...
  function Ot() {
    var e = Array.prototype.slice.call(arguments),
      t = e[0],
      r = e.slice(1)
    return 'string' == typeof t && Wa[t]
      ? Wa[t].apply(Wa, r)
      : void ('function' == typeof t
          ? t.apply(Fi, r)
          : Ne('quick\u65b9\u6cd5\u4e2d\u6ca1\u6709\u8fd9\u4e2a\u529f\u80fd' + e[0]))
  }
  function Nt(t, n) {
    function i() {
      return (
        !a.plugin_is_init && a.init(Fi, n),
        (a.plugin_is_init = !0),
        (Fi.modules = Fi.modules || {}),
        (Fi.modules[a.plugin_name || 'unnamed_' + Qa++] = a),
        a
      )
    }
    ...
    return (
      ...
      a && e(a.init)
        ? a.plugin_is_init
          ? a
          : (a.plugin_name || Ne('warning: invalid plugin, plugin_name required.'),
            a.plugin_version
              ? a.plugin_version !== Fi.lib_version &&
                Ne('warning: plugin version not match SDK version. plugin may not work correctly. ')
              : Ne('warning: invalid plugin, plugin version required.'),
            i())
        : (Ne(
            (t.plugin_name || t) +
  ...
  function Tt(e, t) {
    return (
      ...
      (($a._state.identities[e] = t),
      $a.save(),
      void qa.send({ type: 'track_id_bind', event: '$BindID', properties: {} }))
    )
  }
  function It(e, t) {
    var r = kt(e, t)
  ...
  function $t(e, t, r) {
    'object' == typeof e && e.tagName
      ? ft({ ele: e }, t, r, Fi.track)
      : 'object' == typeof e && e.target && e.event && ft(e, t, r, Fi.track)
  }
  function At(e, t, r) {
    return (
      (r = r || {}),
  ...
  function Dt(e, t, r) {
    et({ item_type: e, item_id: t, properties: r }) &&
      qa.sendItem({ type: 'item_set', item_type: e, item_id: t, properties: r || {} })
  }
  function xt(e, t) {
    ...
    et({ propertiesMust: e }) &&
      (k(e, function (t, r) {
        p(t)
          ...
          ? (e[r] = t)
          : (delete e[r],
            Ne('appendProfile\u5c5e\u6027\u7684\u503c\u5fc5\u987b\u662f\u5b57\u7b26\u4e32\u6216\u8005\u6570\u7ec4'))
      }),
  ...
  function Rt(e, t) {
    ...
    p(e) && ((e = {}), (e[n] = 1)),
      et({ propertiesMust: e }) &&
        (r(e)
          ? qa.send({ type: 'profile_increment', properties: e }, t)
          : je('profile_increment\u7684\u503c\u53ea\u80fd\u662f\u6570\u5b57'))
  }
  function Ht(e) {
    ...
    p(e) && ((e = []), e.push(r)),
      v(e)
        ? (k(e, function (e) {
          ...
          qa.send({ type: 'profile_unset', properties: n }, t))
        : je('profile_unset\u7684\u53c2\u6570\u5fc5\u987b\u662f\u6570\u7ec4')
  }
  function Jt(e, t) {
  ...
  function Mt(e, t, r, n) {
    ...
    $a.set('distinct_id', e),
      qa.send({ original_id: i, distinct_id: $a.getDistinctId(), type: 'track_signup', event: t, properties: r }, n)
  }
  function qt(e, t, r, n) {
  ...
  function Vt(e) {
    var t
    if (v(e) && e.length > 0)
      for (t = 0; t < e.length; t++) p(e[t]) && e[t] in ba.currentProps && delete ba.currentProps[e[t]]
    else if (e === !0) for (t in ba.currentProps) delete ba.currentProps[t]
  }
  function Wt(e) {
  ...
  function Xt(e) {
    Fi.log(
      ...
      et({ properties: e }) ? $a.setSessionProps(e) : je('registerSession\u8f93\u5165\u7684\u53c2\u6570\u6709\u8bef')
  }
  function Zt(e) {
    Fi.log(
      ...
      et({ properties: e })
        ? $a.setSessionPropsOnce(e)
        : je('registerSessionOnce\u8f93\u5165\u7684\u53c2\u6570\u6709\u8bef')
  }
  function Gt(t, r) {
  ...
  function Qt(e, t) {
    return (
      'number' == typeof t && (t = String(t)),
      'number' == typeof e && (e = String(e)),
      !!et({ loginIdKey: e }) && (ha.LOGIN === e ? (Gt(t), !1) : void wt({ id: t, callback: null, name: e }, Mt))
    )
  }
  function Yt(e) {
    var t = $a.getFirstId()
    if (t)
      if (($a.set('first_id', ''), e === !0)) {
        var r = Zi()
        $a.set('distinct_id', r)
      } else $a.set('distinct_id', t)
    St({ $identity_cookie_id: $a._state.identities.$identity_cookie_id }),
      $a.set('history_login_id', { name: '', value: '' })
  }
  function er() {
    function e() {
    ...
    return (
      Fi.para.preset_properties.latest_referrer &&
        Fi.para.preset_properties.latest_referrer_host &&
  ...
  function tr() {
    ...
    Fi.heatmap &&
      v(Fi.heatmap.otherTags) &&
      k(Fi.heatmap.otherTags, function (r) {
        e += r + t
      }),
      le() &&
        K() &&
        ...
        (Fi.para.heatmap &&
          Fi.para.heatmap.collect_tags &&
          Fi.para.heatmap.collect_tags.div &&
          be('div, [data-sensors-click]' + t),
        Fi.para.heatmap && Fi.para.heatmap.track_attr && be('[' + Fi.para.heatmap.track_attr.join('], [') + ']' + t),
        '' !== e && be(e))
  }
  function rr(e) {
    var t = this
          ...
          if (i && t.resultCbs[i]) {
            ...
            if (t.resultCbs[i]) {
              ...
              for (var a in t.resultCbs[i].callbacks)
                t.resultCbs[i].callbacks[a].call(null, e), t.resultCbs[i].callbacks.splice(a, 1)
            }
            return
          }
  ...
  function nr(t) {
    try {
      if (Fi.bridge.activeBridge && e(Fi.bridge.activeBridge.handleCommand))
        return Fi.bridge.activeBridge.handleCommand(t)
    } catch (r) {
  ...
  function ir(e) {
    ...
    var r = t(e),
      n = t(Fi.para.server_url)
    if (r.hostname === n.hostname && r.project === n.project) return !0
    if (v(Fi.para.app_js_bridge.white_list))
      for (var i = 0; i < Fi.para.app_js_bridge.white_list.length; i++) {
  ...
  function or() {
    var e = ba.pageProp.url_domain,
      t = {}
    '' === e && (e = 'url\u89e3\u6790\u5931\u8d25')
    var n = Ee(document.referrer, !0)
    if (
      (pa.preset_properties.search_keyword_baidu
        ? xe(document.referrer) &&
          (!Ie() || (r(n) && n.active)
            ? $a._state &&
              $a._state.props &&
              ($a._state.props.$search_keyword_id && delete $a._state.props.$search_keyword_id,
              $a._state.props.$search_keyword_id_type && delete $a._state.props.$search_keyword_id_type,
              $a._state.props.$search_keyword_id_hash && delete $a._state.props.$search_keyword_id_hash)
            : ((t.$search_keyword_id = va.id()),
              (t.$search_keyword_id_type = va.type()),
        ...
        : $a._state &&
          ...
          $a._state.props.$search_keyword_id_hash && delete $a._state.props.$search_keyword_id_hash),
      $a.save(),
      k(pa.preset_properties, function (n, i) {
            ...
            switch (i) {
              ...
              case 'search_keyword':
                Ee()
                  ...
                  : r($a._state) &&
                    r($a._state.props) &&
                    $a._state.props.$latest_search_keyword &&
                    delete $a._state.props.$latest_search_keyword
                break
              case 'landing_page':
        ...
        } else if ('utm' === i && $a._state && $a._state.props)
          for (var o in $a._state.props)
            (0 === o.indexOf('$latest_utm') || (0 === o.indexOf('_latest_') && o.indexOf('_latest_wx_ad_') < 0)) &&
              delete $a._state.props[o]
        else if ($a._state && $a._state.props && '$latest_' + i in $a._state.props)
          delete $a._state.props['$latest_' + i]
        else if ('wx_ad_click_id' == i && $a._state && $a._state.props && n === !1) {
      ...
      var i = ba.campaignParamsStandard('$latest_', '_latest_'),
        a = i.$utms,
        o = i.otherUtms
  ...
  function lr(e) {
    function t() {
      var e = []
      n.touch_app_bridge || e.push(ya.defineMode('1')),
        r(Fi.para.app_js_bridge) || (e.push(ya.defineMode('2')), (n.verify_success = !1)),
        (r(Fi.para.heatmap) && 'default' == Fi.para.heatmap.clickmap) || e.push(ya.defineMode('3')),
        'fail' === n.verify_success && e.push(ya.defineMode('4')),
        new Fi.SDKJSBridge('app_alert').notifyApp({ data: e })
    }
    var n = Fi.bridge.bridge_info
    if (Fi.bridge.hasVisualModeBridge())
      if (r(Fi.para.heatmap) && 'default' == Fi.para.heatmap.clickmap)
        if (r(Fi.para.app_js_bridge) && 'success' === n.verify_success)
          if (e) window.sa_jssdk_app_define_mode(Fi, e)
          else {
            ...
            ;(i = re(a, i) > -1 ? i : 'https:'),
              _e({
                ...
                error: function () {},
                type: 'js',
                url: i + '//static.sensorsdata.cn/sdk/' + Fi.lib_version + '/vapph5define.min.js',
              })
          }
        else t()
      else t()
  ...
  function ur(t) {
    Fi.para.is_track_single_page &&
      za.on('switch', function (n) {
        var i = function (r) {
        ...
        if ('boolean' == typeof Fi.para.is_track_single_page) i()
        else if ('function' == typeof Fi.para.is_track_single_page) {
  ...
  function pr() {
    Fi.readyState.setState(3),
      new Fi.SDKJSBridge('visualized').onAppNotify(function () {
        lr('undefined' != typeof sa_jssdk_app_define_mode ? !0 : !1)
      }),
      lr(!1),
      Fi.bridge.app_js_bridge_v1(),
      ba.initPage(),
      ur(),
      $a.init(),
      or(),
      fr(),
      Fi.readyState.setState(4),
      cr()
  }
  function dr() {
  ...
  function gr() {
    k(io, function (t) {
      var r = Fi[t]
      Fi[t] = function () {
        if (Fi.readyState.state < 3)
          return (
            v(Fi._q) || (Fi._q = []), Ne('calling sdk api before init is deprecated.'), Fi._q.push([t, arguments]), !1
          )
        if (!e(Fi.getDisabled) || !Fi.getDisabled())
          return Fi.readyState.getState()
            ? r.apply(Fi, arguments)
            : void je('\u8bf7\u5148\u521d\u59cb\u5316\u795e\u7b56JS SDK')
      }
    })
  }
  function _r(e, t) {
  ...
  function Pr(t) {
    ...
    if (t.isMatchedWithFilter && !e(t.isMatchedWithFilter))
      return void je('registerPropertyPlugin arguments error, isMatchedWithFilter must be function')
    var r = {
      finalAdjustData: {
        priority: 100,
        entry: function (r) {
  ...
  function Cr(e) {
    e &&
      ...
      (Fi.vapph5collect = Ua),
      (Fi.detectMode = dr),
      (Fi.registerFeature = vr),
      (Fi.registerInterceptor = yr),
      (Fi.commonWays = Wa),
      vr(new Sr(Fi)),
      vr(new kr(Fi)),
      yr('viewStage', yo))
  ...
  function Rr() {
    if (
      ...
      if (
        ...
        return void No('app_js_bridge is not configured, data will not be sent by android bridge.')
      Co.registerInterceptor('sendDataStage', { send: { priority: 60, entry: Hr } }),
  ...
  function Wr() {
    if (
      ((jo = window.SensorsData_APP_JS_Bridge),
      (To = jo && jo.sensorsdata_track),
      (Io = jo && jo.sensorsdata_verify),
      ($o = jo && jo.sensorsdata_visual_verify),
      Ao && !Ao.bridge.activeBridge && (Io || To || $o))
    ) {
      Ao.bridge.activeBridge = os
      var e = Io || To
      if (
        ($o && (e = !!$o.call(jo, JSON.stringify({ server_url: Ao.para.server_url }))),
        (Ao.bridge.bridge_info = { touch_app_bridge: !0, platform: 'android', verify_success: e ? 'success' : 'fail' }),
        !Ao.para.app_js_bridge)
      )
        return void xo('app_js_bridge is not configured, data will not be sent by android obsolete bridge.')
      Ao.registerInterceptor('sendDataStage', { send: { priority: 80, entry: zr } }),
  ...
  function zr(e, t) {
    ...
    if (Io) {
      ...
      return n
        ? (Do.isFunction(r) && r(), t.cancellationToken.cancel(), e)
        : Ao.para.app_js_bridge.is_send
        ? (Ao.debug.apph5({ data: e.data, step: '3.1', output: 'all' }), e)
        : (Do.isFunction(r) && r(), t.cancellationToken.cancel(), e)
    }
    return (
      To && To.call(jo, JSON.stringify(Do.extend({ server_url: Ao.para.server_url }, e.data))),
      Do.isFunction(r) && r(),
      t.cancellationToken.cancel(),
      e
    )
  ...
  function Xr(e) {
    ...
    return t in is.commands
      ? is.commands[t](e, jo)
      : jo && Do.isFunction(jo.sensorsdata_js_call_app)
      ? jo.sensorsdata_js_call_app(JSON.stringify(e))
      : void 0
  }
  function Zr(e, t, r) {
    if ((t && (e.plugin_name = t), r && e.init)) {
  ...
  function ln(e, t) {
    ...
    return _s.bridge.is_verify_success
      ? (gs() &&
          gs().postMessage(
            JSON.stringify({ callType: 'app_h5_track', data: hs.extend({ server_url: _s.para.server_url }, e.data) }),
          ),
        hs.isFunction(r) && r(),
        t.cancellationToken.cancel(),
        e)
  ...
  function fn() {
    if (vs && !vs.bridge.activeBridge && gn()) {
      if (
        ...
        (vs.bridge.bridge_info = { touch_app_bridge: !0, platform: 'ios', verify_success: _n() ? 'success' : 'fail' }),
        !vs.para.app_js_bridge)
      )
        return void bs('app_js_bridge is not configured, data will not be sent by iOS obsolete bridge.')
      vs.registerInterceptor('sendDataStage', { send: { priority: 90, entry: hn } }),
      ...
      if (e && e[0] && 'string' == typeof e[1] && 2 === e[1].split('?').length) {
        ...
        try {
          ;(t = ys.URL(vs.para.server_url).hostname),
            (r = ys.URL(vs.para.server_url).searchParams.get('project') || 'default')
        } catch (n) {
          vs.log(n)
        }
  ...
  function Pn(e, t) {
    ...
    return (
      n.each(o, function (e) {
        if (n.isObject(e))
          n.indexOf(e.events, l) > -1 && i({ properties: e.properties }) && (u = n.extend(u, e.properties))
  ...
  function ri() {
    sl.on('sdkAfterInitAPI', function () {
      ll.isObject(sl.commonWays) && (sl.commonWays.setOnlineState = ni),
        sl.registerInterceptor('sendDataStage', { send: { priority: 40, entry: ti } })
    })
  }
  function ni(e) {
    ...
    ul.on('sdkInitPara', function () {
      ...
      ul.on('sdkAfterInitPara', function () {
        !ul.para.app_js_bridge &&
          ...
          xl.batchInterval(),
          ul.registerInterceptor('sendDataStage', { send: { priority: 100, entry: si } }))
      })
  }
  function ci(e, t, r) {
    if ((t && (e.plugin_name = t), r && e.init)) {
                ...
                : ((i = [
                  ...
                  (j = function (e, r) {
                    var n,
                      ...
                      o = v.call(e) == w,
                      s =
                        (!o && 'function' != typeof e.constructor && t[typeof e.hasOwnProperty] && e.hasOwnProperty) ||
                        y
          ...
          var H,
                      ...
                      if (((i = a.charCodeAt(H)), i < 32)) q()
                        ...
                        switch ((i = a.charCodeAt(++H))) {
                          ...
                          case 117:
                            for (t = ++H, r = H + 4; H < r; H++)
                              (i = a.charCodeAt(H)),
                                (i >= 48 && i <= 57) || (i >= 97 && i <= 102) || (i >= 65 && i <= 70) || q()
                            e += J('0x' + a.slice(t, H))
                            break
                          default:
                            q()
                  ...
                  default:
                    if (((t = H), 45 == i && ((n = !0), (i = a.charCodeAt(++H))), i >= 48 && i <= 57)) {
                      ...
                      if (((i = a.charCodeAt(H)), 101 == i || 69 == i)) {
                        for (
                          i = a.charCodeAt(++H), (43 != i && 45 != i) || H++, r = H;
            ...
            F = function (e) {
              ...
              if (('$' == e && q(), 'string' == typeof e)) {
                ...
                if ('[' == e) {
                  for (t = []; (e = K()), ']' != e; )
                    r ? (',' == e ? ((e = K()), ']' == e && q()) : q()) : (r = !0), ',' == e && q(), t.push(F(e))
                  return t
                }
                if ('{' == e) {
                  for (t = {}; (e = K()), '}' != e; )
                    r ? (',' == e ? ((e = K()), '}' == e && q()) : q()) : (r = !0),
                      (',' != e && 'string' == typeof e && '@' == (N ? e.charAt(0) : e[0]) && ':' == K()) || q(),
                      (t[e.slice(1)] = F(K()))
                  return t
                }
                q()
      ...
      if (e.atob)
        ...
        ;(e.btoa = function (e) {
          ...
          for (var t, n, i, a, o = '', s = 0, l = e.length % 3; s < e.length; ) {
            if ((n = e.charCodeAt(s++)) > 255 || (i = e.charCodeAt(s++)) > 255 || (a = e.charCodeAt(s++)) > 255)
              return ''
            ;(t = (n << 16) | (i << 8) | a),
              (o += r.charAt((t >> 18) & 63) + r.charAt((t >> 12) & 63) + r.charAt((t >> 6) & 63) + r.charAt(63 & t))
          }
  ...
  var Vi,
    Wi = {
      ...
      log: function () {
        ;(Vi || (console && console.log) || function () {}).apply(null, arguments)
      },
    },
    zi = {
      get: function (e) {
    ...
    return l && ((l = i(l) || { randomNum: 0, expireTime: 0 }), l.expireTime > t())
      ...
      : (zi.set(s, JSON.stringify({ randomNum: u, expireTime: t() + r })),
        void setTimeout(function () {
          ;(l = i(zi.get(s)) || { randomNum: 0, expireTime: 0 }),
    ...
    (a.prototype.set = function (e, r, a, o, s) {
      ...
      return u && ((u = i(u) || { randomNum: 0, expireTime: 0 }), u.expireTime > t())
        ...
        : (zi.set(l, JSON.stringify({ randomNum: c, expireTime: t() + a })),
          void setTimeout(function () {
            ;(u = i(zi.get(l)) || { randomNum: 0, expireTime: 0 }),
              u.randomNum === c
                ? zi.set(e, r) && s({ status: 'success' })
                : s({ status: 'fail', reason: 'This key is locked' })
          }, o))
    }),
  ...
  Gi.prototype = {
    ...
    getCssStyle: function (e) {
      ...
      if (t) return t
      var r = null
      if (('function' == typeof window.getMatchedCSSRules && (r = window.getMatchedCSSRules(this.ele)), !r || !v(r)))
        return null
  ...
  var Yi = Array.prototype.forEach,
    ...
    ra = {
      ...
      set: function (e, t, r, n, i, a, o) {
        ...
        e && (g = s(e)),
          t && (_ = s(t)),
          l && (h = s(l)),
          g && _ && (document.cookie = g + '=' + encodeURIComponent(_) + u + '; path=/' + h + d + c)
      },
      remove: function (e, t) {
        this.set(e, '1', -1, t)
      },
  ...
  var fa = 'utm_source utm_medium utm_campaign utm_content utm_term',
    ga = '1.25.15',
    _a = 'sensorsdata_domain_test',
    ha = { EMAIL: '$identity_email', MOBILE: '$identity_mobile', LOGIN: '$identity_login_id' },
    ma = {
      get: function (e) {
        return ra.get(e)
      },
    ...
    ya = {
      ...
      protocol: {
        ...
        serverUrl: function () {
          p(pa.server_url) &&
            '' !== pa.server_url &&
            !this.protocolIsSame(pa.server_url, location.href) &&
            Ne(
    ...
    ba = {
      initPage: function () {
        var e = De(),
          t = Z(),
          r = Te(t)
        r || ya.jssdkDebug('url_domain\u5f02\u5e38_' + t + '_' + r),
          (this.pageProp = {
            referrer: e,
            referrer_host: e ? q(e) : '',
            url: t,
  ...
  var wa = {
    ...
    Sa = {
      ...
      setDeviceId: function (e, t) {
        var r = null,
          n = ma.get('sensorsdata2015jssdkcross' + Fi.para.sdk_id)
        n = Fi.kit.userDecryptIfNeeded(n)
        var i = {}
        null != n && ue(n) && ((i = JSON.parse(n)), i.$device_id && (r = i.$device_id)),
          (r = r || e),
          Fi.para.cross_subdomain === !0
            ? t.set('$device_id', r)
            : ((i.$device_id = r),
              (i = JSON.stringify(i)),
              Fi.para.encrypt_cookie && (i = Fi.kit.userEncrypt(i)),
              ma.set('sensorsdata2015jssdkcross' + Fi.para.sdk_id, i, null, !0)),
          Fi.para.is_track_device_id && (ba.currentProps.$device_id = r)
      },
      storeInitCheck: function () {
        if (Fi.is_first_visitor) {
          ...
          ma.isSupport()
            ? ma.set(Ue('new_user'), '1', 3600 * t.h + 60 * t.m + t.s + 's')
            : wa.set(wa.getNewUserFlagMemoryKey('new_user'), '1', 3600 * t.h + 60 * t.m + t.s + 's'),
  ...
  Ye.prototype = {
    ...
    getServerUrl: function () {
      return (p(pa.server_url) && '' !== pa.server_url) || (v(pa.server_url) && pa.server_url.length)
        ? void (this.serverUrl = v(pa.server_url) ? pa.server_url[0] : pa.server_url)
        : je(
            '\u5f53\u524d server_url \u4e3a\u7a7a\u6216\u4e0d\u6b63\u786e\uff0c\u53ea\u5728\u63a7\u5236\u53f0\u6253\u5370\u65e5\u5fd7\uff0cnetwork \u4e2d\u4e0d\u4f1a\u53d1\u6570\u636e\uff0c\u8bf7\u914d\u7f6e\u6b63\u786e\u7684 server_url\uff01',
          )
    },
    ...
    updateExpireTime: function () {
      ...
      e &&
        ...
        (e.expireTime = t() + 2 * pa.batch_send.send_interval),
        (e.serverUrl = this.serverUrl),
        zi.set(this.tabKey, JSON.stringify(e)))
    },
    ...
    add: function (e) {
      ...
      null === a
        ? ((this.tabKey = Oa + String(n())), (a = this.generateTabStorageVal()))
        : (a = i(a) || this.generateTabStorageVal()),
        a.data.push(r),
        (a.expireTime = t() + 2 * pa.batch_send.send_interval),
        zi.set(this.tabKey, JSON.stringify(a)),
        Fi.store.saveObjectVal(r, e),
  ...
  var ja = function (e) {
    ;(this.callback = e.callback),
      ...
      (this.img.width = 1),
      (this.img.height = 1),
      pa.img_use_crossorigin && (this.img.crossOrigin = 'anonymous'),
    ...
    $a = {
      ...
      getUnionId: function (e) {
        ...
        return (
          t.login_id &&
            ...
            this._state.history_login_id.name !== ha.LOGIN &&
      ...
      set: function (e, t) {
        ...
        ;(this._state[e] = t),
          ...
          this.save(),
          'distinct_id' === e && r && Ia.tempAdd('changeDistinctId', t)
      },
      change: function (e, t) {
        this._state['_' + e] = t
      },
      ...
      save: function () {
        ...
        Fi.para.encrypt_cookie && (t = Fi.kit.userEncrypt(t)),
          ma.set(this.getCookieName(), t, 73e3, Fi.para.cross_subdomain)
      },
      getCookieName: function () {
        ...
        if (Fi.para.cross_subdomain === !1) {
          ...
          e =
            'string' == typeof e && '' !== e
              ? 'sa_jssdk_2015_' + Fi.para.sdk_id + e.replace(/\./g, '_')
              : 'sa_jssdk_2015_root' + Fi.para.sdk_id
      ...
      init: function () {
        function e(e) {
          ...
          ;(e.identities && r(e.identities) && !oe(e.identities)) ||
            ((e.identities = {}), (e.identities.$identity_cookie_id = Zi())),
            ...
            if (o && e.identities.hasOwnProperty(o)) {
              if (e.identities[o] !== n.login_id) {
                ...
                for (t in e.identities)
                  e.identities.hasOwnProperty(t) && '$identity_cookie_id' !== t && t !== o && delete e.identities[t]
              ...
              for (t in e.identities)
                e.identities.hasOwnProperty(t) && '$identity_cookie_id' !== t && t !== s && delete e.identities[t]
        ...
        function t(e) {
          $a.set('distinct_id', e),
            $a.set('identities', { $identity_cookie_id: e }),
            $a.set('history_login_id', { name: '', value: '' })
        }
        ...
        var n,
          a,
          o = Zi()
        ma.isSupport() && ((n = ma.get(this.getCookieName())), (n = Fi.kit.userDecryptIfNeeded(n)), (a = i(n))),
          ma.isSupport() && null !== n && ue(n) && r(a) && (!r(a) || a.distinct_id)
            ? (($a._state = P(e(a))), $a.save())
            : ((Fi.is_first_visitor = !0), t(o)),
  ...
  ;(Ea.initUrl = function () {
    ...
    if (!se(Fi.para.server_url))
      return je('----vcollect---server_url\u5fc5\u987b\u4e3a\u6709\u6548 URL \u5b57\u7b26\u4e32'), !1
    try {
      ;(e = g(Fi.para.server_url)),
    ...
    (Ea.configIsMatch = function (e, t) {
      return (
        ...
        (t.element_field && t['function'] ? Ea.configIsMatchNew(e, t) : Ea.configIsMatchOldVersion(e, t))
      )
    }),
        ...
        '$WebClick' === e.event &&
          k(t, function (t) {
            r(t) &&
              ...
              Ea.configIsMatch(e.properties, t.event) &&
              i.push(t)
          }),
        i
      )
    ...
    (Ea.getProp = function (e, t) {
      ...
      if (!(p(e.name) && e.name.length > 0))
        return Ne('----vcustom----\u5c5e\u6027\u540d\u4e0d\u5408\u6cd5,\u5c5e\u6027\u629b\u5f03', e.name), !1
      var n,
        i,
        a = {}
      if ('content' === e.method) {
        ...
        if (p(e.element_selector) && e.element_selector.length > 0) o = J(e.element_selector)
          ...
          if (!t || !p(e.list_selector))
            return Ne('----vcustom----\u5c5e\u6027\u914d\u7f6e\u5f02\u5e38\uff0c\u5c5e\u6027\u629b\u5f03', e.name), !1
        ...
        if (!o || !_(o))
          return (
            Ne('----vcustom----\u5c5e\u6027\u5143\u7d20\u83b7\u53d6\u5931\u8d25\uff0c\u5c5e\u6027\u629b\u5f03', e.name),
            !1
          )
        ...
        if (e.regular) {
          ...
          if (!v(i) || !p(i[0]))
            return (
              Ne('----vcustom----\u6b63\u5219\u5904\u7406\u5f02\u5e38\uff0c\u5c5e\u6027\u629b\u5f03', e.name, i), !1
            )
          n = i[0]
        }
      ...
      geth5Props: function (e) {
        ...
        return (
          t.sensorsdata_app_visual_properties &&
            (t.sensorsdata_app_visual_properties = j(JSON.stringify(t.sensorsdata_app_visual_properties))),
          t
        )
      },
      initAppGetPropsBridge: function () {
        var e = this,
          t = new Fi.SDKJSBridge('getJSVisualProperties')
        return (
    ...
    Ra = {
      ...
      isTargetEle: function (e) {
        ...
        for (var n = 0; n < this.events.length; n++)
          if (r(this.events[n]) && r(this.events[n].event) && Ba.configIsMatch(t, this.events[n].event)) return !0
        return !1
      },
    },
    Ha = {
      ...
      getProp: Ea.getProp,
      getPropElInLi: Ea.getPropElInLi,
      filterConfig: Ea.filterConfig,
    },
    Ba = {
      unlimitedDiv: Ra,
      ...
      init: function () {
        ...
        if ((zi.isSupport() || (this.storageEnable = !1), !this.initUrl()))
          return (
            je('----vtrackcustom----\u521d\u59cb\u5316\u5931\u8d25\uff0curl\u4fe1\u606f\u89e3\u6790\u5931\u8d25'), !1
          )
        ...
        var e = this,
          t = function (t, n) {
            ...
            200 === t
              ...
              : 304 === t
              ? (i = e.config)
              : (je('----vtrackcustom----\u6570\u636e\u5f02\u5e38', t), e.updateConfig(i)),
              e.updateStorage(i),
              e.setNextFetch()
          },
          n = function (t) {
            ;(e.update_time = new Date().getTime()),
              je('----vtrackcustom----\u914d\u7f6e\u62c9\u53d6\u5931\u8d25', t),
              e.setNextFetch()
          }
  ...
  var Ka = {
    ...
    Va = {
      ...
      isDivLevelValid: function (e) {
        for (
          ...
          if (Va.getDivLevels(r[n], e) > t) return !1
        return !0
      },
      ...
      setNotice: function (e) {
        ;(Fi.is_heatmap_render_mode = !0),
          ...
          Fi.para.heatmap_url ||
            (Fi.para.heatmap_url = gt() + '//static.sensorsdata.cn/sdk/' + Fi.lib_version + '/heatmap.min.js')
      },
      ...
      selector: function (e, t) {
        ...
        return e.getAttribute &&
          ...
          (!Fi.para.heatmap || (Fi.para.heatmap && 'not_use_id' !== Fi.para.heatmap.element_selector)) &&
          !t
          ? '#' + e.getAttribute('id')
      ...
      getDomSelector: function (e, t, r) {
        ...
        return e && 'body' !== n && 1 == e.nodeType
          ? (t.unshift(this.selector(e, r)),
            ...
            /^[A-Za-z][-A-Za-z0-9_:.]*$/.test(e.getAttribute('id')) &&
            Fi.para.heatmap &&
            'not_use_id' !== Fi.para.heatmap.element_selector &&
            !r
              ? t.join(' > ')
      ...
      getEleDetail: function (e) {
        ...
        ;(r.$element_selector = t ? t : ''),
          (r.$element_path = Fi.heatmap.getElementPath(
            e,
            Fi.para.heatmap && 'not_use_id' === Fi.para.heatmap.element_selector,
          ))
        var n = Fi.heatmap.getElementPosition(
          e,
          r.$element_path,
          Fi.para.heatmap && 'not_use_id' === Fi.para.heatmap.element_selector,
        )
      ...
      isStyleTag: function (e, t) {
        ...
        return (
          !(re(n, e) > -1) &&
          (!t || (Fi.para.heatmap && Fi.para.heatmap.collect_tags && Fi.para.heatmap.collect_tags.div)
            ? !!(
                r(Fi.para.heatmap) &&
                r(Fi.para.heatmap.collect_tags) &&
                r(Fi.para.heatmap.collect_tags.div) &&
                v(Fi.para.heatmap.collect_tags.div.ignore_tags) &&
                re(Fi.para.heatmap.collect_tags.div.ignore_tags, e) > -1
              )
            : re(i, e) > -1)
        )
      },
      ...
      initScrollmap: function () {
        ...
        var t = !0
        Fi.para.scrollmap &&
          e(Fi.para.scrollmap.collect_url) &&
        ...
        var n = function (e) {
          ...
          i = n({
            ...
            func: function (e, t) {
              ...
              ;((i > Fi.para.heatmap.scroll_delay_time && r - e.$viewport_position !== 0) || t) &&
                ((e.$url = Z()),
                (e.$title = document.title),
                (e.$url_path = G()),
                (e.event_duration = Math.min(Fi.para.heatmap.scroll_event_duration, parseInt(i) / 1e3)),
      ...
      initHeatmap: function () {
        var t = this,
          n = !0
        return (
          !(!r(Fi.para.heatmap) || 'default' !== Fi.para.heatmap.clickmap) &&
          (e(Fi.para.heatmap.collect_url) &&
            this.listenUrlChange(function () {
              n = !!Fi.para.heatmap.collect_url()
            }),
          'all' === Fi.para.heatmap.collect_elements
            ? (Fi.para.heatmap.collect_elements = 'all')
            : (Fi.para.heatmap.collect_elements = 'interact'),
          void ('all' === Fi.para.heatmap.collect_elements
            ...
            : He(document, 'click', function (e) {
                ...
                var a = i.target || i.srcElement,
                  o = Fi.heatmap.getTargetElement(a, e)
                o
                  ? t.start(i, o, o.tagName.toLowerCase())
                  : _(a) &&
                    'div' === a.tagName.toLowerCase() &&
                    r(Fi.para.heatmap) &&
                    Fi.para.heatmap.get_vtrack_config &&
                    Ra.events.length > 0 &&
                    Ra.isTargetEle(a) &&
    ...
    Wa = {
      ...
      setProfileLocal: function (e) {
        ...
        var t = $a.readObjectVal('sensorsdata_2015_jssdk_profile'),
          n = !1
        if (r(t) && !oe(t)) {
      ...
      autoTrackSinglePage: function (e, t) {
        function n(e, t) {
          Fi.track('$pageview', P({ $referrer: i, $url: Z(), $url_path: G(), $title: document.title }, e, mt()), t),
            (i = Z())
        }
        var i
      ...
      autoTrack: function (e, t) {
        ...
        e.not_set_profile && delete e.not_set_profile
        var a = location.href
        Fi.para.is_single_page &&
          w(function () {
            var r = De(a, !0)
            Fi.track('$pageview', P({ $referrer: r, $url: Z(), $url_path: G(), $title: document.title }, n, e), t),
              (a = Z())
          }),
          Fi.track(
            '$pageview',
            P({ $referrer: De(null, !0), $url: Z(), $url_path: G(), $title: document.title }, n, e),
            t,
          ),
          vt(Fi.setOnceProfile, !0, i),
          (this.autoTrackIsUsed = !0)
      },
      getAnonymousID: function () {
        return oe($a._state)
          ? 'SDK is not initialized.'
          : $a._state._first_id || $a._state.first_id || $a._state._distinct_id || $a._state.distinct_id
      },
          ...
          void k(t, function (t, n) {
            e(t) &&
              (r(window.SensorsDataWebJSSDKPlugin) && window.SensorsDataWebJSSDKPlugin[n]
                ...
                : r(Fi.modules) && Fi.modules[n]
                ? t(window.SensorsDataWebJSSDKPlugin[n])
                : Ne(n + 'is not found,please check sensorsdata documents.'))
          })
        )
      },
  ...
  var eo = P({}, la, Ta),
    to = {
      ...
      initPara: function () {
        ...
        'object' == typeof Fi.para.app_js_bridge
          ? (Fi.para.app_js_bridge = P({}, e, Fi.para.app_js_bridge))
          : (Fi.para.use_app_track !== !0 &&
              Fi.para.app_js_bridge !== !0 &&
              'only' !== Fi.para.use_app_track &&
              'mui' !== Fi.para.use_app_track) ||
            (Fi.para.app_js_bridge = P({}, e)),
          Fi.para.app_js_bridge.is_send === !1 &&
            Ne(
      ...
      t &&
        (this.timerId = setTimeout(function () {
          ...
          for (var e in r.timeoutCbs[i].callbacks)
            r.timeoutCbs[i].callbacks[e].call(null), r.timeoutCbs[i].callbacks.splice(e, 1)
        }, t)),
      nr(a),
      {
        onResult: function (e) {
          return r.resultCbs[i].result
            ...
            : (!r.timeoutCbs[i].isTimeout && r.resultCbs[i].callbacks.push(e), this)
        },
        onTimeout: function (e) {
          return r.timeoutCbs[i].isTimeout
            ? (e(), this)
            : (!r.resultCbs[i].result && r.timeoutCbs[i].callbacks.push(e), this)
        },
      }
    )
  }),
  ...
  var ro = {
      ...
      hasKeywordHandle: function () {
        ...
        if ((Va.setNotice(n), ia.isSupport()))
          if (
              ...
              success: function () {
                setTimeout(function () {
                  'undefined' != typeof sa_jssdk_heatmap_render &&
                    (sa_jssdk_heatmap_render(Fi, e, t, r),
                    'object' == typeof console &&
                      'function' == typeof console.log &&
                      ((Fi.heatmap_version && Fi.heatmap_version === Fi.lib_version) ||
                        Ne(
    ...
    no = {
      ...
      isSearchHasKeyword: function () {
        return (
          (sr('sa-visual-mode') === !0 || 'true' === sr('sa-visual-mode')) &&
      ...
      loadVtrack: function () {
        _e({
          ...
          error: function () {},
          type: 'js',
          url: Fi.para.vtrack_url
            ? Fi.para.vtrack_url
            : gt() + '//static.sensorsdata.cn/sdk/' + Fi.lib_version + '/vtrack.min.js',
        })
      },
      messageListener: function (e) {
        ...
        if ('v-track-mode' === e.data.type) {
          if (e.data.data && e.data.data.isVtrack)
            if (
              (ia.isSupport() && sessionStorage.setItem('sensors-visual-mode', 'true'),
      ...
      postMessage: function () {
        try {
          window.parent &&
            ...
            window.parent.postMessage({ source: 'sa-web-sdk', type: 'v-is-vtrack', data: { sdkversion: ga } }, '*')
        } catch (e) {
  ...
  ;(mr.prototype.process = function (e, t) {
    ...
    if (r && v(r) && r.length > 0)
      for (var n = { current: 0, total: r.length }, i = new hr(t, n, Fi), a = 0; a < r.length; a++)
        try {
  ...
  ;(vo.buildData = function (e) {
    ...
    (vo.sendData = function (e, t) {
      var r = qe(e.properties),
        n = { server_url: Fi.para.server_url, data: e, config: r || {}, callback: t }
      wr(n), Fi.log(e)
    }),
  ...
  ;(Fi.init = function (e) {
    return (
      Za.sdk.emit('beforeInit'),
      !(Fi.readyState && Fi.readyState.state && Fi.readyState.state >= 2) &&
        (wo && (Cr(!0), gr()),
        Za.initSystemEvent(),
        Fi.setInitVar(),
        Fi.readyState.setState(2),
        Fi.initPara(e),
        Za.sdk.emit('initPara'),
        Za.sdk.emit('afterInitPara'),
        Za.sdk.emit('initAPI'),
        Za.sdk.emit('afterInitAPI'),
        Fi.detectMode(),
        tr(),
        Za.sdk.emit('afterInit'),
        void Za.sdk.emit('ready'))
    )
  }),
    wo ? Cr(!1) : (Cr(!0), gr())
  var So,
    ...
    Qo = {
      init: function (e) {
        ;(Co = e), (Oo = Co && Co._), (No = (Co && Co.log) || (console && console.log) || function () {}), Rr()
      },
      handleCommand: Br,
    },
    Yo = Ur(Qo, 'AndroidBridge', 'sdkAfterInitPara'),
    ...
    os = {
      init: function (e) {
        ;(Ao = e), (Do = Ao && Ao._), (xo = (Ao && Ao.log) || (console && console.log) || function () {}), Wr()
      },
      handleCommand: Xr,
    },
    ss = Vr(os, 'AndroidObsoleteBridge', 'sdkAfterInitPara'),
    ls = '1.25.15',
    us = {
      event_list: [],
    ...
    cs = Qr(us, 'SensorsChannel', 'sdkAfterInitAPI'),
    ps = '1.25.15',
    ds =
  ...
  var fs,
    ...
    Is = {
      ...
      init: function (e) {
        ...
        if (
          (arguments.length > 0 &&
            (1 === arguments.length && Cs(arguments[0])
              ? (t = arguments[0])
              : arguments.length >= 2 && Cs(arguments[1]) && (t = arguments[1])),
          !Ps())
        )
          return (
        ...
        if (
          (Cs(t) && this.sd._.isNumber(t.timeout) && t.timeout >= 2500 && (this.timeout = t.timeout),
      ...
      openDeepLink: function () {
        ...
        if ('iOS' === ks) {
          ...
          this.log('\u5f53\u524d\u7cfb\u7edf\u662f android'),
            js(this, this.data.android_info.url_schemes, this.data.android_info.download_url)
      },
      log: function (e) {
    ...
    $s = tn(Is, 'Deeplink', 'sdkReady'),
    As = '1.25.15',
    Ds = {
      init: function (e) {
        ;(_s = e), (hs = _s && _s._), (ms = (_s && _s.log) || (console && console.log) || function () {}), sn()
      },
      handleCommand: un,
    },
    xs = on(Ds, 'IOSBridge', 'sdkAfterInitPara'),
    Es = '1.25.15',
    Ls = {
      init: function (e) {
        ;(vs = e), (ys = vs && vs._), (bs = (vs && vs.log) || (console && console.log) || function () {}), fn()
      },
    },
    Us = dn(Ls, 'IOSObsoleteBridge', 'sdkAfterInitPara'),
    Rs = '1.25.15',
    Hs = 5e3,
    Bs = 432e3
  ;(bn.prototype.init = function (e, t) {
    ...
    (bn.prototype.pageStartHandler = function () {
      ;(this.start_time = +new Date()),
        !document.hidden == !0 ? (this.page_show_status = !0) : (this.page_show_status = !1),
        (this.url = location.href),
        (this.title = document.title)
    }),
    ...
    (bn.prototype.isCollectUrl = function (e) {
      return (
        'function' != typeof this.option.isCollectUrl || 'string' != typeof e || '' === e || this.option.isCollectUrl(e)
      )
    }),
    ...
    Fs = {
      init: function (e, t) {
        ...
        function a() {
          ...
          if (
            (s ? ((o = i(s) || n(s)), r(s, l)) : e.log('\u6d4f\u89c8\u5668\u672a\u652f\u6301 performance API.'), o > 0)
          ) {
  ...
  var zs,
      ...
      init: function (e) {
        return (
          ...
          e && e.kit && e.kit.buildData
            ? ((Xs = zs.kit.buildData),
              (zs.kit.buildData = An),
              void Ys('RegisterPropertyPageHeight \u63d2\u4ef6\u521d\u59cb\u5316\u5b8c\u6210'))
            : void Ys(
    ...
    tl = $n(el, 'RegisterPropertyPageHeight', 'sdkReady'),
    rl = '1.25.15',
    nl = {}
            ...
            (n
              ? (this.sd.identify(r, !0),
                this.store.getFirstId() &&
                  this.sd.saEvent.send(
                    { original_id: r, distinct_id: t, type: 'track_signup', event: '$SignUp', properties: {} },
                    null,
                  ))
  ...
  var il,
    ...
    Ol = Jn(Cl, 'DisableSDK', 'sdkInitAPI'),
    Nl = '1.25.15',
    jl = {
    ...
    Xl = {
      init: function (e) {
        e &&
          ((Vl = e),
          (Wl = Vl._),
          Vl.logger && Vl.logger.appendWriter(Ei),
          Vl.on &&
    ...
    Zl = xi(Xl, 'ConsoleLogger'),
    Gl = 'sensorsdata_jssdk_debug'
  Fi.modules = Fi.modules || {}
  for (
    var Ql = [Zl, Fo, Yo, ss, cs, $s, xs, Us, Ms, Vs, Gs, tl, ml, wl, Ol, Tl, Al, Ll, Hl, Ml, Fl],
      Yl = [Zl, Mo, wl, Ol, Al, Tl, Yo, xs, ss, Us, Ll, Hl, Ml, Fl],
      eu = 0;
    eu < Ql.length;
    eu++
  ) {
    var tu = Ql[eu]
    Fi._.isString(tu.plugin_name)
      ? (Fi.modules[tu.plugin_name] = tu)
      : Fi._.isArray(tu.plugin_name) &&
        Fi._.each(tu.plugin_name, function (e) {
          Fi.modules[e] = tu
        })
  }
  ...
  try {
    'string' == typeof window.sensorsDataAnalytic201505
      ? ((Fi.para = window[sensorsDataAnalytic201505].para),
        (Fi._q = window[sensorsDataAnalytic201505]._q),
        (window[sensorsDataAnalytic201505] = Fi),
        (window.sensorsDataAnalytic201505 = Fi),
        Fi.init())
