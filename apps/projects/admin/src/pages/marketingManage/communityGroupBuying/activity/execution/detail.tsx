...
import { getMarketingPlatformCbgActivityExecution } from '@apps/apis'
...
const CbgActivityExecution = () => {
  ...
  useEffect(() => {
    getMarketingPlatformCbgActivityExecution({
      id: id,
    }).then((res) => {
      if (res.code !== 1000) {
            ...
            <Space direction="vertical">
              <Row gutter={[48, 48]}>
                ...
                <Col span={4}>
                  <Statistic
                    title="团购佣金金额"
                    value={((activityData.commissionReceived || 0) + (activityData.commissionUnreceived || 0)).toFixed(
                      2,
                    )}
                  />
                </Col>
...
export default CbgActivityExecution
