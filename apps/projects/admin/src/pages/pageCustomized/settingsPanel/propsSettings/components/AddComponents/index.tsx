...
import commodityFloorStoreIcon from './imgs/commodity-floor-store.png'
...
const AddComponents: React.FC<IProps> = ({ layoutType }) => {
  ...
  const options = useMemo(() => {
    const list = [
      ...
      {
        img: commodityFloorStoreIcon,
        label: translate('web.resource.shop.shangpinloucengdaidianputuijian'),
        value: WEB_DESIGN_COMPONENT.CommodityStoreFloor,
        status: layoutType !== LAYOUT_TYPE.cpecialPage,
      },
      {
        img: couponIcon,
