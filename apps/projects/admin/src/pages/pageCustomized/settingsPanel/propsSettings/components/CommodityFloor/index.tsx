...
import { Col, Form, Input, Popconfirm, Row, Select, Slider, Space, TreeSelect, message } from 'antd'
...
const CommodityFloor: React.FC<IProps> = (props) => {
  ...
  const onChooseCommodityConfirm = (chooseList: any) => {
    ...
    if ([...list, ...newList].length > 8) {
      message.info(translate('web.resource.shop.zuiduotuijiancountgeshangpin', { count: 8 }))
      return
    }
