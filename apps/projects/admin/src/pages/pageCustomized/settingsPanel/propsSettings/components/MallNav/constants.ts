...
export const NAV_TYPE_OPTION = [
  ...
  {
    value: NAV_TYPE.askPurchase,
    label: translate('web.resource.mall.nav-askPurchase'),
  },
  {
    value: NAV_TYPE.stores,
    label: translate('web.resource.mall.nav-stores'),
  },
]
