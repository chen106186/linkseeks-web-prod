  ...
  const columns: RecordColumns<any>[] = [
    {
      ...
      render: (text, record) => {
        const url = `/settlementManage/platformSettlement/coupon/detail?id=${record.id}`
    ...
    { title: '结算金额', key: 'amount', render: (text) => `￥${priceFormat(text)}` },
    {
      title: '结算日期',
      key: 'settlementDate',
      searchField: {
    ...
    { title: '实际支付时间', key: 'settlementTime' },
