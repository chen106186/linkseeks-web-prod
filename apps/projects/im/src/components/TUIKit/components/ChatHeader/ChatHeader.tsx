...
function UnMemoizedTUIChatHeader<T extends TUIChatHeaderProps>(props: PropsWithChildren<T>): React.ReactElement {
  const {
    title,
  ...
  const TUIChatHeaderUIComponent = propTUIChatHeader || ContextTUIChatHeader || ChatHeaderDefault
...
export const ChatHeader = React.memo(UnMemoizedTUIChatHeader) as typeof UnMemoizedTUIChatHeader
