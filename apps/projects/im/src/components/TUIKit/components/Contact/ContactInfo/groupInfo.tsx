...
export function UnMemoizedGroupInfo<T extends Props>(props: T): React.ReactElement {
  ...
  return (
    <>
      <div className="tui-contact-info-header">
        {isH5 && <Icon width={9} height={16} type={IconTypes.BACK} onClick={back} />}
      ...
      <div className="tui-contact-info-content">
        <div className="content-btn-container">
          <div className="content-item-btn confirm-btn" role="button" tabIndex={0} onClick={openGroupConversation}>
