...
const ConversationActions = (props: IConversationActionsProps) => {
  ...
  const defaultConversationActions: Record<string, IConversationActionItem> = {
    delete: {
      ...
      onClick:
        onConversationDelete ||
        ((_conversation: IConversationModel) => {
  ...
  return (
    ...
    >
      <Plugins
        ...
        plugins={
          ...
          Object.keys(conversationActions).map((key: string) => {
            ...
            return (
              <div
                key={key}
                className={cs('uikit-conversation-actions__item', [`uikit-conversation-actions__item--${key}`])}
        ...
        MoreIcon={
          PopupIcon || (
            <Icon className="uikit-conversation-actions__popup-icon" width={16} height={16} type={IconTypes.MORE} />
          )
        }
      />
    </div>
...
export { ConversationActions, IConversationActionsProps, IConversationActionItem, IConversationActionsConfig }
