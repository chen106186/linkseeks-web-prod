...
const ConversationCreateButton = (props: IConversationCreateButtonProps) => {
  const { visible = true, className, onClick, height = 24, width = 24 } = props
  ...
  return (
    <div className={cs('tui-conversation-create-button', className)}>
      <Icon onClick={onClick} type={IconTypes.CREATE} height={height} width={width} />
    </div>
  )
}
