...
function ConversationListHeader<T extends IConversationListHeaderProps>(props: T): React.ReactElement {
  const { children, left, right, className, style } = props

  return (
    <div className={cs('uikit-chat-list__header', className)} style={style}>
