...
import {
  ConversationSearchInput as DefaultConversationSearchInput,
  type IConversationSearchInputProps,
} from './ConversationSearchInput/ConversationSearchInput'
import {
  ConversationSearchResult as DefaultConversationSearchResult,
  type IConversationSearchResultProps,
} from './ConversationSearchResult/ConversationSearchResult'
...
export function defaultSearchFn(searchValue: string, conversationList: IConversationModel[]) {
  ...
  return conversationList.filter((item) =>
    item.getShowName().toLocaleLowerCase().includes(searchValue.toLocaleLowerCase()),
  )
}
