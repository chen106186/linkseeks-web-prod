...
export function MessageAvatar<T extends MessageAvatarProps>(props: PropsWithChildren<T>): React.ReactElement {
  const { className, CustomAvatar, message, showType } = props
