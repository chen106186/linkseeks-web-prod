...
function MessageFaceWithContext<T extends MessageContextProps>(props: PropsWithChildren<T>): React.ReactElement {
...
const MemoizedMessageFace = React.memo(MessageFaceWithContext) as typeof MessageFaceWithContext

export function MessageFace(props: MessageContextProps): React.ReactElement {
  return <MemoizedMessageFace {...props} />
}
