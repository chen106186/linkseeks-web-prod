...
function MessageImageWithContext<T extends MessageContextProps>(props: PropsWithChildren<T>): React.ReactElement {
  ...
  return (
    <div className="message-image">
      ...
      >
        <img
          className={`img ${isH5 ? 'img-h5' : ''} bubble-${message?.flow} 
...
const MemoizedMessageImage = React.memo(MessageImageWithContext) as typeof MessageImageWithContext

export function MessageImage(props: MessageContextProps): React.ReactElement {
  return <MemoizedMessageImage {...props} />
}
