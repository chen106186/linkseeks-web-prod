...
function MessageLocationWithContext<T extends MessageContextProps>(props: PropsWithChildren<T>): React.ReactElement {
...
const MemoizedMessageLocation = React.memo(MessageLocationWithContext) as typeof MessageLocationWithContext

export function MessageLocation(props: MessageContextProps): React.ReactElement {
  return <MemoizedMessageLocation {...props} />
}
