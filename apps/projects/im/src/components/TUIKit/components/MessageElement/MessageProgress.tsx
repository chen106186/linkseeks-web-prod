...
function MessageProgressWithContext<T extends MessageProgressProps>(props: PropsWithChildren<T>): React.ReactElement {
  const { message, children, Progress: propsProgress, isShow: propsIsShow = false } = props
  ...
  const { isShowProgress: contextIsShow = false, Progress: contextProgress } =
    useTUIMessageContext('MessageProgressWithContext')
...
const MemoizedMessageProgress = React.memo(MessageProgressWithContext) as typeof MessageProgressWithContext

export function MessageProgress(props: MessageProgressProps): React.ReactElement {
  return <MemoizedMessageProgress {...props} />
}
