...
export function TUIMessageInputDefault(): React.ReactElement {
  ...
  const { operateData } = useTUIChatStateContext('TUIMessageInputDefault')
  ...
  return (
    <div className="extra-text-input-container">
      <div
      ...
      <button className="extra-submit-btn" onClick={handleSubmit}>
        发送
      </button>
    </div>
  )
