...
export const TUIChatActionContext = React.createContext<TUIChatActionContextValue | undefined>(undefined)
...
export function TUIChatActionProvider({
  ...
  return (
    <TUIChatActionContext.Provider value={value as unknown as TUIChatActionContextValue}>
      {children}
    </TUIChatActionContext.Provider>
  )
}

export const useTUIChatActionContext = (componentName?: string) => {
