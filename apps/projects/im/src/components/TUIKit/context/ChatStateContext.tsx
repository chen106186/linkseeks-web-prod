import React, { PropsWithChildren, useContext, MutableRefObject, RefObject } from 'react'
...
export function TUIChatStateContextProvider({
  children,
  value,
}: PropsWithChildren<{
  value: TUIChatStateContextValue
}>): React.ReactElement {
  return <TUIChatStateContext.Provider value={value}>{children}</TUIChatStateContext.Provider>
}
