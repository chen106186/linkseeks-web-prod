...
export function ComponentProvider({
  ...
  return (
    <ComponentContext.Provider value={value as unknown as ComponentContextValue}>{children}</ComponentContext.Provider>
  )
}

export function useComponentContext(componentName?: string) {
