import React, { PropsWithChildren, ChangeEventHandler, useContext, KeyboardEventHandler, MutableRefObject } from 'react'
...
export function TUIMessageInputContextProvider({
  children,
  value,
}: PropsWithChildren<{
  value: TUIMessageInputContextValue
}>): React.ReactElement {
  return <TUIMessageInputContext.Provider value={value}>{children}</TUIMessageInputContext.Provider>
}
