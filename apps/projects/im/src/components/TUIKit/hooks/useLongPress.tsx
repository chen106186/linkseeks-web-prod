...
export default function useLongPress<T>(
  ...
  { delay = DEFAULT_DURATION, shouldPreventDefault = true, shouldStopPropagation = false }: Options = {},
): UseLongPressType<T> {
  ...
  const clear = useCallback(
    (e: React.MouseEvent<T> | React.TouchEvent<T>, shouldTriggerClick = true, onDrag = false) => {
      if (onDrag) {
