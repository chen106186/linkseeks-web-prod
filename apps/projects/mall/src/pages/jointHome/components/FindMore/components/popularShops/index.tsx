...
import top1Icon from '@/assets/imgs/top1.png'
import top2Icon from '@/assets/imgs/top2.png'
import top3Icon from '@/assets/imgs/top3.png'
  ...
  return (
    <div className={styles.popular_shops}>
      <div className={styles.find_more_title}>
        ...
        <span>{translate('web.resource.mall.paimingmeitianlingchengengxin')}</span>
        <Link className={styles.more_btn} to="/stores">
            ...
            (item, index) =>
              index <= 5 && (
                <a
                  ...
                  href={linkPrefix(`/shop/${item.memberShopId}`)}
                  className={styles.popular_shops_list_item}
                  key={item.memberShopId || index}
                >
                  <div className={styles.popular_shops_rank}>{renderRank(index + 1)}</div>
                  <div className={styles.popular_shops_logo}>
                    <ImageBox width={36} height={36} src={item.memberLogo} alt={item.name} />
                  </div>
