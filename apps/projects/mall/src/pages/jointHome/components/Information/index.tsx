...
import { getManageContentInformationFindAllByRecommendLabel } from '@apps/apis'
...
const Information: React.FC = () => {
  ...
  const toDetailLink = (id: number) => {
    return `${mallUrl?.infoUrl}/infoDetail/${id}`
  }

  const toMoreLink = () => {
    return mallUrl?.infoUrl
  }
      ...
      <div className={styles.information} id="information">
        <div className={styles.information_container}>
          <div className={styles.information_header}>
            ...
            <a href={toMoreLink()} className={styles.more_link}>
                          ...
                          <a href={toDetailLink(item.id)} title={item.title}>
                            <div className={styles.information_recommand}>
                              <div className={styles.information_recommand_img}>
                                <ImageBox width={220} height={146} src={item.imageUrl} alt={item.title} />
                              </div>
