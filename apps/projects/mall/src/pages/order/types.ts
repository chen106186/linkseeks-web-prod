 ...
 * @LastEditTime: 2022-03-15 18:24:19
 * @LastEditors: GHua
 * @Description: 订单相关类型
 */
...
export interface OrderParamType {
  orderContractType?: CONTRACT_TYPE
  orderMode?: number
  /** 门店ID(通过收货地址获取) */
  storeId?: number
  /**
...
export interface PromotionsCommodityType {
  productName: string
  productImgUrl: string
  price: number
  id: number
