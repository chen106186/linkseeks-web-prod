...
import { getMenuButtonBoundingClientRect } from '@apps/mobile-services/utils/taro'
...
const NavBar: React.FC<NavBarProps> = (props: NavBarProps) => {
  ...
  return (
    ...
    >
      ...
      {showExtra && (
        <View
          className={classNames('nav-bar-right-view', {
            'nav-bar-right-view__auto': greedy,
          })}
        >
          {extra}
        </View>
