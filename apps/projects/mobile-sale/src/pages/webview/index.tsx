...
import { setNavigationBarTitle, getCurrentInstance, useDidShow, useRouter } from '@apps/mobile-services/utils/taro'
...
const WebViewPage = () => {
  ...
  return url || webUrl ? (
    <View>
      ...
      customRenderLeft={<View style={{ flex: 2 }}><Icons name='ChevronLeft' size={24} color='#000' onClick={() => Router.reLaunch('root/mine', { hasTab: 'true' })} /></View>}
    /> */}
