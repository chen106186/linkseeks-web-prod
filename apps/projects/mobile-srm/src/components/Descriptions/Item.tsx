...
const DescriptionsItem: React.FC<DescriptionsItemProps> = (props: DescriptionsItemProps) => {
  ...
  const contentNode =
    typeof children !== 'object' ? (
      <View className={classNames('descriptions-item-content', customContentClassName)} style={customContentStyle}>
        {children}
      </View>
    ) : (
      children
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text className={classNames('descriptions-item-colon', customLabelClassName)} style={customLabelStyle}>
          {finalColon}
        </Text>
      </View>
