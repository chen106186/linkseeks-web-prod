import { ElementType } from '../../common/utils/createMemberSchemaUtil'
import { CategoriesItemType } from '../SupplierClassifyInfo'
...
export type SupplierDetailsType = {
   ...
   * 分类信息
   */
  classification?: CategoriesItemType
  /**
   * 内部流转记录
   */
  innerHistory?: {
