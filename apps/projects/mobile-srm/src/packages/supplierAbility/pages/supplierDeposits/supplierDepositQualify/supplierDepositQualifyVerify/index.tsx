...
import { getMemberMobileDepositQualifyDetail, postMemberMobileDepositQualify } from '@apps/apis'
...
type SupplierDepositQualifyVerifyRouteParams = {
  /**
   * 会员审核id
   */
  validateId?: string
...
const SupplierDepositQualifyVerify: React.FC = () => {
  const router = useRouter<SupplierDepositQualifyVerifyRouteParams>()
  const {
    params: { validateId },
  } = router
  ...
  const handleVerifyConfirm = (values: VerifySubmitValueType) => {
    ...
    // 暂无渠道信息
    postMemberMobileDepositQualify({
...
export default SupplierDepositQualifyVerify
