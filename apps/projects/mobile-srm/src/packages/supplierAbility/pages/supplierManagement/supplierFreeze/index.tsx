...
type SupplierFreezeRouteParams = {
  /**
   * 会员审核id
   */
  validateId?: string
...
const SupplierFreeze: React.FC = () => {
  const router = useRouter<SupplierFreezeRouteParams>()
  const {
    params: { validateId },
  } = router
  ...
  return (
    ...
    >
      <View className="supplier-freeze-section">
        <ActionForm actionType="freeze" onSubmit={handleSubmit} />
      </View>
    </PageLayout>
  )
}

export default SupplierFreeze
