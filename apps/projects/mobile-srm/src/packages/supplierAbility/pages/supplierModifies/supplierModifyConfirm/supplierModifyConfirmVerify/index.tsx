...
import { showToast, useRouter, showLoading, hideLoading } from '@apps/mobile-services/utils/taro'
import { Button } from '@apps/mobile-ui'
import Router from '@/utils/router'
import { getMemberMobileModityConfirmDetail, postMemberMobileModityConfirm } from '@apps/apis'
...
type SupplierModifyConfirmVerifyRouteParams = {
  /**
   * 会员审核id
   */
  validateId?: string
...
const SupplierModifyConfirmVerify: React.FC = () => {
  const router = useRouter<SupplierModifyConfirmVerifyRouteParams>()
  const {
    params: { validateId },
  } = router
