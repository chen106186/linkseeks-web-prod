import { nextTick, useReady, createSelectorQuery, getSystemInfoSync } from '@apps/mobile-services/utils/taro'
...
const Echarts: ForwardRefRenderFunction<EchartsHandle, EChartsProps> = (
    ...
    query
      ...
      .exec((res) => {
        ...
        if (result) {
          ...
          const canvasDpr = getSystemInfoSync().pixelRatio
  ...
  const initChart = () => {
    if (IS_WEB && canvasRef.current) {
      ...
      console.log(version, canUseNewCanvas, '----')
      if (canUseNewCanvas) {
