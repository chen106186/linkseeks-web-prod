...
const MellowCard: React.FC<MellowCardProps> = (props: MellowCardProps) => {
  ...
  const titleNode = typeof title !== 'object' ? (
    <Text className='mellow-card-head-title'>
      {title}
    </Text>
  ) : title;
  ...
  const outerTitleNode = typeof outerTitle !== 'object' ? (
    <Text
      className='mellow-card-outerTitle'
      style={outerTitleStyle}
    >
      {outerTitle}
    </Text>
  ) : outerTitle;
  ...
  return (
    <>
      {outerTitle ? (
        <View className='mellow-card-outerTitleWrap'>
          {outerTitleNode}
        </View>
      ) : null}
      <View
        className={classNames('mellow-card', className)}
        style={style}
      >
        {(title || extra) && (
          <View
          ...
          >
            <View className='mellow-card-head-titleWrap'>
              {ribbon && (
                <View className='mellow-card-head-ribbon' />
              )}
              {titleNode}
            </View>
            <View className='mellow-card-head-extra'>
              {extra}
            </View>
          </View>
        )}
