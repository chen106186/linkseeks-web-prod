...
/*
 * @Author: XieZhiXiong
 * @Date: 2021-11-26 20:19:58
 * @LastEditors: XieZhiXiong
 * @LastEditTime: 2021-12-01 15:20:31
 * @Description: 退货发货明细
 */
...
const ExchangeRefundDeliveryDetails: React.FC = () => {
  ...
  return (
    <View className={styles['exchange-refund-delivery-details']}>
      <AsPageHeader
        title={intl.formatMessage({
          id: 'exchangeRecords.exchangeRefundDeliveryDetails.title',
          defaultMessage: '退货发货',
        })}
        extra={
          details && details.returnDeliveryGoodsList && details.returnDeliveryGoodsList.length > 0
            ? intl.formatMessage({
                id: 'exchangeRecords.exchangeRefundDeliveryDetails.returnDeliveryGoodsList',
...
export default GlobalWrapper(ExchangeRefundDeliveryDetails)
