    ...
    <View className={cx(styles['ap'], visible ? styles['ap--active'] : '')}>
      ...
      <View className={cx(styles['ap-container'], visible ? styles['ap-container--active'] : '')}>
        <View className={styles['ap-container-top']}>
          <Text className={styles['ap-container-top-title']}>{intl.formatMessage({ id: 'addressPicker_title' })}</Text>
        </View>
        <View className={styles['flex']}>
          ...
          {tabList.length !== 4 && (
            <View>
              <Text style={{ color: '#C45124' }}>{intl.formatMessage({ id: 'addressPicker_select_btn' })}</Text>
            </View>
          )}
        </View>
