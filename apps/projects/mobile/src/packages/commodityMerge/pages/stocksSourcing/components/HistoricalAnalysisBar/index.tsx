  ...
  return (
    <>
      <View className='historical-bar'>
        <Text className='historical-bar-title'>{intl.formatMessage({id: 'commodityMerge.stocksSourcing.components.historicalAnalysisBar.title',  defaultMessage: '爆料时近期好价' })}</Text>
        <View className='historical-bar-extra'>
          <Icons
            name='Activity'
            size={12}
            color='#F25767'
            className='historical-bar-icon'
          />
          <Shuttle describe={intl.formatMessage({id: 'commodityMerge.stocksSourcing.components.historicalAnalysisBar.check',  defaultMessage: '查看价格走势' })} onJump={handleClick} />
        </View>
      </View>
    </>
  );
