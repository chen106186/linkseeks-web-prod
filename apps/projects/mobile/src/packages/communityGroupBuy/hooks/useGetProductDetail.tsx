...
import {
  getProductMobileShopStoreGetCbgCommodityDetail,
...
const ENTERPRISE_MAP = {
  cbgActivityId: getProductMobileShopStoreGetCbgCommodityDetail,
...
function useGetProductDetail(options: OptionsType) {
  ...
  const currentMode: 'cbgActivityId' | 'commodityId' | 'skuId' = options.cbgActivityId
    ? 'cbgActivityId'
    : options.skuId
    ? 'skuId'
    : 'commodityId'
  ...
  useEffect(() => {
    async function getProductInfo() {
      ...
      const postData =
        currentMode === 'cbgActivityId'
          ? { commodityId: options.commodityId, activityId: options.cbgActivityId }
          : currentMode === 'commodityId'
          ? { commodityId: options.commodityId }
          : { commoditySkuId: options.skuId! }
