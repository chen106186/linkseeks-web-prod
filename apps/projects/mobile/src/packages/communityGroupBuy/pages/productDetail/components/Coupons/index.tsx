...
export const CouponsItem: React.FC<CouponsItemProps> = (props: CouponsItemProps) => {
  ...
  return (
    <View className="marketing-campaign-coupons-item" style={customStyle}>
      <View className="marketing-campaign-coupons-item-wrap">
        <View
          className={classNames(
            'marketing-campaign-coupons-item-circle',
            'marketing-campaign-coupons-item-circle__left',
          )}
        />
        <View
          className={classNames(
            'marketing-campaign-coupons-item-circle',
            'marketing-campaign-coupons-item-circle__right',
          )}
        />
...
const Coupons: React.FC<IProps> = (props: IProps) => {
  ...
  return (
    <View className="marketing-campaign-coupons" style={customStyle}>
      {slice.map((item) => (
        <CouponsItem data={item} key={item.id} />
      ))}
    </View>
  )
}
