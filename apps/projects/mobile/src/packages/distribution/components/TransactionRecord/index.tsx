  ...
  return (
    <View className="transaction">
      <View className="transaction-left">
        <View className="transaction-avatar">
          <ImageBox source={data.logo} className="transaction-avatar-img" />
        </View>
      </View>
      <View className="transaction-center">
        <View className="transaction-name">{data.buyerMemberName}</View>
        <View className="transaction-created">{data.createTime}</View>
      </View>
      <View className="transaction-right">
        <Text className="transaction-quantity">{data.quantity}</Text>
        <Text className="transaction-unit">{data.unit}</Text>
      </View>
    </View>
  )
}
