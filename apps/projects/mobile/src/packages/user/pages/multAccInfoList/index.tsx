...
import { getCurrentInstance, showToast, useRouter } from '@apps/mobile-services/utils/taro'
          ...
          return (
            ...
            >
              <Image
                ...
                src={v.logo || getOssUrlPath('/miniprogram/assets/images/default_avatar.png')}
              />
...
export default GlobalWrapper(MultAccInfoList)
