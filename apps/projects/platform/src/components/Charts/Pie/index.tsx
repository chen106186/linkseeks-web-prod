import { Chart, Axis, Interval, Interaction, Coordinate, Legend, Tooltip } from 'bizcharts'
  ...
  render() {
    ...
    if (percent || percent === 0) {
      ...
      formatColor = (value: string) => {
        if (value === intl.formatMessage({ id: 'components.zhanbi' })) {
      ...
      data = [
        {
          x: intl.formatMessage({ id: 'components.zhanbi' }),
          y: parseFloat(`${percent}`),
        },
        {
          x: intl.formatMessage({ id: 'components.fanbi' }),
