...
const ExchangeReceivedInfo: React.FC<ExchangeReceivedInfoProps> = ({
  ...
  return (
    <MellowCard
      title={intl.formatMessage({
        id: 'afterService.components.ExchangeReceivedInfo.title',
                    ...
                    <Col span={16}>
                      <Descriptions>
                        ...
                        >
                          {isPurchaser ? (
                            <Link
                              to={`/afterAbility/exchangeApplication/exchangePrAddDeliver/deliverDetail?id=${item.deliveryNoId}`}
                            >
                              {item.deliveryNo}
                            </Link>
                          ) : (
                        ...
                        >
                          {!isPurchaser ? (
                            <Link
                              to={`/afterAbility/exchangeManage/exchangePrAddWarehousing/warehousingDetail?id=${item.deliveryNoId}`}
                            >
                              {item.storageNo}
                            </Link>
                          ) : (
                      ...
                      <Descriptions column={2}>
                        ...
                        <Descriptions.Item contentStyle={{ display: 'block', textAlign: 'right' }}>
                          {isEdit &&
                            ...
                            innerStatus === EXCHANGE_INNER_STATUS_UNCONFIRMED_RETURN_DELIVERY && (
                              <a
                                style={{
                                  textAlign: 'right',
                                  display: 'block',
                          ...
                          {isEdit &&
                            ...
                            innerStatus === EXCHANGE_INNER_STATUS_UNCONFIRMED_RETURN_RECEIVE && (
                              <a
                                style={{
                                  textAlign: 'right',
                                  display: 'block',
                          ...
                          {isEdit &&
                            ...
                            innerStatus === EXCHANGE_INNER_STATUS_UNCONFIRMED_RETURN_RECEIPT && (
                              <a
                                style={{
                                  textAlign: 'right',
                                  display: 'block',
