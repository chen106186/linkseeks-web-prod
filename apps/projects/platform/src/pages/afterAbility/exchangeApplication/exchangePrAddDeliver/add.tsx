 ...
 * @LastEditTime: 2021-11-17 19:39:52
 * @Description: 新增退货发货单
 */
...
import { DOC_TYPE_EXCHANGE_RETURN_INVOICE } from '@/constants/commodity'
...
import {
  ...
  postAftersalesReplaceGoodsAddReturnDeliveryGoods,
} from '@apps/apis'
...
const ExchangeAddDeliverBill = () => {
  ...
  return (
    <>
      <BillsFormPage
        relatedType={2}
        billType={DOC_TYPE_EXCHANGE_RETURN_INVOICE}
