 ...
 * @LastEditTime: 2021-11-17 19:40:05
 * @Description: 退货发货单详情
 */
...
import { getAftersalesReplaceGoodsGetReturnDeliveryGoodsDetail } from '@apps/apis'
...
const ExchangeDeliverBillDetail = () => {
  ...
  const fetchRelatedInfo = (): Promise<RelatedInfoDataType> => {
    return new Promise((resolve, reject) => {
      getAftersalesReplaceGoodsGetReturnDeliveryGoodsDetail({
        returnDeliveryId: id,
      })
        .then((res) => {
          if (res.code === 1000) {
