...
import { getAftersalesRepairGoodsPageByConsumer, getAftersalesRepairGoodsPageItems } from '@apps/apis'
  ...
  const defaultColumns: ColumnType<any>[] = [
    {
      ...
      render: (text, record) => (
        <DetailAuthButton>
          <EyeAuthButton url={`/afterAbility/repairApplication/repairQuery/detail?id=${record.applyId}`}>
            {text}
          </EyeAuthButton>
        </DetailAuthButton>
      ),
