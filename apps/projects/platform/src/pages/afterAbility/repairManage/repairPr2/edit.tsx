 ...
 * @LastEditTime: 2021-11-17 19:55:50
 * @Description:
 */
...
import { postAftersalesRepairGoodsVerifyStepTwo } from '@apps/apis'
...
const RepairPr2Verify: React.FC = () => {
  ...
  const handleSubmit = (values) => {
    ...
    postAftersalesRepairGoodsVerifyStepTwo({
      applyId: id,
      ...values,
    })
      .then((res) => {
  ...
  return (
    <>
      <DetailInfo
        id={id}
        target="/afterAbility/repairManage/repairPr2"
        headExtra={() => (
