 ...
 * @LastEditTime: 2021-11-17 20:05:13
 * @Description:
 */
...
import { postAftersalesReturnGoodsVerifyStepOne } from '@apps/apis'
...
const ReturnPr1Verify: React.FC = () => {
  ...
  const handleSubmit = (values) => {
    ...
    postAftersalesReturnGoodsVerifyStepOne({
      applyId: id,
      ...values,
    })
      .then((res) => {
  ...
  return (
    <>
      <DetailInfo
        id={id}
        target="/afterAbility/returnManage/returnPr1"
        headExtra={() => (
