...
const InvoiceList: React.FC<InvoiceListProps> = (props: InvoiceListProps) => {
  ...
  return (
    <Row gutter={[8, 8]} className={styles.invoiceList}>
      ...
      <Col span={6}>
        <div className={styles.title}>{translate('web.resource.balance.kaipiaojine')}</div>
        <div className={styles.content}>
          {translate('web.common.currencySymbol')} {priceFormat(data.invoiceAmount)}
        </div>
      </Col>
      <Col span={6}>
      ...
      <Row gutter={[8, 8]} className={styles.addInvoice}>
        <Col flex="auto">
          <Row gutter={[8, 8]}>
            ...
            <Col span={6}>
              {translate('web.resource.balance.kaipiaojine')}({translate('web.common.currencySymbol')})
              <span className={styles.required}>*</span>
            </Col>
            <Col span={6}>
