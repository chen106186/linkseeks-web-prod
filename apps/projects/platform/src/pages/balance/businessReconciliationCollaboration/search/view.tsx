...
import {
  getSettlementBusinessReconciliationTeamworkBuyerReconciliationList,
  getSettlementBusinessReconciliationItemReconciliationStatus,
  getSettlementBusinessReconciliationTeamworkBuyerReconciliationExport,
} from '@apps/apis'
...
const Search: React.FC = () => {
  ...
  const loadingTableData = async (params) => {
    ...
    const { data } = await getSettlementBusinessReconciliationTeamworkBuyerReconciliationList(_params)
    return data
  }
  ...
  const columns: ColumnType<any>[] = [
    {
      ...
      render: (text: any, record: any) =>
        AuthUrl('detail') ? (
          <Link
            to={`/balance/businessReconciliationCollaboration/search/detail?id=${record.reconciliationId}&no=${text}`}
          >
            {text}
          </Link>
        ) : (
  ...
  const _exportFunc = () => {
    ...
    exportFile(getSettlementBusinessReconciliationTeamworkBuyerReconciliationExport, exportParams)
  }
