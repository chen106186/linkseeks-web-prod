...
import {
  GetSettlementMemberSettlementPagePayableSettlementResponseDetail,
  GetSettlementPlatformScoreSettlementPageReceivableSettlementResponseDetail,
} from '@apps/apis'
  ...
  const columns = [
    {
      ...
      render: (text, record) => {
        return (
          <EyeAuthButton url={`/balance/platformSettlement/integral/detail?id=${record.id}`}>
            {record.settlementNo}
          </EyeAuthButton>
        )
      },
