import { getProductCustomerGetCustomerCategory, getProductCustomerGetCustomerCategoryTree } from '@apps/apis'
import type { GetProductCustomerGetCustomerCategoryResponse } from '@apps/apis'
...
export const useCategoryContextValue = () => {
  ...
  const [selectCategoryInfo, setSelectCategoryInfo] = useState<GetProductCustomerGetCustomerCategoryResponse>()
  ...
  const refreshData = async () => {
    try {
      const { data } = await getProductCustomerGetCustomerCategoryTree()
