...
import { getContractCoordinationPageToBeSubmitExamine } from '@apps/apis'
import { AuthButton } from '@apps/components'
import { customAuthUrl as AuthUrl } from '@apps/domains'

const intl = getIntl()

const pageToBeSubmitExamine = () => {
      ...
      render: (text, record) => (
        <DetailAuthButton>
          <EyeAuthButton
            ...
            url={`/contract/coordination/pageToBeSubmitExamine/detail?contractId=${record.id}&type=submitExamine`}
          >
            {text}
          </EyeAuthButton>
          ...
          <AuthButton type="custom" code="submit">
            <div>
              <span
                ...
                onClick={() =>
                  history.push(
                    `/contract/coordination/pageToBeSubmitExamine/submit?contractId=${record.id}&type=submitExamine&status=submit`,
                  )
                }
              >
  ...
  return (
    <PageHeaderWrapper>
      ...
      <ExamineFrom ExamineFlag={Visible} getfetchData={getfetchData} applyId={id} type="pageToBeSubmitExamine" />
    </PageHeaderWrapper>
  )
}

export default pageToBeSubmitExamine
