      ...
      render: (text, record) => (
        <div>
          <EyeAuthButton
            ...
            url={`${
              isCreatExamine ? '/contract/manage/creatExamine/detail' : '/contract/manage/creatExaminetwo/detail'
              ...
              <span
                ...
                onClick={() =>
                  history.push(
                    `${
                      isCreatExamine
                        ? '/contract/manage/creatExamine/detail'
                        : '/contract/manage/creatExaminetwo/examine'
