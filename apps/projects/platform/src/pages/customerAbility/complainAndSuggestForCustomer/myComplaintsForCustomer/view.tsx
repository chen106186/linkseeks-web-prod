...
import {
  getMemberCustomerComplaintSubPage,
  postMemberCustomerComplaintSubDelete,
  postMemberCustomerComplaintSubSubmit,
  GetMemberCustomerComplaintSubPageRequest,
} from '@apps/apis'
import moment from 'moment'

const MyComplaints: React.FC<{}> = (props) => {
  ...
  const handleSubmit = async (params: { id: number }, type: 'submit' | 'delete') => {
    ...
    const service = type === 'submit' ? postMemberCustomerComplaintSubSubmit : postMemberCustomerComplaintSubDelete
