...
const CountryPhone: React.FC<Iprops> = (props: Iprops) => {
  ...
  return (
    <div className={styles.container}>
      <Select disabled={disable} value={innerValue.code} className={styles.select} onChange={ (selectValue) => handleChange('code', selectValue.toString()) }>
        {
      ...
      <Input disabled={disable} className={styles.input} value={innerValue.phone}  onChange={(e: React.FormEvent<HTMLInputElement>) => handleChange("phone", e.currentTarget.value)}/>
    </div>
  )
}
