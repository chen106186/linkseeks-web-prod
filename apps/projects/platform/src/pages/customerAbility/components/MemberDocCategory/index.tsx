  ...
  const handleSubmit = (value: ValueType) => {
    ...
    const msg = message.loading({
      content: intl.formatMessage({
        id: 'customerAbility.components.MemberDocCategory.edit.message',
  ...
  const data = [
    {
      title: intl.formatMessage({
        id: 'customerAbility.components.MemberDocCategory.code',
        defaultMessage: '会员编号',
      }),
    ...
    {
      title: intl.formatMessage({
        id: 'customerAbility.components.MemberDocCategory.maxAmount',
        defaultMessage: '单次合作金额',
      }),
      value:
    ...
    {
      title: intl.formatMessage({
        id: 'customerAbility.components.MemberDocCategory.classifyAreas',
        defaultMessage: '适用区域',
      }),
    ...
    {
      title: intl.formatMessage({
        id: 'customerAbility.components.MemberDocCategory.partnerTypeName',
        defaultMessage: '会员关系',
      }),
    ...
    {
      title: intl.formatMessage({
        id: 'customerAbility.components.MemberDocCategory.category',
        defaultMessage: '主营品类',
      }),
      value: (
              ...
              <Descriptions column={1}>
                <Descriptions.Item
                  label={intl.formatMessage({
                    id: 'customerAbility.components.MemberDocCategory.category.name',
                    defaultMessage: '品类',
                  })}
                >
                ...
                <Descriptions.Item
                  label={intl.formatMessage({
                    id: 'customerAbility.components.MemberDocCategory.category.paymentDay',
                    defaultMessage: '结算方式',
                  })}
                >
                  {`${item.payTypeName} `}
                  {item.month
                    ? `${intl.formatMessage({
                        id: 'customerAbility.components.MemberDocCategory.month',
                        month: item.month,
                      })}`
                    : ''}
                  {item.monthDay
                    ? `${intl.formatMessage({
                        id: 'customerAbility.components.MemberDocCategory.monthDay',
                        monthDay: item.monthDay,
                      })}`
                    : ''}
                  {item.days
                    ? `${intl.formatMessage({
                        id: 'customerAbility.components.MemberDocCategory.days',
                        days: item.days,
                      })}`
                    : ''}
                </Descriptions.Item>
                ...
                <Descriptions.Item
                  label={intl.formatMessage({
                    id: 'customerAbility.components.MemberDocCategory.category.invoiceTypeName',
                    defaultMessage: '发票类型',
                  })}
                >
                ...
                <Descriptions.Item
                  label={intl.formatMessage({
                    id: 'customerAbility.components.MemberDocCategory.category.taxPoint',
                    defaultMessage: '税点',
                  })}
                >
                  {item.taxPoint}%
