        ...
        value: (
          <div className={styles.changed}>
            ...
            {showNew && ele.fieldType !== 'list' && ele.lastValue && ele.lastValue !== ele.fieldValue && (
              <Tooltip
                title={`${intl.formatMessage({ id: 'customerAbility.components.MemberDocIncomingInfo.before' })}：${
                  ele.lastValue
                }`}
              >
                <span className={styles.new}>
                  {intl.formatMessage({ id: 'customerAbility.components.MemberDocIncomingInfo.new' })}
                </span>
              </Tooltip>
            )}
          </div>
