...
const MemberDocScoredInfo: React.FC<IProps> = (props: IProps) => {
  ...
  const columns: EditableColumns[] = [
    {
      title: intl.formatMessage({
        id: 'customerAbility.components.MemberDocScoredInfo.columns.id',
        defaultMessage: '序号',
      }),
      dataIndex: 'id',
    },
    {
      title: intl.formatMessage({
        id: 'customerAbility.components.MemberDocScoredInfo.columns.subject',
        defaultMessage: '考评主题',
      }),
      dataIndex: 'subject',
      ellipsis: true,
    ...
    {
      title: intl.formatMessage({
        id: 'customerAbility.components.MemberDocScoredInfo.columns.appraisalDayStart',
        defaultMessage: '考评范围',
      }),
    ...
    {
      title: intl.formatMessage({
        id: 'customerAbility.components.MemberDocScoredInfo.columns.completeDay',
        defaultMessage: '考评完成时间',
      }),
      dataIndex: 'completeDay',
    },
    {
      title: intl.formatMessage({
        id: 'customerAbility.components.MemberDocScoredInfo.columns.totalScore',
        defaultMessage: '考评最终分',
      }),
  ...
  return (
    <MellowCard
      title={intl.formatMessage({
        id: 'customerAbility.components.MemberDocScoredInfo.title',
        defaultMessage: '考评信息',
      })}
      {...rest}
    >
