...
const MemberImportRolesModal: React.FC<MemberImportRolesModalProps> = (props) => {
  ...
  return (
    <Modal
      title={intl.formatMessage({ id: 'customerAbility.insteadRegister.import.title', defaultMessage: '选择导入角色' })}
      cancelText={intl.formatMessage({ id: 'common.button.cancel', defaultMessage: '取消' })}
      okText={intl.formatMessage({ id: 'customerAbility.insteadRegister.import.next', defaultMessage: '下一步' })}
      visible={visible}
