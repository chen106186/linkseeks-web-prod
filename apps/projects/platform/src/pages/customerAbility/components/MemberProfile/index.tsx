  ...
  const anchorsArr = [
    {
      ...
      label: intl.formatMessage({
        id: 'customerAbility.components.MemberProfile.verifySteps',
        defaultMessage: '流转进度',
      }),
    },
    {
      key: 'basicInfo',
      label: intl.formatMessage({
        id: 'customerAbility.components.MemberProfile.basicInfo',
        defaultMessage: '基本信息',
      }),
    },
    showChannelInfo &&
    (dataSource?.memberTypeEnum === MEMBER_TYPE_CHANNEL_CORPORATE ||
      ...
      ? {
          key: 'channelInfo',
          label: intl.formatMessage({
            id: 'customerAbility.components.MemberProfile.channelInfo',
            defaultMessage: '渠道信息',
          }),
        }
      : null,
    ...
    (dataSource && dataSource.qualities && dataSource.qualities.length) || editableQualities
      ? {
          ...
          label: intl.formatMessage({
            id: 'customerAbility.components.MemberProfile.qualificationInfo',
            defaultMessage: '资质证明',
          }),
        }
      : null,
    dataSource && dataSource.inspection && dataSource.inspection.inspectDay
      ? {
          key: 'investigateInfo',
          label: intl.formatMessage({
            id: 'customerAbility.components.MemberProfile.investigateInfo',
            defaultMessage: '考察信息',
          }),
        }
      : null,
    (dataSource && dataSource.classification && dataSource.classification.code) || editableCategory
      ? {
          key: 'classifyInfo',
          label: intl.formatMessage({
            id: 'customerAbility.components.MemberProfile.classifyInfo',
            defaultMessage: '分类信息',
          }),
        }
      : null,
    {
      key: 'flowRecords',
      label: intl.formatMessage({
        id: 'customerAbility.components.MemberProfile.flowRecords',
        defaultMessage: '流转记录',
      }),
    },
  ].filter(Boolean)
