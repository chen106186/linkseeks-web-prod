...
const MemberRightsRecords: React.FC<IProps> = (props: IProps) => {
  ...
  const receivedColumns: EditableColumns[] = [
    {
      title: intl.formatMessage({
        id: 'customerAbility.components.MemberRightsRecords.receivedColumns.id',
        defaultMessage: 'ID',
      }),
      dataIndex: 'id',
    },
    {
      title: intl.formatMessage({
        id: 'customerAbility.components.MemberRightsRecords.receivedColumns.rightTypeName',
        defaultMessage: '会员权益名称',
      }),
      dataIndex: 'rightTypeName',
    },
    {
      title: intl.formatMessage({
        id: 'customerAbility.components.MemberRightsRecords.receivedColumns.point',
        defaultMessage: '获取数量',
      }),
      dataIndex: 'point',
    },
    {
      title: intl.formatMessage({
        id: 'customerAbility.components.MemberRightsRecords.receivedColumns.createTime',
        defaultMessage: '获取时间',
      }),
    ...
    {
      title: intl.formatMessage({
        id: 'customerAbility.components.MemberRightsRecords.receivedColumns.remark',
        defaultMessage: '备注',
      }),
      dataIndex: 'remark',
      ellipsis: true,
  ...
  const usageColumns: EditableColumns[] = [
    {
      title: intl.formatMessage({
        id: 'customerAbility.components.MemberRightsRecords.usageColumns.id',
        defaultMessage: 'ID',
      }),
      dataIndex: 'id',
    },
    {
      title: intl.formatMessage({
        id: 'customerAbility.components.MemberRightsRecords.usageColumns.rightTypeName',
        defaultMessage: '会员权益名称',
      }),
      dataIndex: 'rightTypeName',
    },
    {
      title: intl.formatMessage({
        id: 'customerAbility.components.MemberRightsRecords.usageColumns.spendTypeName',
        defaultMessage: '会员权益使用名称',
      }),
      dataIndex: 'spendTypeName',
    },
    {
      title: intl.formatMessage({
        id: 'customerAbility.components.MemberRightsRecords.usageColumns.point',
        defaultMessage: '使用数量',
      }),
      dataIndex: 'point',
    },
    {
      title: intl.formatMessage({
        id: 'customerAbility.components.MemberRightsRecords.usageColumns.createTime',
        defaultMessage: '使用时间',
      }),
      dataIndex: 'createTime',
    },
    {
      title: intl.formatMessage({
        id: 'customerAbility.components.MemberRightsRecords.usageColumns.remark',
        defaultMessage: '备注',
      }),
      dataIndex: 'remark',
      ellipsis: true,
  ...
  const options = [
    {
      label: intl.formatMessage({
        id: 'customerAbility.components.MemberRightsRecords.options.received',
        defaultMessage: '获取记录',
      }),
      value: 'received',
    },
    {
      label: intl.formatMessage({
        id: 'customerAbility.components.MemberRightsRecords.options.usage',
        defaultMessage: '使用记录',
      }),
      value: 'usage',
    },
  ...
  return (
    <MellowCard
      title={intl.formatMessage({
        id: 'customerAbility.components.MemberRightsRecords.title',
        defaultMessage: '权益记录',
      })}
