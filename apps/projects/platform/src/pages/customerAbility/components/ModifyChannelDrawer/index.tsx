...
// import {
//   getMemberCustomerAbilityMaintenanceDetailBasicChannelProvince,
//   getMemberCustomerAbilityMaintenanceDetailBasicChannelCity,
// } from '@apps/apis'
  ...
  return (
    <Drawer
      title={intl.formatMessage({
        id: 'customerAbility.components.ModifyChannelDrawer.title',
        defaultMessage: '修改渠道信息',
      })}
      width={600}
      onClose={handleClose}
      visible={visible}
      footer={
        ...
        >
          <Button onClick={handleClose} style={{ marginRight: 16 }}>
            {intl.formatMessage({ id: 'customerAbility.actions.cancel', defaultMessage: '取消' })}
          </Button>
          <Button onClick={() => formActions.submit()} type="primary" loading={submitLoading}>
            {intl.formatMessage({ id: 'customerAbility.actions.confirm', defaultMessage: '确认' })}
          </Button>
        </div>
      }
    >
