...
export const schema: ISchema = {
  ...
  properties: {
    INVESTIGATE_INFO: {
      ...
      'x-component': 'FlagBox',
      'x-component-props': {
        title: intl.formatMessage({ id: 'customerAbility.management.memberPrComingClassify.drawer.form.classify' }),
      },
      properties: {
        MEGA_LAYOUT: {
          type: 'object',
                ...
                properties: {
                  ...
                  advanceCharge: {
                    ...
                    'x-rules': [
                      {
                        required: true,
                        message: translate('web.common.qingxuanze') + translate('web.resource.member.yufukuang'),
                      },
                    ],
                  },
                  settlementDocuments: {
    ...
    VERIFY_APPLY: {
      ...
      'x-component': 'FlagBox',
      'x-component-props': {
        title: intl.formatMessage({ id: 'customerAbility.management.memberPrComingClassify.drawer.form.verify' }),
      },
      properties: {
        MEGA_LAYOUT: {
          type: 'object',
          ...
          properties: {
            agree: {
              type: 'string',
              title: intl.formatMessage({
                id: 'customerAbility.management.memberPrComingClassify.drawer.form.verify.agree',
              }),
              default: 1,
              'x-component': 'Radio',
              required: true,
              enum: [
                {
                  label: intl.formatMessage({
                    id: 'customerAbility.management.memberPrComingClassify.drawer.form.verify.agree.pass',
                  }),
                  value: 1,
                },
                {
                  label: intl.formatMessage({
                    id: 'customerAbility.management.memberPrComingClassify.drawer.form.verify.agree.noPass',
                  }),
                  value: 0,
                },
              ],
            ...
            reason: {
              type: 'string',
              title: intl.formatMessage({
                id: 'customerAbility.management.memberPrComingClassify.drawer.form.verify.reason',
              }),
              'x-component': 'Textarea',
              'x-component-props': {
                placeholder: intl.formatMessage({
                  id: 'customerAbility.management.memberPrComingClassify.drawer.form.verify.placeholder',
                }),
                rows: 5,
              },
              'x-rules': [
