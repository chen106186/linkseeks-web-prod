...
const expireDayTitle = (
  <span style={{ marginTop: 40 }}>
    {intl.formatMessage({ id: 'customerAbility.components.QualitiesUploadFormItem.endTime', defaultMessage: '到期日' })}
  </span>
)
          ...
          'x-rules': [
            {
              ...
              message: intl.formatMessage({
                id: 'customerAbility.components.QualitiesUploadFormItem.file.placeholder',
                defaultMessage: '请上传资质证明',
              }),
            },
          ],
        },
          ...
          properties: {
            ...
            permanent: {
              ...
              title: intl.formatMessage({
                id: 'customerAbility.components.QualitiesUploadFormItem.permanent',
                defaultMessage: '有效期',
              }),
