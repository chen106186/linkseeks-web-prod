...
export const STATUS_COLOR_TXT = {
  0: intl.formatMessage({ id: 'customerAbility.daishenhe' }),
  1: intl.formatMessage({ id: 'customerAbility.shenhetongguo' }),
  2: intl.formatMessage({ id: 'customerAbility.dongjie' }),
}
...
export const MEMBER_OUTER_COLUMNS: EditableColumns[] = [
  {
    title: intl.formatMessage({ id: 'customerAbility.xuhao' }),
    dataIndex: 'index',
    render: (text, record, index) => index + 1,
  },
  {
    title: intl.formatMessage({ id: 'customerAbility.caozuojuese' }),
  ...
  {
    title: intl.formatMessage({ id: 'customerAbility.caozuoshijian' }),
    dataIndex: 'createTime',
    ellipsis: true,
  },
  {
    title: intl.formatMessage({ id: 'customerAbility.shenheyijian' }),
    dataIndex: 'remark',
    ellipsis: true,
  },
]
...
export const MEMBER_INNER_COLUMNS: EditableColumns[] = [
  ...
  {
    title: intl.formatMessage({ id: 'customerAbility.caozuoren' }),
    dataIndex: 'operatorName',
  },
  {
    title: intl.formatMessage({ id: 'customerAbility.bumen' }),
    dataIndex: 'operatorOrgName',
  },
  {
    title: intl.formatMessage({ id: 'customerAbility.zhiwei' }),
