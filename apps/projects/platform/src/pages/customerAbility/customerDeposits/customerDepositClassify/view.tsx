...
import { getMemberCustomerDepositClassifyPage, getMemberCustomerDepositPageConditions } from '@apps/apis'
...
const customerDepositClassifyIndex: React.FC<{}> = (props) => {
  ...
  const fetchListData = async (params: any) => {
    ...
    const res = await getMemberCustomerDepositClassifyPage(payload)
...
export default customerDepositClassifyIndex
