...
import { getMemberCustomerDepositConfirmDetail, postMemberCustomerDepositConfirm } from '@apps/apis'
import MemberProfile from '../../components/MemberProfile'
import VerifyModal, { ValueType as VerifyData } from '../../components/VerifyModal'

const CustomerDepositConfirmVerify: React.FC<{}> = () => {
  ...
  const handleSubmit = (value: VerifyData) => {
    ...
    postMemberCustomerDepositConfirm(
      {
        validateId,
        ...value,
      },
...
export default CustomerDepositConfirmVerify
