...
import { getMemberCustomerDepositVerifyDetail, GetMemberDepositVerifyDetailResponse } from '@apps/apis'
import { IRequestSuccess } from '@/index'
import MemberProfile from '../../components/MemberProfile'

const CustomerDepositDataDetails: React.FC<{}> = () => {
...
export default CustomerDepositDataDetails
