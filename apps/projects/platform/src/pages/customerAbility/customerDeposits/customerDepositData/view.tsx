...
import {
  getMemberCustomerDepositVerifyPage,
  postMemberCustomerDepositVerifyBatch,
...
const CustomerDepositDataIndex: React.FC<{}> = (props) => {
  ...
  const fetchListData = async (params: any) => {
    ...
    const res = await getMemberCustomerDepositVerifyPage(payload)
...
export default CustomerDepositDataIndex
