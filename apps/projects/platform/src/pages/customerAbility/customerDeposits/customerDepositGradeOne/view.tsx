...
import {
  getMemberCustomerDepositGradeOnePage,
  postMemberCustomerDepositGradeOneBatch,
...
const CustomerDepositGradeOne: React.FC<{}> = (props) => {
  ...
  const fetchListData = async (params: any) => {
    ...
    const res = await getMemberCustomerDepositGradeOnePage(payload)
...
export default CustomerDepositGradeOne
