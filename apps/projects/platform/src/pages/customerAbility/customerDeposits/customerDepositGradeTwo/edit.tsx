...
import { getMemberCustomerDepositGradeTwoDetail, postMemberCustomerDepositGradeTwo } from '@apps/apis'
import MemberProfile from '../../components/MemberProfile'
import VerifyModal, { ValueType as VerifyData } from '../../components/VerifyModal'

const CustomerDepositGradeTwoVerify: React.FC<{}> = () => {
  ...
  const handleSubmit = (value: VerifyData) => {
    ...
    postMemberCustomerDepositGradeTwo(
      {
        validateId,
        ...value,
      },
...
export default CustomerDepositGradeTwoVerify
