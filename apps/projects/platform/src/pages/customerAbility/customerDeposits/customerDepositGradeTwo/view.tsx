...
import {
  getMemberCustomerDepositGradeTwoPage,
  postMemberCustomerDepositGradeTwoBatch,
...
const CustomerDepositGradeTwoIndex: React.FC<{}> = (props) => {
  ...
  const fetchListData = async (params: any) => {
    ...
    const res = await getMemberCustomerDepositGradeTwoPage(payload)
...
export default CustomerDepositGradeTwoIndex
