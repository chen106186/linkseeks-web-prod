...
import {
  ...
  getMemberCustomerDepositQualifyPage,
  postMemberCustomerDepositQualifyBatch,
} from '@apps/apis'
...
const CustomerDepositQualifyIndex: React.FC<{}> = (props) => {
  ...
  const fetchListData = async (params: any) => {
    ...
    const res = await getMemberCustomerDepositQualifyPage(payload)
...
export default CustomerDepositQualifyIndex
