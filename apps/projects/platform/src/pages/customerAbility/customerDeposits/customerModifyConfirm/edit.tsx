...
import { postMemberCustomerModifyConfirm, getMemberCustomerModifyConfirmDetail } from '@apps/apis'
import MemberProfile from '../../components/MemberProfile'
import VerifyModal, { ValueType as VerifyData } from '../../components/VerifyModal'

const CustomerModifyConfirmVerify: React.FC<{}> = () => {
  ...
  const handleSubmit = (value: VerifyData) => {
    ...
    postMemberCustomerModifyConfirm(
      {
        validateId,
        ...value,
      },
...
export default CustomerModifyConfirmVerify
