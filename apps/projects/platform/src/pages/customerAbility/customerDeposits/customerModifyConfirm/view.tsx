...
import {
  getMemberCustomerModifyConfirmPage,
  getMemberCustomerModifyPageConditions,
  postMemberCustomerModifyConfirmBatch,
} from '@apps/apis'
...
const CustomerModifyConfirmIndex: React.FC<{}> = (props) => {
  ...
  const fetchListData = async (params: any) => {
    ...
    const res = await getMemberCustomerModifyConfirmPage(payload)
...
export default CustomerModifyConfirmIndex
