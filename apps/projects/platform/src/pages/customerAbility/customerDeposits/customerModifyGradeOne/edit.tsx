...
import { postMemberCustomerModifyGradeOne, getMemberCustomerModifyGradeOneDetail } from '@apps/apis'
import MemberProfile from '../../components/MemberProfile'
import VerifyModal, { ValueType as VerifyData } from '../../components/VerifyModal'

const CustomerModifyGradeOneVerify: React.FC<{}> = () => {
  ...
  const handleSubmit = (value: VerifyData) => {
    ...
    postMemberCustomerModifyGradeOne(
      {
        validateId,
        ...value,
      },
...
export default CustomerModifyGradeOneVerify
