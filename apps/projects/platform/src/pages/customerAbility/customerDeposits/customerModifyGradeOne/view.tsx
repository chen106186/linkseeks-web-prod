...
import {
  getMemberCustomerModifyGradeOnePage,
  getMemberCustomerModifyPageConditions,
  postMemberCustomerModifyGradeOneBatch,
} from '@apps/apis'
...
const CustomerModifyGradeOneIndex: React.FC<{}> = (props) => {
  ...
  const fetchListData = async (params: any) => {
    ...
    const res = await getMemberCustomerModifyGradeOnePage(payload)
...
export default CustomerModifyGradeOneIndex
