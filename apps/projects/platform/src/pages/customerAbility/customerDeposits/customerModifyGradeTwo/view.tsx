...
import {
  getMemberCustomerModifyGradeTwoPage,
  postMemberCustomerModifyGradeTwoBatch,
...
const CustomerModifyGradeTwoIndex: React.FC<{}> = (props) => {
  ...
  const fetchListData = async (params: any) => {
    ...
    const res = await getMemberCustomerModifyGradeTwoPage(payload)
  ...
  const handleBatch = () => {
    ...
    confirm({
      ...
      content: intl.formatMessage({
        id: 'customerAbility.management.memberPrVerifyChange1.query.verify-tip',
        defaultMessage: '确定要审核通过选中的客户吗？',
      }),
      onOk() {
...
export default CustomerModifyGradeTwoIndex
