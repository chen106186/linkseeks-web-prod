            ...
            name: {
              ...
              'x-component-props': {
                placeholder: intl.formatMessage({
                  id: 'customerAbility.enterpriseBasicInfo.search',
                  defaultMessage: '搜索',
                }),
                tip: intl.formatMessage({
                  id: 'customerAbility.enterpriseBasicInfo.tip',
        ...
        [FORM_FILTER_PATH]: {
          ...
          properties: {
            outerStatus: {
              ...
              'x-component-props': {
                placeholder: intl.formatMessage({
                  id: 'customerAbility.enterpriseBasicInfo.reviewStatus',
            ...
            '[startDate, endDate]': {
              ...
              'x-component-props': {
                placeholder: intl.formatMessage({
                  id: 'customerAbility.enterpriseBasicInfo.timeFrame',
            ...
            submit: {
              ...
              'x-component-props': {
                children: intl.formatMessage({
                  id: 'customerAbility.enterpriseBasicInfo.inquire',
                  defaultMessage: '查询',
                }),
              },
            },
