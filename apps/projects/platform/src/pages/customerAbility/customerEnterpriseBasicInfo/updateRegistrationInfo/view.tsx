...
import { getMemberCustomerAbilityInfoDetail, postMemberCustomerAbilityInfoDetailUpdate } from '@apps/apis'
...
const MemberUpdate: React.FC<any> = (props) => {
  ...
  const getDetailedInfo = async () => {
    if (validateId) {
      setInfoLoading(true)
      const infoRes = await getMemberCustomerAbilityInfoDetail({
        validateId,
      })
  ...
  const handleSubmit = (values: any) => {
    ...
    postMemberCustomerAbilityInfoDetailUpdate({
      validateId,
      detail: values,
    })
      .then((res) => {
