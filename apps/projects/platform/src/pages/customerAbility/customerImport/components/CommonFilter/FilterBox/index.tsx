  ...
  return (
    <div className={styles.filter_box}>
      <div className={styles.filter_box_header} onClick={() => setExpand(!expand)}>
        <span>{title}</span>
        {
          expand ? <MinusOutlined translate={undefined} className={styles.filter_box_header_icon} /> : <PlusOutlined translate={undefined} className={styles.filter_box_header_icon} />
        }

      </div>
      {
        expand && (<div className={styles.filter_box_body}>
          {children}
        </div>)
      }
    </div>
