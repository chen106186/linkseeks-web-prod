...
const MemberIntroduceDrawer = (props: MemberIntroduceDrawerProps) => {
  ...
  const columns: ColumnType<MemberIntroduceType>[] = [
    {
      title: intl.formatMessage({ id: 'supplier.management.import.query.supplierId', defaultMessage: '客户ID' }),
      dataIndex: 'memberId',
      width: '15%',
    },
    {
      title: intl.formatMessage({ id: 'supplier.management.import.query.supplierName2', defaultMessage: '客户名称' }),
      dataIndex: 'name',
    },
    // {
