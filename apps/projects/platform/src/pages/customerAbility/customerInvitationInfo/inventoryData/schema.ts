    ...
    NO_DEPOSIT: {
      ...
      'x-component-props': {
        content: intl.formatMessage({
          id: 'customerAbility.invitationInfo.inventoryData.deposit.nothing',
        ...
        'x-component-props': {
          ...
          dataSource: [
            !validateId
              ? {
                  title: intl.formatMessage({
                    id: 'customerAbility.invitationInfo.inventoryData.warehousing.agreement',
            ...
            !validateId
              ? {
                  title: intl.formatMessage({
                    id: 'customerAbility.invitationInfo.inventoryData.step2',
            ...
            {
              title: intl.formatMessage({
                id: 'customerAbility.invitationInfo.inventoryData.step3',
            ...
            {
              title: intl.formatMessage({
                id: 'customerAbility.invitationInfo.inventoryData.step4',
            ...
            {
              title: intl.formatMessage({
                id: 'customerAbility.invitationInfo.inventoryData.step5',
                defaultMessage: '完成',
              }),
              name: 'step5',
            },
      ...
      step4: {
        ...
        properties: {
          INCOMING_INFO: {
            ...
            'x-component-props': {
              title: intl.formatMessage({
                id: 'customerAbility.invitationInfo.inventoryData.step3.qualities',
                defaultMessage: '上传资质证明',
              }),
              wrapProps: {
                style: {
