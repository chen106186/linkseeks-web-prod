...
import { getMemberCustomerInvitationReceivePage } from '@apps/apis'
...
const InvitationInfo: React.FC<{}> = () => {
  ...
  const tableColumns: ColumnsType = [
    {
      title: intl.formatMessage({
        id: 'customerAbility.invitationInfo.customerName',
        defaultMessage: '邀请方客户名称',
      }),
      dataIndex: 'memberName',
    },
    {
      title: intl.formatMessage({ id: 'customerAbility.invitationInfo.invitationTime', defaultMessage: '邀请时间' }),
      dataIndex: 'invitationTime',
    },
    {
      title: intl.formatMessage({
        id: 'customerAbility.invitationInfo.customerAbilityName',
        defaultMessage: '被邀请方供应商名称',
      }),
      dataIndex: 'subMemberName',
    },
    {
      title: intl.formatMessage({ id: 'customerAbility.invitationInfo.registeredAccount', defaultMessage: '注册账号' }),
      dataIndex: 'registerAccount',
    },
    {
      title: intl.formatMessage({ id: 'customerAbility.invitationInfo.registeredMail', defaultMessage: '注册邮箱' }),
      dataIndex: 'email',
    },
    {
      title: intl.formatMessage({ id: 'customerAbility.invitationInfo.registrationTime', defaultMessage: '注册时间' }),
      dataIndex: 'registerTime',
    },
    {
      title: intl.formatMessage({ id: 'customerAbility.invitationInfo.inviteCode', defaultMessage: '邀请码' }),
        ...
        <>
          {!row.fillInDepositoryDetail ? null : (
            <AuthButton type="custom" code="apply">
              <Link
                to={`/customerAbility/customerInvitationInfo/inventoryData/apply?upperMemberId=${row.upperMemberId}&upperRoleId=${row.upperRoleId}`}
              >
                <Button type="link">
                  {intl.formatMessage({
                    id: 'customerAbility.invitationInfo.incomingData',
  ...
  const getInvitationInfoList = async (params: InvitationInfoListItem) => {
    try {
      const res = await getMemberCustomerInvitationReceivePage({
        ...params,
