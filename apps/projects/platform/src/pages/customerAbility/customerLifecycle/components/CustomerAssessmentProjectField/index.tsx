...
interface CustomerAssessmentProjectFieldProps {}

const CustomerAssessmentProjectField = (props) => {
  const { value, schema, path } = props
  const componentProps: CustomerAssessmentProjectFieldProps = schema.getExtendsComponentProps() || {}
...
CustomerAssessmentProjectField.isFieldComponent = true

export default CustomerAssessmentProjectField
