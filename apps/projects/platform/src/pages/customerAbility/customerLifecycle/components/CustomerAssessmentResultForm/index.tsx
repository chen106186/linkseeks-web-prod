...
export interface CustomerAssessmentResultFormProps {
  /**
   * 值
   */
  value?: ValueType
...
export type CustomerAssessmentResultFormRef = {
  /**
   * 触发表单 submit 事件
   */
  submit: () => void
...
const CustomerAssessmentResultForm: React.ForwardRefRenderFunction<
  CustomerAssessmentResultFormRef,
  CustomerAssessmentResultFormProps
> = (props, ref) => {
...
const CustomerAssessmentResultFormForWard = React.forwardRef<
  CustomerAssessmentResultFormRef,
  CustomerAssessmentResultFormProps
>(CustomerAssessmentResultForm)

export default CustomerAssessmentResultFormForWard
