/*
 * @Description: 客户变更信息详情
 */
import React, { useContext, useEffect } from 'react'
import { useIntl } from '@linkseeks/i18n'
import { Row, Col } from 'antd'
import { getMemberCustomerAbilityMaintenanceDetailDepositHistoryPage } from '@apps/apis'
...
const CustomerChangedInfo = (props) => {
  ...
  const getInspectList = (params: FetchParamsType): Promise<ReponseType> => {
    return new Promise((resolve, reject) => {
      getMemberCustomerAbilityMaintenanceDetailDepositHistoryPage({
        validateId,
        ...params,
      })
        .then((res) => {
...
export default CustomerChangedInfo
