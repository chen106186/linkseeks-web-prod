...
import { postMemberCustomerLifecycleWaitAddAdd } from '@apps/apis'
...
const AddCustomerModifies: React.FC<any> = (props) => {
  ...
  const handleSubmit = (value: SubmitCallValueType): Promise<void> =>
    new Promise((resolve, reject) => {
      ...
      postMemberCustomerLifecycleWaitAddAdd(value)
        .then((res) => {
          if (res.code === 1000) {
            resolve()
            setTimeout(() => {
...
export default AddCustomerModifies
