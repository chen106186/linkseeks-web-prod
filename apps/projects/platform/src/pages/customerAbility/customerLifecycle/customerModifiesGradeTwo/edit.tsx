...
import { getMemberCustomerLifecycleSummaryDetail, postMemberCustomerLifecycleWaitAuditTwoAudit } from '@apps/apis'
...
const CustomerModifiesGradeTwoVerify: React.FC<IProps> = (props) => {
  ...
  const handleSubmit = (value: VerifyData) => {
    ...
    postMemberCustomerLifecycleWaitAuditTwoAudit(
      {
        id: +id,
        ...value,
      },
...
export default CustomerModifiesGradeTwoVerify
