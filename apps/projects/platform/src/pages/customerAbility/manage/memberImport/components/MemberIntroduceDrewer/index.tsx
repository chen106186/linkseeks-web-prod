...
const MemberIntroduceDrawer = (props: MemberIntroduceDrawerProps) => {
  ...
  const columns: ColumnType<MemberIntroduceType>[] = [
    {
      title: intl.formatMessage({ id: 'customerAbility.management.import.query.memberId', defaultMessage: '会员ID' }),
      dataIndex: 'memberId',
      width: '15%',
    },
    {
      title: intl.formatMessage({
        id: 'customerAbility.management.import.query.memberName2',
        defaultMessage: '会员名称',
      }),
      dataIndex: 'name',
    },
    {
      title: intl.formatMessage({
        id: 'customerAbility.management.import.query.memberTypeName',
        defaultMessage: '会员类型',
      }),
      dataIndex: 'memberTypeName',
    },
    {
      title: intl.formatMessage({ id: 'customerAbility.management.import.query.roleName', defaultMessage: '会员角色' }),
      dataIndex: 'roleName',
    },
    {
      title: intl.formatMessage({
        id: 'customerAbility.management.import.query.form.basic.level',
        defaultMessage: '会员等级',
      }),
      dataIndex: 'levelTag',
    },
  ...
  const handleConfirm = () => {
    if (!rowCtl.selectRow.length) {
      message.warning(
        intl.formatMessage({
          id: 'customerAbility.management.import.query.introduceDrewer.required',
          defaultMessage: '请选择会员',
        }),
      )
      return
    }
