...
const MemberArchiveInfo = (props) => {
  ...
  const inspectionColumns: EditableColumns<InspectListItemType>[] = [
    {
      title: intl.formatMessage({ id: 'customerAbility.management.maintain.detail.archivalInfo.inspect.index' }),
      dataIndex: 'id',
      render: (text, record, index) => index + 1,
    },
    {
      title: intl.formatMessage({ id: 'customerAbility.management.maintain.detail.archivalInfo.inspect.subject' }),
      dataIndex: 'subject',
      ellipsis: true,
    },
    {
      title: intl.formatMessage({
        id: 'customerAbility.management.maintain.detail.archivalInfo.inspect.inspectTypeName',
      }),
      dataIndex: 'inspectTypeName',
    },
    {
      title: intl.formatMessage({ id: 'customerAbility.management.maintain.detail.archivalInfo.inspect.inspectTime' }),
      dataIndex: 'inspectTime',
    },
    {
      title: intl.formatMessage({ id: 'customerAbility.management.maintain.detail.archivalInfo.inspect.score' }),
      dataIndex: 'score',
    },
  ]
  ...
  const AppraisalColumns: EditableColumns<AppraisalListItemType>[] = [
    {
      title: intl.formatMessage({ id: 'customerAbility.management.maintain.detail.archivalInfo.appraisal.index' }),
      render: (text, record, index) => index + 1,
    },
    {
      title: intl.formatMessage({ id: 'customerAbility.management.maintain.detail.archivalInfo.appraisal.subject' }),
      dataIndex: 'subject',
      ellipsis: true,
    ...
    {
      title: intl.formatMessage({
        id: 'customerAbility.management.maintain.detail.archivalInfo.appraisal.appraisalDayStart',
      }),
    ...
    {
      title: intl.formatMessage({
        id: 'customerAbility.management.maintain.detail.archivalInfo.appraisal.completeDay',
      }),
      dataIndex: 'completeDay',
    },
    {
      title: intl.formatMessage({ id: 'customerAbility.management.maintain.detail.archivalInfo.appraisal.totalScore' }),
  ...
  const RectifyColumns: EditableColumns<RectifyListItemType>[] = [
    {
      title: intl.formatMessage({ id: 'customerAbility.management.maintain.detail.archivalInfo.rectify.index' }),
      render: (text, record, index) => index + 1,
    },
    {
      title: intl.formatMessage({ id: 'customerAbility.management.maintain.detail.archivalInfo.rectify.subject' }),
      dataIndex: 'subject',
      ellipsis: true,
    },
    {
      title: intl.formatMessage({
        id: 'customerAbility.management.maintain.detail.archivalInfo.rectify.rectifyTimeStart',
      }),
      dataIndex: 'rectifyTimeStart',
    },
    {
      title: intl.formatMessage({
        id: 'customerAbility.management.maintain.detail.archivalInfo.rectify.rectifyTimeEnd',
      }),
      dataIndex: 'rectifyTimeEnd',
    },
    {
      title: intl.formatMessage({ id: 'customerAbility.management.maintain.detail.archivalInfo.rectify.result' }),
      dataIndex: 'result',
    },
  ]
  ...
  useEffect(() => {
    const anchors = [
      {
        key: 'categoryInfo',
        name: intl.formatMessage({ id: 'customerAbility.management.maintain.detail.categoryInfo' }),
      },
      ...
      {
        key: 'qualitiesInfo',
        name: intl.formatMessage({ id: 'customerAbility.management.maintain.detail.qualitiesInfo' }),
      },
      {
        key: 'inspectInfo',
        name: intl.formatMessage({ id: 'customerAbility.management.maintain.detail.inspectInfo' }),
      },
      {
        key: 'appraisalInfo',
        name: intl.formatMessage({ id: 'customerAbility.management.maintain.detail.appraisalInfo' }),
      },
      {
        key: 'rectifyInfo',
        name: intl.formatMessage({ id: 'customerAbility.management.maintain.detail.rectifyInfo' }),
      },
    ].filter(Boolean)
  ...
  const handleCategorySubmit: MemberDocCategoryProProps['onSubmit'] = (values) =>
    new Promise((resolve, reject) => {
      ...
      const msg = message.loading({
        content: intl.formatMessage({ id: 'customerAbility.components.MemberDocCategory.edit.message' }),
        duration: 0,
      })
        ...
        <Col span={24}>
          <div id="inspectInfo">
            <MemberDocTableList<InspectListItemType>
              title={intl.formatMessage({ id: 'customerAbility.management.maintain.detail.archivalInfo.inspect' })}
        ...
        <Col span={24}>
          <div id="appraisalInfo">
            <MemberDocTableList<AppraisalListItemType>
              title={intl.formatMessage({ id: 'customerAbility.management.maintain.detail.archivalInfo.appraisal' })}
          ...
          <Col span={24}>
            <div id="rectifyInfo">
              <MemberDocTableList<RectifyListItemType>
                title={intl.formatMessage({ id: 'customerAbility.management.maintain.detail.archivalInfo.rectify' })}
