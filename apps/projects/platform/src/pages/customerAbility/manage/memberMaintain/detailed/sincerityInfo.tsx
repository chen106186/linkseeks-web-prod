...
import {
  getMemberCustomerAbilityMaintenanceDetailCreditAftersaleHistoryPage,
  getMemberCustomerAbilityMaintenanceDetailCreditAftersaleSummary,
  getMemberCustomerAbilityMaintenanceDetailCreditBasic,
  getMemberCustomerAbilityMaintenanceDetailCreditComplainHistoryPage,
  getMemberCustomerAbilityMaintenanceDetailCreditComplainSummary,
  getMemberCustomerAbilityMaintenanceDetailCreditTradeHistoryPage,
  getMemberCustomerAbilityMaintenanceDetailCreditTradeSummary,
} from '@apps/apis'
...
const MemberSincerityInfo: React.FC<any> = (props) => {
  ...
  const getBasicInfo = () => {
    ...
    getMemberCustomerAbilityMaintenanceDetailCreditBasic({
      ...
      .then((res) => {
        ...
        const pieData = [
          {
            x: intl.formatMessage({ id: 'customerAbility.management.maintain.detail.sincerityInfo.tradeCommentPoint' }),
            y: tradeCommentPoint || 0,
          },
          {
            x: intl.formatMessage({
              id: 'customerAbility.management.maintain.detail.sincerityInfo.afterSaleCommentPoint',
            }),
            y: afterSaleCommentPoint || 0,
          },
          {
            x: intl.formatMessage({ id: 'customerAbility.management.maintain.detail.sincerityInfo.complainPoint' }),
            y: complainPoint || 0,
          },
          {
            x: intl.formatMessage({
              id: 'customerAbility.management.maintain.detail.sincerityInfo.registerYearsPoint',
            }),
  ...
  useEffect(() => {
    const anchors = [
      ...
      {
        key: 'orderEvaluation',
        name: intl.formatMessage({ id: 'customerAbility.management.maintain.detail.orderEvaluation' }),
      },
      {
        key: 'afterServiceEvaluation',
        name: intl.formatMessage({ id: 'customerAbility.management.maintain.detail.afterServiceEvaluation' }),
      },
      {
        key: 'feedbackRecords',
        name: intl.formatMessage({ id: 'customerAbility.management.maintain.detail.feedbackRecords' }),
      },
    ]
      ...
      <Row gutter={[16, 16]}>
        ...
        <Col span={24}>
          <div id="orderEvaluation">
            <MemberEvaluation
              title={intl.formatMessage({ id: 'customerAbility.management.maintain.detail.orderEvaluation' })}
        ...
        <Col span={24}>
          <div id="afterServiceEvaluation">
            <MemberEvaluation
              title={intl.formatMessage({ id: 'customerAbility.management.maintain.detail.afterServiceEvaluation' })}
