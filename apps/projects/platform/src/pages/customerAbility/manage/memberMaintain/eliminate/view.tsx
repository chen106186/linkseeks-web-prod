...
import {
  ...
  postMemberCustomerAbilityMaintenanceEliminate,
} from '@apps/apis'
...
const MemberMaintainEliminate: React.FC<{}> = () => {
  ...
  const handleSubmit = (values: ValueType) => {
    ...
    return postMemberCustomerAbilityMaintenanceEliminate({
  ...
  return (
    <Spin spinning={infoLoading}>
        ...
        extra={
          <Space size={16}>
            <Button icon={<StopOutlined />} onClick={() => setUnfriendModalVisible(true)}>
              {intl.formatMessage({ id: 'customerAbility.management.maintain.eliminate.remove' })}
            </Button>
          </Space>
        }
      >
      ...
      <Modal
        title={
          <div>
            {intl.formatMessage({ id: 'customerAbility.management.maintain.eliminate.remove.title' })}
            <Tooltip
              title={intl.formatMessage({
                id: 'customerAbility.management.maintain.eliminate.remove.title-description',
              })}
            >
