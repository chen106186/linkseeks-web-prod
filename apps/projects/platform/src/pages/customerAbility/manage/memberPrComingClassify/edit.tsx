...
import { postMemberDepositClassify, getMemberDepositClassifyDetail } from '@apps/apis'
...
const MemberPrComingClassifyVerify: React.FC<{}> = () => {
  ...
  const handleVerifySubmit = (value: VerifyData) => {
    ...
    const msg = message.loading({
      content: intl.formatMessage({ id: 'customerAbility.management.memberPrComingClassify.verify.commiting' }),
      duration: 0,
    })
...
export default MemberPrComingClassifyVerify
