...
import { postMemberModifyGradeOne, getMemberModifyGradeOneDetail } from '@apps/apis'
...
const MemberPrVerifyChange1Verify: React.FC<{}> = () => {
  ...
  const { data: dataSource, loading } = useHttpRequest(() => getMemberModifyGradeOneDetail({ validateId }), {
    manual: false,
  })
