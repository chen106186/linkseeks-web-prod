 ...
 * @LastEditTime: 2021-11-17 18:10:38
 * @Description: 审核入库(二级)
 */
...
import { getMemberDepositGradeTwoDetail, postMemberDepositGradeTwo } from '@apps/apis'
import MemberProfile from '../../components/MemberProfile'
import VerifyModal, { ValueType as VerifyData } from '../../components/VerifyModal'

const MemberPrVerifyComing2Verify: React.FC<{}> = () => {
  ...
  const { data: dataSource, loading } = useHttpRequest(() => getMemberDepositGradeTwoDetail({ validateId }), {
    manual: false,
  })
...
export default MemberPrVerifyComing2Verify
