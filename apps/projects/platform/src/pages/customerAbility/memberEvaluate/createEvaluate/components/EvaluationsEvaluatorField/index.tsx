...
interface EvaluationsEvaluatorFieldProps {}
...
const EvaluationsEvaluatorField = (props) => {
  const { schema, value, editable } = props
  const componentProps: EvaluationsEvaluatorFieldProps = schema.getExtendsComponentProps() || {}
...
EvaluationsEvaluatorField.isFieldComponent = true

export default EvaluationsEvaluatorField
