...
import { Tag, Badge, Tooltip, Typography, Card, Button } from '@linkseeks/ui'
...
import { getTradeAskPurchaseAskPurchaseQuoteDetail } from '@apps/apis'
import OffterTable from '../components/offterTable'
import Supplier from '../components/supplier'
import { innerStatusList, statusList } from '../../constats'
import PeripheralLayout from '@/components/DetailLayout'
import BasicLayout from '@/components/DetailLayout/components/basicLayout'
import { Context } from '@/components/DetailLayout/components/context'
...
const DemandDetailed = () => {
  ...
  useEffect(() => {
    if (id) {
      getTradeAskPurchaseAskPurchaseQuoteDetail({ id: id })
        .then((res) => {
          if (res.code !== 1000) {
            return
          }
