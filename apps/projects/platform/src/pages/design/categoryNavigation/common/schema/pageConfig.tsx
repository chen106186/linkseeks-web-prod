...
const template = {
  '6-1': {
    ...
    title: intl.formatMessage({ id: 'editor.category.second.title' }),
    addBtnText: intl.formatMessage({ id: 'editor.add.nav.btn' }),
    canDelete: false,
  ...
  '6-2': {
    ...
    title: intl.formatMessage({ id: 'editor.category.seckill' }),
    canDelete: false,
    addBtnText: intl.formatMessage({ id: 'editor.add.seckill.product.btn' }),
    childProps: {
      otherProps: {
        type: 'flashSaleItem',
      },
  ...
  '6-3': {
    componentName: 'SimpleCommodityList',
    title: intl.formatMessage({ id: 'editor.category.sales.rank' }),
    canDelete: false,
    addBtnText: intl.formatMessage({ id: 'editor.add.sales.product.btn' }),
    childComponentName: 'SimpleCommodityList.Item',
    childProps: {
      otherProps: {
  ...
  '6-4': {
    ...
    canDelete: false,
    addBtnText: intl.formatMessage({ id: 'editor.add.brand.btn' }),
  ...
  '6-5': {
    ...
    title: intl.formatMessage({ id: 'editor.nav.link.type.product' }),
    canDelete: false,
...
const header: PageConfigType = {
  ...
  '2': {
    ...
    title: intl.formatMessage({ id: 'editor.template.channel.header.data.mine' }),
    canEdit: false,
    canDelete: false,
    props: {
      data: {
  ...
  '3': {
    componentName: 'HeaderNav.ActionItem',
    title: intl.formatMessage({ id: 'editor.search.box' }),
    canEdit: false,
    canDelete: false,
    props: {
      data: {
        name: intl.formatMessage({ id: 'editor.search.box' }),
        content: '',
        status: true,
        type: 4,
      },
...
const tab: PageConfigType = {
  '4': {
    ...
    addBtnText: intl.formatMessage({ id: 'editor.add.tab.btn' }),
    childNodes: ['5'],
    childProps: {
      title: 'tab',
      props: {
  ...
  '5': {
    componentName: 'div',
    title: intl.formatMessage({ id: 'editor.channel.menu.home' }),
    props: {
