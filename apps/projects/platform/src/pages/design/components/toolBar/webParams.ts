...
const normalizeSortConfig = (currentComponent: VirtualDOMType, pageConfig: PageConfigType) => {
 ...
 * @returns
 */
export const getDesignParam = (pageConfig: PageConfigType, adornId: number, shopId: number, storeId?: number) => {
  ...
  sortConfig.forEach((ele, childKey) => {
    ...
    switch (item.componentName) {
      ...
      case WEB_DESIGN_COMPONENT.OwnMainNav:
        adornContent[WEB_DESIGN_COMPONENT.OwnMainNav] = {
          ...props,
          sort,
        }
        break
