...
function useCountDown(initialTime: number, format: 'DD:HH:mm:ss' | 'HH:mm:ss' | 'mm:ss') {
  ...
  //     setTime((prev) => ((prev! - backgroundTime.current - 1) > 0 ? (prev! - backgroundTime.current - 1) : 0!))
  //   }
  // }
