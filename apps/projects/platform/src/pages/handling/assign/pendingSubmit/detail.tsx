...
import { GetEnhanceSupplierToBeAddDetailsResponse, postEnhanceSupplierToBeSubmitSubmit } from '@apps/apis'
...
import { getEnhanceSupplierToBeAddDetails } from '@apps/apis'
...
const Info = () => {
  ...
  const handleSubmit = async () => {
    const { code, data } = await postEnhanceSupplierToBeSubmitSubmit({
      id: +id,
    })
    if (code === 1000) {
      history.back()
