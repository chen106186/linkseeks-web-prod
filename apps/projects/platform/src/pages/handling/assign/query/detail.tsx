...
import { getEnhanceSupplierAllDetails, GetEnhanceSupplierAllDetailsResponse } from '@apps/apis'
...
const Info = () => {
  ...
  const { loading, initialValue } = useInitialValue<GetEnhanceSupplierAllDetailsResponse, { id: string }>(
  ...
  const handleViewDetail = (record: GetEnhanceSupplierAllDetailsResponse['details'][0]) => {
    const dataProps = {
