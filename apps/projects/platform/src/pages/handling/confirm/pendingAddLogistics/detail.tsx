...
import { GetEnhanceProcessToBeAddDeliveryDetailsResponse } from '@apps/apis'
...
import { getEnhanceProcessToBeAddDeliveryDetails } from '@apps/apis'
...
const Info = () => {
  ...
  const { loading, initialValue } = useInitialValue<GetEnhanceProcessToBeAddDeliveryDetailsResponse, { id: string }>(
