...
const ReceivingAddress = () => {
  ...
  const actionRef = AddressManageModal.useRef({ type: ADDRESS_TYPE.DELIVERY })
  const actionHandle = AddressManageModal.useHandle({ actionRef })
  const columns: any[] = [
    {
      title: translate('web.resource.logistics.fahuorenxingming'),
      key: 'shipperName',
      dataIndex: 'shipperName',
    },
    {
      title: translate('web.resource.logistics.fahuodizhi'),
      key: 'fullAddress',
  ...
  return (
    <PageHeaderWrapper>
      <StandardFormTable
        columns={columns}
        request={getLogisticsShipperAddressPage}
        actionRef={tableRef}
        searchButtons={[
          {
            key: 'add',
