...
const columns_3 = () => {
  return [
    ...
    {
      title: (
        <Tooltip placement="top" title={intl.formatMessage({ id: 'marketingAbility.discountCommodity' })}>
          {intl.formatMessage({ id: 'marketingAbility.discount' })}
          <QuestionCircleOutlined />
        </Tooltip>
      ),
      key: 'discount',
      dataIndex: 'discount',
      render: (text) => text + `${intl.formatMessage({ id: 'marketingAbility.fold' })}`,
    },
    {
