...
const columns_8 = () => {
  return [
    ...
    {
      title: `${intl.formatMessage({ id: 'marketingAbility.openToBookingAPrice' })}`,
      key: 'activityPrice',
      dataIndex: 'activityPrice',
      render: (text) => `${intl.formatMessage({ id: 'common.money' })}${Number(text).toFixed(2)}`,
    },
    {
      title: `${intl.formatMessage({ id: 'marketingAbility.unitOfTheDeposit' })}`,
      key: 'activityPrice',
      dataIndex: 'activityPrice',
      render: (text) => `${intl.formatMessage({ id: 'common.money' })}${Number(text).toFixed(2)}`,
    },
    {
      title: `${intl.formatMessage({ id: 'marketingAbility.theDepositDeductionPrice' })}`,
      key: 'activityPrice',
      dataIndex: 'activityPrice',
      render: (text) => `${intl.formatMessage({ id: 'common.money' })}${Number(text).toFixed(2)}`,
    },
