 ...
 * @LastEditTime: 2021-09-26 14:32:13
 * @Description: 会员方块复选框
 */
                ...
                <div className={itemCls}>
                  <Row gutter={16} style={{ width: '100%' }}>
                    <Col span={6}>
                      <div className={styles['member-list-descriptions']}>
                        <div className={styles['member-list-descriptions-label']}>
                          {intl.formatMessage({ id: 'marketingAbility.huiyuanleixing' })}
                        </div>
                    ...
                    <Col span={6}>
                      <div className={styles['member-list-descriptions']}>
                        <div className={styles['member-list-descriptions-label']}>
                          {intl.formatMessage({ id: 'marketingAbility.huiyuanjuese' })}
                        </div>
                    ...
                    <Col span={6}>
                      <div className={styles['member-list-descriptions']}>
                        <div className={styles['member-list-descriptions-label']}>
                          {intl.formatMessage({ id: 'marketingAbility.dengjileixing' })}
                        </div>
                    ...
                    <Col span={6}>
                      <div className={styles['member-list-descriptions']}>
                        <div className={styles['member-list-descriptions-label']}>
                          {intl.formatMessage({ id: 'marketingAbility.dengjibiaoqian' })}
                        </div>
      ...
      {isShowMoreAction && (
        <div className={styles['member-list-more']}>
          <Button type="link" loading={loading} onClick={handleLoadMore}>
            {!loading
              ? `${intl.formatMessage({ id: 'marketingAbility.jiazaigengduo' })}`
              : `${intl.formatMessage({ id: 'marketingAbility.zhengzaijiazai' })}`}
          </Button>
        </div>
      )}
    </div>
