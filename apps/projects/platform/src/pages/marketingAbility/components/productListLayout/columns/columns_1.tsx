...
const columns_1 = ({ dataSource, setDataSource, handleDelete, form, current }) => {
  /** 输入  */
  const intl = getIntl()
      ...
      title: (
        <Tooltip
          ...
          title={intl.formatMessage({
            id: 'marketingAbility.huodongjiagebiaoshishangchengzhijieyigaishangpindehuodongjiagejinxingxiaoshou',
          })}
        >
          {intl.formatMessage({ id: 'marketingAbility.huodongjiage' })}
