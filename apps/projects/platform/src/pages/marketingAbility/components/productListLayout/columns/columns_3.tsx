...
const columns_3 = ({ dataSource, setDataSource, handleDelete, form, current }) => {
  /** 输入  */
  const intl = getIntl()
      ...
      title: (
        <Tooltip
          ...
          title={intl.formatMessage({
            id: 'marketingAbility.zhekouweishangpinjiagedezhekou，shurushuzi，ru85zhe，shuru85，9zheshuru90',
          })}
        >
        ...
        return (
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: `${intl.formatMessage({ id: 'marketingAbility.qingshuruzhekou' })}`,
              },
              () => ({
                validator: (_rule, value) => {
                  ...
                  if (!pattern.test(value)) {
                    return Promise.reject(
                      new Error(
                        `${intl.formatMessage({
                          id: 'marketingAbility.zhekoubixudayu0qiexiaoyu100zuiduobaoliu3weixiaoshu',
                        })}`,
                      ),
                    )
                  }
          ...
          >
            <Input
              ...
              onPressEnter={(e) => handleInputChange(e, 'discount', _index)}
              onBlur={(e) => handleInputChange(e, 'discount', _index)}
            />
          </Form.Item>
        )
      },
