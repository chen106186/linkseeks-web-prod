...
import DEFAULT_DATA from '../mock/index'
import { GetMarketingWebActivityPageGetResponse } from '@apps/apis'
...
import { getMarketingWebActivityPageGet } from '@apps/apis'
...
function useGetLayout() {
  ...
  useEffect(() => {
    ...
    async function setData() {
      ...
      /** 获取自定义区域请求体 */
      const customizeAreaRequestData = adornContent.suggestProduct.props.childrenData.reduce(
        (prev, next, _index) => {
          const labelsWithId = {}
