...
const DeliveryPlanAwaitSRMUpdate: React.FC = () => {
  ...
  const getAnchors = (_length: number | string) => {
    return [Circulation, base_Info, { ...PlanMaterial, len: _length }, Remarks]
  }
  ...
  const save = () => {
    form.validateFields().then((values) => {
      ...
      setSpinning(true)
      const orders = materialTableDataRef.current
...
export default DeliveryPlanAwaitSRMUpdate
