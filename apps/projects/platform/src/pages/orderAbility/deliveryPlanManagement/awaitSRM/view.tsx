    ...
    <Space>
      <AddAuthButton>
        <Button
          type="primary"
          icon={<PlusOutlined />}
          onClick={() => history.push(`/orderAbility/deliveryPlanManagement/awaitSRM/add`)}
        >
  ...
  const renderOptionButton = (record: any) => {
    ...
    const operationHandler = {
      ...
      [translate('web.common.edit')]: () =>
        history.push(`/orderAbility/deliveryPlanManagement/awaitSRM/edit?i=${godBtoa(record.id)}`),
      [translate('web.common.delete')]: () => handleDelete(record.id),
      [translate('web.common.preview')]: () =>
        history.push(`/orderAbility/deliveryPlanManagement/awaitSRM/detail?i=${godBtoa(record.id)}`),
    }
  ...
  const columns: ColumnType<unknown>[] = [
    {
      ...
      render: (text: unknown, record: any) => (
        <EyeAuthButton
          ...
          url={`/orderAbility/deliveryPlanManagement/awaitSRM/detail?i=${godBtoa(record.id)}`}
        >
          {text}
        </EyeAuthButton>
      ),
        ...
        <StandardTable
          ...
          controlRender={
            <NiceForm
              ...
              schema={deliveryPlanManagementAwaitSRMSchema}
            />
          }
        />
      </Card>
