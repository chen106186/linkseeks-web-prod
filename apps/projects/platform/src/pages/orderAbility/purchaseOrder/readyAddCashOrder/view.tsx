...
export interface ReadyAddCashOrderProps {}

const fetchTableData = async (params) => {
  const { data } = await getOrderBuyerCreatePurchasePage(params)
  return data
}

const ReadyAddCashOrder: React.FC<ReadyAddCashOrderProps> = () => {
  const intl = useIntl()
  ...
  const clickAdd = () => {
    // 现货采购 购物车下单
    history.push('/orderAbility/purchaseOrder/readyAddCashOrder/add')
  }
...
ReadyAddCashOrder.defaultProps = {}

export default ReadyAddCashOrder
