...
import '../index.less'
import { getOrderBuyerMaterielPage, postOrderBuyerCreateDeleteBatch, postOrderBuyerCreateSubmitBatch } from '@apps/apis'
...
export interface ReadyAddMaterialOrderProps {}

const fetchTableData = async (params) => {
  const { data } = await getOrderBuyerMaterielPage(params)
  return data
}

const ReadyAddMaterialOrder: React.FC<ReadyAddMaterialOrderProps> = () => {
  const intl = useIntl()
  ...
  const clickAdd = () => {
    // 物料订单下单
    history.push(`/orderAbility/purchaseOrder/readyAddMaterialOrder/add`)
  }
...
ReadyAddMaterialOrder.defaultProps = {}

export default ReadyAddMaterialOrder
