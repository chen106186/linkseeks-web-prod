...
import './index.less'
import { postSettlementAgentInvoiceMessageAdd, postSettlementAgentInvoiceMessageUpdate } from '@apps/apis'
...
const InvoiceModal: React.FC<InvoiceModalProps> = (props) => {
  ...
  const handleSubmit = async (value) => {
    ...
    const fn = mode === 'edit' ? postSettlementAgentInvoiceMessageUpdate : postSettlementAgentInvoiceMessageAdd
    await fn(params)
    resetForm()
    props.currentRef.current.setVisible(false)
