 ...
 * @LastEditTime: 2022-04-01 11:07:43
 * @LastEditors: GHua
 * @Description:
 */
...
const Category: React.FC<CategoryProps> = (props) => {
  ...
  const handleChange = (attrId: any, checkedList: any[]) => {
    if (filterType === FILTER_SEARCH_TYPE.url) {
      ...
      const firstDetail: any = getDetailById(attrId, attrId, 1)
  ...
  return categoryList && categoryList.length > 0 ? (
    <Fragment>
      <FilterBox title={intl.formatMessage({ id: 'filter.category.title' })}>
