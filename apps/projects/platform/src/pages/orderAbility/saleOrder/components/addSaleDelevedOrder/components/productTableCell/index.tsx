      ...
      case 'select': {
        return (
          <Select
            ...
            options={[
              { label: intl.formatMessage({ id: 'saleOrder.wuliu', defaultMessage: '物流' }), value: 1 },
              { label: intl.formatMessage({ id: 'saleOrder.ziti', defaultMessage: '自提' }), value: 2 },
              { label: intl.formatMessage({ id: 'saleOrder.wuxupeisong', defaultMessage: '无需配送' }), value: 3 },
            ]}
            {...formItemProps}
          />
        )
          ...
          rules={[
            ...
            },
            {
              ...
              message: intl.formatMessage({
                id: 'saleOrder.shouhuoshuliangjin',
                defaultMessage: '收货数量仅限三位小数',
              }),
            },
            {
            ...
            content={
              <Row>
                <div>
                  <div>
                    <EnvironmentOutlined />{' '}
                    {intl.formatMessage({ id: 'saleOrder.zitidizhi', defaultMessage: '自提地址' })}
                  </div>
                  {receiveInfo && (
                    <>
                      <p>
