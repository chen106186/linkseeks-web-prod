...
const ReadyCheckoutOrderDetail: React.FC = () => {
  const intl = useIntl()
  ...
  const handleSubmit = () => {
    ...
    document.querySelector('#page-header-main')?.scrollTo(0, deleveBox?.offsetTop)
  }
      ...
      <PageHeaderWrapper
        ...
        extra={
          <ChangeButtonCard
            ...
            authButtonCard={
              // <AuthButton type="custom" code="writeOff">
              <Button type="primary" onClick={handleSubmit}>
                {intl.formatMessage({ id: 'saleOrder.quhexiaozitidingdan' })}
              </Button>
              // </AuthButton>
            }
          />
...
export default ReadyCheckoutOrderDetail
