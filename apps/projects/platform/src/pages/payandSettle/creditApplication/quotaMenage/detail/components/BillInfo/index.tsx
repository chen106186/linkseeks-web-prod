                  ...
                  <div className={styles.dateWrap}>
                    <StatusTag
                      ...
                      title={intl.formatMessage({
                        id: 'payandSettle.creditApplication.quotaMenage.detail.components.billInfo.statusTag',
                    ...
                    <Descriptions column={1}>
                      <Descriptions.Item
                        label={intl.formatMessage({
                          id: 'payandSettle.creditApplication.quotaMenage.detail.components.billInfo.descriptions.1',
                        })}
                      >
                        {item.billQuota}
                      </Descriptions.Item>
                      <Descriptions.Item
                        label={intl.formatMessage({
                          id: 'payandSettle.creditApplication.quotaMenage.detail.components.billInfo.descriptions.2',
                        })}
                      >
                        {item.lastRepayDate}
                      </Descriptions.Item>
                      <Descriptions.Item
                        label={intl.formatMessage({
                          id: 'payandSettle.creditApplication.quotaMenage.detail.components.billInfo.descriptions.3',
                        })}
                      >
                        {item.lastRepayQuota}
                      </Descriptions.Item>
                      <Descriptions.Item
                        label={intl.formatMessage({
                          id: 'payandSettle.creditApplication.quotaMenage.detail.components.billInfo.descriptions.4',
                        })}
                      >
                        {item.payOffDate}
                      </Descriptions.Item>
                        ...
                        item.tradeList.map((trade) => (
                          <TradeWrap.TradeItem width="33.33%" key={trade.tradeCode}>
                            <Descriptions column={1}>
                              <Descriptions.Item
                                label={intl.formatMessage({
                                  id: 'payandSettle.creditApplication.quotaMenage.detail.components.billInfo.descriptions.5',
                                })}
                              >
                              ...
                              <Descriptions.Item
                                label={intl.formatMessage({
                                  id: 'payandSettle.creditApplication.quotaMenage.detail.components.billInfo.descriptions.6',
                                })}
                              >
                                <Row justify="space-between" style={{ width: '100%' }}>
                              ...
                              <Descriptions.Item
                                label={intl.formatMessage({
                                  id: 'payandSettle.creditApplication.quotaMenage.detail.components.billInfo.descriptions.7',
                                })}
                              >
                                {trade.tradeTime}
                              </Descriptions.Item>
