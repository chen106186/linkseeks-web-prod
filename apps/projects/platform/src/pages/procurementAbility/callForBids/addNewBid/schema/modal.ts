...
import type { ElementType } from '@/utils/createRegisterFieldSchema'
import { createRegisterFieldsSchema } from '@/utils/createRegisterFieldSchema'
  ...
  properties: {
    NO_SUBMIT: {
      ...
      properties: {
        publishShop: {
          type: 'checkbox',
          title: `{{help("${intl.formatMessage({
            id: 'detail.purchase.priceContrast3',
          })}", "${intl.formatMessage({ id: 'detail.purchase.tips2' })}")}}`,
          enum: [],
        },
      },
    },
      ...
      properties: {
        NO_SUBMIT_LAYOUT_1: {
          ...
          properties: {
            code: {
              type: 'string',
              title: intl.formatMessage({ id: 'table.purchase.materailNumber' }),
              'x-mega-props': {
                full: true,
              },
              'x-component-props': {
            ...
            name: {
              type: 'string',
              title: intl.formatMessage({ id: 'table.purchase.materailName' }),
              'x-component-props': {
                disabled: true,
