...
export const paramsRenderFn = (value) => {
  const _value = { ...value }
  value['inviteTenderShopList'] = _value['inviteTenderShopList']
...
// export const memberColumns: ColumnsType = [
//   {
...
// 招标物料列
export const materialInfoColumns: ColumnsType = [
  {
    title: 'ID',
    dataIndex: 'id',
    align: 'center',
...
// 招标方式 邀请会员列
export const inviteMemberColumns: ColumnsType = [
  {
    dataIndex: 'memberId',
    title: intl.formatMessage({ id: 'detail.purchase.memberId' }),
    align: 'center',
...
// 招标方式 邀请会员列弹窗
export const inviteMemberModalColumns: ColumnsType = [
  {
    dataIndex: 'memberId',
    title: intl.formatMessage({ id: 'detail.purchase.memberId' }),
    align: 'center',
