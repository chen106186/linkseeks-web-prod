...
import { postPurchaseInviteTenderGetSubmitTenderCheckQualificationsList } from '@apps/apis'
...
const fetchTableData = async (params) => {
  const { data } = await postPurchaseInviteTenderGetSubmitTenderCheckQualificationsList(
    {
      ...params,
    },
    { ctlType: 'none' },
