...
const DemandDetailed = () => {
  const { id, number, preview } = useQuery()
  ...
  const fetchDataSource = async () => {
    ...
    await getPurchasePurchaseInquiryDetails({ ...params } as any)
      .then((res) => {
        if (res.code !== 1000) {
          history.goBack()
          return
      ...
      <PeripheralLayout
        ...
        components={
          <Fragment>
            ...
            <MaterialLayout id={id as any} number={number as any} fetch={getPurchasePurchaseInquiryProductlistList} />
