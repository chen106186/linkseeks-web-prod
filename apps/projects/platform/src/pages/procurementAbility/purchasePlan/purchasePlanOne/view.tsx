...
import { getPurchasePurchasePlanToBeFirstExamList } from '@apps/apis'
...
const PurchasePlanOne = () => {
        ...
        <Space direction="vertical">
          <DetailAuthButton>
            <EyeAuthButton
              ...
              url={`/procurementAbility/purchasePlan/purchasePlanOne/detail?id=${record.id}`}
            >
              {text}
            </EyeAuthButton>
          </DetailAuthButton>
      ...
      render: (text: any, record: any) => (
        <>
          <AuthButton type="custom" code="audit">
            <Button
              type="link"
              onClick={() => history.push(`/procurementAbility/purchasePlan/purchasePlanOne/detail?id=${record.id}`)}
            >
  ...
  return (
    <Table
      ...
      fetch={getPurchasePurchasePlanToBeFirstExamList}
    />
  )
}
