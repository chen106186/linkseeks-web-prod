...
import { getPurchasePurchasePlanToBeSecondExamList } from '@apps/apis'
...
const PurchasePlanTwo = () => {
        ...
        <Space direction="vertical">
          <DetailAuthButton>
            <EyeAuthButton
              ...
              url={`/procurementAbility/purchasePlan/purchasePlanTwo/detail?id=${record.id}`}
            >
              {text}
            </EyeAuthButton>
          </DetailAuthButton>
      ...
      render: (text: any, record: any) => (
        <>
          <AuthButton type="custom" code="audit">
            <Button
              type="link"
              onClick={() => history.push(`/procurementAbility/purchasePlan/purchasePlanTwo/detail?id=${record.id}`)}
            >
  ...
  return (
    <Table
      ...
      fetch={getPurchasePurchasePlanToBeSecondExamList}
    />
  )
}
