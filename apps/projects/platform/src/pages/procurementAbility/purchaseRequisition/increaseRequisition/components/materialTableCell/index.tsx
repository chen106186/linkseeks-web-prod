      ...
      case 'select': {
        return (
          <Select
            ...
            options={[
              { label: intl.formatMessage({ id: 'purchaseRequisition.wuliu', defaultMessage: '物流' }), value: 1 },
              { label: intl.formatMessage({ id: 'purchaseRequisition.ziti', defaultMessage: '自提' }), value: 2 },
              {
                label: intl.formatMessage({ id: 'purchaseRequisition.wuxupeisong', defaultMessage: '无需配送' }),
                value: 3,
              },
            ]}
            {...formItemProps}
  ...
  const validatorNumber = (rule, value, callback) => {
    try {
      ...
      if (_value > Number.MAX_SAFE_INTEGER) {
        throw new Error(
          intl.formatMessage({ id: 'purchaseRequisition.shuzhijingduyi', defaultMessage: '数值精度溢出' }),
        )
      }
      callback()
    } catch (err) {
        ...
        return [
          {
            ...
            message: `${title}${intl.formatMessage({
              id: 'purchaseRequisition.bixutianxie',
              defaultMessage: '必须填写',
            })}`,
          },
          {
            ...
            message: intl.formatMessage({
              id: 'purchaseRequisition.caigoushuliangjin',
        ...
        return [
          {
            pattern: /^\d+(\.\d{1,4})?$/,
            message: intl.formatMessage({
              id: 'purchaseRequisition.danjiajinxiansi',
            ...
            content={
              <Row>
                <div>
                  <div>
                    <EnvironmentOutlined />{' '}
                    {intl.formatMessage({ id: 'purchaseRequisition.zitidizhi', defaultMessage: '自提地址' })}
                  </div>
                  {receiveInfo && (
                    <>
                      <p>
