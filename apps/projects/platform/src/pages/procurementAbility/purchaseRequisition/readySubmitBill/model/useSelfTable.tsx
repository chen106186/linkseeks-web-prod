...
export const useSelfTable = () => {
  ...
  const handleSubmit = (id) => {
    history.push(`/procurementAbility/purchaseRequisition/readySubmitBill/detail?id=${id}`)
  }

  /** 参照后台数据生成 */
  const renderOptionButton = (record: any) => {
    const btnAuthOfOperationTextMap = {
      [intl.formatMessage({ id: 'purchaseRequisition.shenhe', defaultMessage: '审核' })]: 'audit',
    }
