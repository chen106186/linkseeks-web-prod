...
import { postPurchaseSubmitTenderGetSubmitTenderQualificationsList } from '@apps/apis'
...
const fetchTableData = async (params) => {
  const { data } = await postPurchaseSubmitTenderGetSubmitTenderQualificationsList(
    {
      ...params,
    },
    { ctlType: 'none' },
