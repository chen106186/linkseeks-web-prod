...
import { getOrderQualityCollaborateDetail, getOrderQualityCollaborateGetInnerLog } from '@apps/apis'
...
const QualitySynergyDetail = (props) => {
  const { id } = useQuery()
    ...
    setBasicEffect([
      {
        col: [
          {
            label: intl.formatMessage({ id: 'quality.zhijiandanbianhao', defaultMessage: '质检单编号' }),
            extra: data?.qualityNo,
          },
          {
            label: intl.formatMessage({ id: 'quality.zhijiandanzhaiyao', defaultMessage: '质检单摘要' }),
            extra: data?.digest,
          },
          {
      ...
      },
      {
        col: [
          ...
          { label: intl.formatMessage({ id: 'quality.beizhu', defaultMessage: '备注' }), extra: data?.remark },
          {
            label: intl.formatMessage({ id: 'quality.shouhuodanhao', defaultMessage: '收货单号' }),
            extra: (
  ...
  const columns: ColumnType<any>[] = [
    ...(dataSource?.type === TYPE.SRM
      ? [
          ...
          {
            title: intl.formatMessage({ id: 'quality.wuliaomingcheng', defaultMessage: '物料名称' }),
            key: 'productName',
    ...
    {
      title: intl.formatMessage({ id: 'quality.shouhuoshuliang', defaultMessage: '收货数量' }),
      key: 'receiveCount',
    ...
    {
      title: intl.formatMessage({ id: 'quality.rangbujieshoushuliang', defaultMessage: '让步接收数量' }),
    ...
    ...(dataSource?.type === TYPE.B2B
      ? [
          {
            title: intl.formatMessage({ id: 'quality.shouhouzhuangtai', defaultMessage: '售后状态' }),
  ...
  return (
    <PageHeaderWrapper
      ...
      items={[
        { label: intl.formatMessage({ id: 'quality.jibenxinxi', defaultMessage: '基本信息' }), key: 'basicInfo' },
        {
          label:
            dataSource?.type === TYPE.SRM
        ...
        { label: intl.formatMessage({ id: 'quality.fujian', defaultMessage: '附件' }), key: 'attachment' },
        { label: intl.formatMessage({ id: 'quality.liuzhuanjilu', defaultMessage: '流转记录' }), key: 'recordLyout' },
      ]}
    >
      <Fragment>
        {/* 基本信息 */}
...
export default QualitySynergyDetail
