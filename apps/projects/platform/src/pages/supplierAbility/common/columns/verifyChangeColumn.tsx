...
const columns = (target = '/supplierAbility/manage/memberPrSubmit/detail'): ColumnType<any>[] => [
  {
    title: `${intl.formatMessage({ id: 'supplier.management.common.columns.supplierId' })}/${intl.formatMessage({
      id: 'member.management.common.columns.memberName',
    })}`,
    dataIndex: 'memberId',
    render: (text, record) => (
      <>
  ...
  {
    title: intl.formatMessage({ id: 'member.management.common.columns.memberTypeName' }),
    dataIndex: 'memberTypeName',
  },
  {
    title: intl.formatMessage({ id: 'member.management.common.columns.roleName' }),
    dataIndex: 'roleName',
  },
  {
