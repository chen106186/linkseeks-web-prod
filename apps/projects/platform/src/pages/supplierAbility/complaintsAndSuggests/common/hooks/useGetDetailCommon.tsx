...
function useGetDetailCommon({ initialValue }, isSupplier = false) {
  const intl = useIntl()
    ...
    return [
      ...
      },
      {
        title: isSupplier
          ...
          : translate('web.resource.member.gouyingshangmingchen'),
        value: isSupplier ? initialValue?.upperName : initialValue?.name,
      },
      {
