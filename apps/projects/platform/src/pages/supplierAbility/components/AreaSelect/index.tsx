...
const AreaSelect = (props) => {
  ...
  return (
    ...
    >
      <Row gutter={16}>
        <Col span={editable ? 8 : 'auto'}>
          <SelectItem
            placeholder={intl.formatMessage({ id: 'member.components.AreaSelect.province.placeholder' })}
            allowClear
            {...SelectProps}
            value={provinceValue}
        ...
        <Col span={editable ? 8 : 'auto'}>
          <SelectItem
            placeholder={intl.formatMessage({ id: 'member.components.AreaSelect.city.placeholder' })}
            allowClear
            {...SelectProps}
            value={cityValue}
            options={cityList}
        ...
        <Col span={editable ? 8 : 'auto'}>
          <SelectItem
            placeholder={intl.formatMessage({ id: 'member.components.AreaSelect.district.placeholder' })}
            allowClear
            {...SelectProps}
            value={districtValue}
