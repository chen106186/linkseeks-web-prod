...
const LevelInfo: React.FC<LevelInfoProps> = ({ levelInfo = {}, chartData = [], fetchList }) => {
  ...
  const columns: EditableColumns[] = [
    {
      title: intl.formatMessage({ id: 'member.components.LevelInfo.columns.id' }),
      dataIndex: 'id',
    },
    {
      title: intl.formatMessage({ id: 'member.components.LevelInfo.columns.ruleName' }),
      dataIndex: 'ruleName',
    },
    {
      title: intl.formatMessage({ id: 'member.components.LevelInfo.columns.score' }),
      dataIndex: 'score',
    },
    {
      title: intl.formatMessage({ id: 'member.components.LevelInfo.columns.createTime' }),
      dataIndex: 'createTime',
    },
    {
      title: intl.formatMessage({ id: 'member.components.LevelInfo.columns.remark' }),
      dataIndex: 'remark',
      ellipsis: true,
    },
  ]
  ...
  return (
    <div className={styles.levelInfo}>
      <Row gutter={[0, 24]}>
        ...
        <Col span={24}>
          <MellowCard
            title={intl.formatMessage({ id: 'member.components.LevelInfo.record.title' })}
            headStyle={{
              borderBottom: 'none',
            }}
          >
