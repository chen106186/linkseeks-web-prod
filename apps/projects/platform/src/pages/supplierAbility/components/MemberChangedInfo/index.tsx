...
const MemberChangedInfo: React.FC<IProps> = (props: IProps) => {
  ...
  const columns: EditableColumns[] = [
    {
      title: intl.formatMessage({ id: 'member.components.MemberChangedInfo.columns.id' }),
      dataIndex: 'id',
    },
    {
      title: intl.formatMessage({ id: 'member.components.MemberChangedInfo.columns.createTime' }),
      dataIndex: 'createTime',
    },
    {
      title: intl.formatMessage({
        id: 'member.components.MemberChangedInfo.columns.fieldLocalName',
      }),
      dataIndex: 'fieldLocalName',
      ellipsis: true,
    },
    {
      title: intl.formatMessage({ id: 'member.components.MemberChangedInfo.columns.lastValue' }),
      dataIndex: 'lastValue',
      ellipsis: true,
      render: (text, row) => {
    ...
    {
      title: intl.formatMessage({ id: 'member.components.MemberChangedInfo.columns.fieldValue' }),
  ...
  return (
    <MellowCard title={intl.formatMessage({ id: 'member.components.MemberChangedInfo.title' })} {...rest}>
      <PolymericTable
      ...
      {/** 普通图片抽屉 */}
      <ImgChangeDrawer visible={imgChangeProps.isShow} setVisible={handleShowImgChange} data={imgChangeProps.row} />
      {/* 查看变更列表弹窗 */}
      <DrawerListInfo
