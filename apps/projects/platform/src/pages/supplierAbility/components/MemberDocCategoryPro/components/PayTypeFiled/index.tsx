    ...
    switch (internalPayType) {
      ...
      case PAY_TYPE_PAYMENT_DAYS_DAY: {
        return (
          <>
            <Form.Item
              label={translate('web.resource.member.zhangqi_jigeyue')}
              name="month"
            ...
            <Form.Item
              label={translate('web.resource.member.jiesuanri_meiyuejihao')}
              name="monthDay"
              style={{ marginBottom: themeConfig['@margin-xs'] }}
              rules={[
                {
      ...
      case PAY_TYPE_PAYMENT_DAYS_MONTH: {
        return (
          <Form.Item
            label={translate('web.resource.member.zhangqi_jiangeduoshaotian')}
            name="days"
            rules={[
              {
                pattern: PATTERN_MAPS.quantity,
  ...
  const content = (
    <div>
      {`
        ...
        ${formValues?.month ? '：' + formValues.month + translate('web.resource.member.geyue') : ''}
        ${
          formValues?.monthDay
            ? translate('web.resource.member.jiesuanri') + formValues.monthDay + translate('web.common.hao')
            : ''
        }
        ${formValues?.days ? '：' + formValues.days + translate('web.common.tian') : ''}
      `}
    </div>
  )
