...
import {
  ...
  getMemberSupplierAbilityMaintenanceDetailRecordClassifyCategoryItems,
  getMemberSupplierAbilityMaintenanceDetailRecordClassifyCity,
  getMemberSupplierAbilityMaintenanceDetailRecordClassifyProvince,
...
const PROVINCE_API_MAP = {
  0: getMemberSupplierAbilityMaintenanceDetailRecordClassifyProvince,
  1: getMemberSupplierDepositClassifyProvince,
}
// 会员品类接口map
...
// 结算类型、发票类型接口map
const ITEMS_API_MAP = {
  0: getMemberSupplierAbilityMaintenanceDetailRecordClassifyCategoryItems,
  1: getMemberSupplierDepositClassifyCategoryItems,
}
// 城市接口map
const CITY_API_MAP = {
  0: getMemberSupplierAbilityMaintenanceDetailRecordClassifyCity,
  1: getMemberSupplierDepositClassifyCity,
}
  ...
  useEffect(() => {
    if ('value' in props && value) {
      ...
      const defaultCategoriesValue = [
        { categoryId: 0, children: [], level: 1, name: translate('web.common.all'), parentId: 0 },
      ]
