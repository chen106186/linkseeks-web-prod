            ...
            <Descriptions column={1}>
              ...
              >
                {(item[permanentName] !== 1 && item[dateFileName]) ||
                  intl.formatMessage({
                    id: 'member.components.MemberDocQualification.expireDay.nothing',
                  })}
              </Descriptions.Item>
              <Descriptions.Item
                label={intl.formatMessage({
                  id: 'member.components.MemberDocQualification.permanent',
                })}
...
const MemberDocQualification: React.FC<IProps> = (props: IProps) => {
  ...
  return (
    <MellowCard
      title={intl.formatMessage({ id: 'member.components.MemberDocQualification.title' })}
      extra={
        showNew && (
          <div>
            <span
