...
const MemberInvestigateInfo: React.FC<InvestigateInfoProps> = (props: InvestigateInfoProps) => {
  ...
  return (
    <MellowCard
      title={intl.formatMessage({ id: 'member.components.MemberInvestigateInfo.title' })}
      ...
      <Row gutter={16}>
        <Col span={8}>
          <Descriptions column={1}>
            <Descriptions.Item
              label={intl.formatMessage({ id: 'member.components.MemberInvestigateInfo.score' })}
            ...
            >
              <div className={styles['investigate-info-progress']}>
                ...
                <div className={styles['investigate-info-progress-text']}>
                  ...
                  {intl.formatMessage({ id: 'member.components.MemberInvestigateInfo.score.unit' })}
                </div>
              </div>
            </Descriptions.Item>
          </Descriptions>
        ...
        <Col span={8}>
          <Descriptions column={1}>
            <Descriptions.Item
              label={intl.formatMessage({ id: 'member.components.MemberInvestigateInfo.inspectDay' })}
              labelStyle={{ width: 106 }}
            >
              {dataSource?.inspectDay}
            </Descriptions.Item>
            <Descriptions.Item
              label={intl.formatMessage({ id: 'member.components.MemberInvestigateInfo.result' })}
              labelStyle={{ width: 106 }}
        ...
        <Col span={8}>
          <Descriptions column={1}>
            <Descriptions.Item
              label={intl.formatMessage({ id: 'member.components.MemberInvestigateInfo.reports' })}
              labelStyle={{ width: 106 }}
