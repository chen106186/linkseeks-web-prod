...
const MemberRightsAnalysis: React.FC<IProps> = (props: IProps) => {
  ...
  return (
    <div className={styles.equityInfo} {...rest}>
      <Row gutter={16}>
        <Col span={12}>
          <MellowCard title={intl.formatMessage({ id: 'member.components.MemberRightsAnalysis.returnMoney' })}>
            <div className={styles.container}>
              <div className={styles['container-content']}>
                <div className={styles.exhibition}>
                  <div className={styles['exhibition-left']}>
                    <div className={styles['exhibition-title']}>
                      {intl.formatMessage({ id: 'member.components.MemberRightsAnalysis.sumReturnMoney' })}
                    </div>
        ...
        <Col span={12}>
          <MellowCard title={intl.formatMessage({ id: 'member.components.MemberRightsAnalysis.point' })}>
            <div className={styles.container}>
              <div className={styles['container-content']}>
                <div className={styles.exhibition}>
                  <div className={styles['exhibition-left']}>
                    <div className={styles['exhibition-title']}>
                      {intl.formatMessage({ id: 'member.components.MemberRightsAnalysis.sumUsedPoint' })}/
                      {intl.formatMessage({ id: 'member.components.MemberRightsAnalysis.sumPoint' })}
                    </div>
                    <div className={styles['exhibition-amount']}>
