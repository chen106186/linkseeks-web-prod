    ...
    <div className={styles.sincerityInfo} {...rest}>
      <Spin spinning={!!loading}>
        <Row gutter={16}>
          <Col flex="386px">
            <MellowCard
              title={intl.formatMessage({ id: 'member.components.MemberSincerityAnalysis.title' })}
              fullHeight
            >
              <Pie
                hasLegend
                subTitle={intl.formatMessage({ id: 'member.components.MemberSincerityAnalysis.pie.subTitle' })}
