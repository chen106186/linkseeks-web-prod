...
import {
  ...
  postMemberSupplierAbilityMaintenanceBlacklist,
} from '@apps/apis'
...
const MemberMaintainBlack: React.FC<{}> = () => {
  ...
  const handleSubmit = (values: ValueType) => {
    ...
    return postMemberSupplierAbilityMaintenanceBlacklist({
  ...
  return (
    <Spin spinning={infoLoading}>
      ...
      <Modal
        title={
          <div>
            {intl.formatMessage({ id: 'supplier.management.maintain.black.getBlocked.title' })}
            <Tooltip
              title={intl.formatMessage({ id: 'member.management.maintain.black.getBlocked.title-description' })}
            >
