...
import {
  ...
  postMemberSupplierAbilityMaintenanceFreeze,
} from '@apps/apis'
...
const MemberMaintainUnfreeze: React.FC<{}> = () => {
  ...
  const handleSubmit = (values: ValueType) => {
    ...
    return postMemberSupplierAbilityMaintenanceFreeze({
  ...
  return (
    <Spin spinning={infoLoading}>
      ...
      >
        ...
        {/* 解冻相关 */}
        <Modal
          title={intl.formatMessage({ id: 'supplier.management.maintain.unfreeze.unfreeze.title' })}
