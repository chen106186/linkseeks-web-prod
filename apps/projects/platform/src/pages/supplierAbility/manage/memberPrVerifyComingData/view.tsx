...
import {
  getMemberSupplierDepositVerifyPage,
  postMemberSupplierDepositVerifyBatch,
...
const MemberPrVerifyComingData: React.FC<any> = (props) => {
  ...
  const fetchListData = async (params: any) => {
    ...
    const res = await getMemberSupplierDepositVerifyPage(payload)
