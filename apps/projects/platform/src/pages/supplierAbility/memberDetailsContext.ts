...
import { GetMemberSupplierAbilityMaintenanceDetailBasicResponse } from '@apps/apis'
import { AnchorsItem } from '@/components/AnchorPage'

export type MemberDetails = GetMemberSupplierAbilityMaintenanceDetailBasicResponse & {}
