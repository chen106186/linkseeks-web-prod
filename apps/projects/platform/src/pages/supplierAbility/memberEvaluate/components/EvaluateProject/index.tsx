...
import TableModal from '@/pages/supplierAbility/components/TableModal'
// import { getMemberSupplierAppraisalItemConfigPage } from '@apps/apis';
...
const EvaluateProject: React.FC<Iprops> & { isFieldComponent: boolean } = (props: Iprops) => {
  ...
  const handleFetchData = useCallback(async (params: any): Promise<any> => {
    // const { data, code } = await getMemberSupplierAppraisalItemConfigPage(params);
    // if (code === 1000) {
    //   return data;
    // }
