...
import { getMemberSupplierAppraisalWaitGradePage, GetMemberAppraisalWaitGradePageResponseDetail } from '@apps/apis'
...
const defaultColumns = setColumnsByLinks(
  {
    detail: '/supplierAbility/memberEvaluate/tobeEvaluate/detail',
  },
  ['totalScore'],
)
...
const List: React.FC<Iprops> = (props: Iprops) => {
    ...
    [
      {
        ...
        render: (_text, _record) => (
          <DetailAuthButton>
            <Space>
              <Link to={`/supplierAbility/memberEvaluate/tobeEvaluate/detail?id=${_record.id}`}>
                {intl.formatMessage({
  ...
  const handleFetch = async (params) => {
    const result = fetchListData(getMemberSupplierAppraisalWaitGradePage, params)
    return result
  }
