...
import {
  getMemberSupplierAppraisalWaitAuditTwoGet,
  GetMemberAppraisalWaitAuditTwoGetResponse,
  postMemberSupplierAppraisalWaitAuditTwoAudit,
} from '@apps/apis'
...
const TobeEvaluateDetail = () => {
  ...
  const onSubmit = async (values: SubmitDataTypes) => {
    const { data, code } = await postMemberSupplierAppraisalWaitAuditTwoAudit({
      id: +id,
      agree: values.status,
