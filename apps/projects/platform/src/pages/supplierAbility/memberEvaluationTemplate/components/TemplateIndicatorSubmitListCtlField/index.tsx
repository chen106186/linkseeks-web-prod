...
import {
  getMemberSupplierScoringIndicatorToAssignedPage,
  GetMemberSupplierScoringIndicatorToAssignedPageRequest,
} from '@apps/apis'
...
const TemplateIndicatorSubmitListCtlField = (props: any) => {
  ...
  const getUnassignedEvaluationTemplates = async (
    params: GetMemberSupplierScoringIndicatorToAssignedPageRequest,
  ): Promise<any> => {
    try {
      const res = await getMemberSupplierScoringIndicatorToAssignedPage({ ...params })
