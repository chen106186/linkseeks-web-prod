...
import { getMemberSupplierRectifyStatusList } from '@apps/apis'
...
export default function useColumns<T>(
  ...
  const fetchStatusOptions = useCallback(async () => {
    const defaultApi = (defaultOptions && defaultOptions.fetchStatusListApi) || getMemberSupplierRectifyStatusList
