...
import {
  getMemberSupplierInspectMembers,
  GetMemberInspectMembersResponse,
  getMemberSupplierRectifyWaitAddGet,
  GetMemberRectifyWaitAddGetResponse,
  postMemberSupplierRectifyWaitAddAdd,
  postMemberSupplierRectifyWaitAddUpdate,
} from '@apps/apis'
...
import { postMemberSupplierLifecycleArchivesManagementPage, GetMemberInspectMembersRequest } from '@apps/apis'
...
const InspectionAdd = (props) => {
  ...
  const { memberColumns, memberSchema } = useGetCommonSubMember(getMemberSupplierInspectMembers)
  ...
  const handleSubmit = useCallback(
    async (value: SubmitData) => {
      ...
      const service = isEdit ? postMemberSupplierRectifyWaitAddUpdate : postMemberSupplierRectifyWaitAddAdd
