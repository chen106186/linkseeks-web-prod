    ...
    tabs: {
      ...
      properties: {
            ...
            MEGA_LAYOUT1: {
              ...
              properties: {
                ...
                memberRole: {
                  ...
                  required: true,
                  title: intl.formatMessage({
                    id: 'supplier.supplierFlowRule.components.FlowRuleForm.form.basic.supplierRole',
                  }),
        ...
        'tab-2': {
          ...
          'x-component': 'TabPane',
          'x-component-props': {
            tab: intl.formatMessage({ id: 'supplier.supplierFlowRule.components.FlowRuleForm.form.flow' }),
          },
          properties: {
            MEGA_LAYOUT1: {
              type: 'object',
        ...
        'tab-5': {
          ...
          'x-component': 'TabPane',
          'x-component-props': {
            tab: intl.formatMessage({ id: 'supplier.supplierFlowRule.components.FlowRuleForm.form.changed' }),
          },
          properties: {
            MEGA_LAYOUT1: {
              type: 'object',
              ...
              properties: {
                changedProcessId: {
                  type: 'string',
                  title: intl.formatMessage({
                    id: 'member.memberFlowRule.components.FlowRuleForm.form.changed.changedProcessId',
                  }),
                  'x-component': 'FlowListFormItem',
                  'x-component-props': {
                    dataSource: [],
