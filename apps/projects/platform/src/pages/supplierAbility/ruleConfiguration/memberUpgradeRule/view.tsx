...
import { getMemberSupplierAbilityLevelRulePage, postMemberSupplierAbilityLevelRuleUpdatescore } from '@apps/apis'
...
const MemberUpgradeRule: React.FC<[]> = () => {
  ...
  const getRuleList = async (params) => {
    setListLoading(true)
    const res = await getMemberSupplierAbilityLevelRulePage(params)
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const res = await postMemberSupplierAbilityLevelRuleUpdatescore({
        items: payload,
      })
