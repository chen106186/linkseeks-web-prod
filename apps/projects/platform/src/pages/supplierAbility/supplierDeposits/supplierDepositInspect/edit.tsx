...
import { getMemberSupplierDepositInspectDetail, postMemberSupplierDepositInspect } from '@apps/apis'
import MemberProfile from '../../components/MemberProfile'
import VerifyComingInvestigateDrawer, { ValueType } from './components/VerifyComingInvestigateDrawer'

const SupplierDepositInspectVerify: React.FC<{}> = () => {
  ...
  const handleSubmit = (value: ValueType) => {
    ...
    postMemberSupplierDepositInspect(payload, {
      timeout: 0,
    })
      .then((res) => {
        if (res.code !== 1000) {
...
export default SupplierDepositInspectVerify
