...
import {
  getMemberSupplierAbilityMaintenanceDetailAppraisalPage,
  getMemberSupplierAbilityMaintenanceDetailInspectPage,
  getMemberSupplierAbilityMaintenanceDetailRecord,
  GetMemberSupplierAbilityMaintenanceDetailRecordResponse,
  getMemberSupplierAbilityMaintenanceDetailRectifyPage,
...
const SupplierArchivesInfo = (props) => {
  const { validateId } = props
  const [archiveInfo, setArchiveInfo] = useState<GetMemberSupplierAbilityMaintenanceDetailRecordResponse>()
...
export default SupplierArchivesInfo
