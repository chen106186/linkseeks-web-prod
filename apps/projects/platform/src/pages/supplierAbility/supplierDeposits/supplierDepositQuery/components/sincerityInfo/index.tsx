...
import {
  getMemberSupplierAbilityMaintenanceDetailCreditAftersaleHistoryPage,
  getMemberSupplierAbilityMaintenanceDetailCreditAftersaleSummary,
  getMemberSupplierAbilityMaintenanceDetailCreditBasic,
  getMemberSupplierAbilityMaintenanceDetailCreditComplainHistoryPage,
  getMemberSupplierAbilityMaintenanceDetailCreditComplainSummary,
  getMemberSupplierAbilityMaintenanceDetailCreditTradeHistoryPage,
  getMemberSupplierAbilityMaintenanceDetailCreditTradeSummary,
} from '@apps/apis'
...
const SupplierSincerityInfo: React.FC<any> = (props) => {
...
export default SupplierSincerityInfo
