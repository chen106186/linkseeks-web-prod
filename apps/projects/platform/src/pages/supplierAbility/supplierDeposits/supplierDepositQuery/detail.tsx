...
const SupplierArchivesDetails: React.FC<any> = (props) => {
  ...
  const { isConfigMember, isConfigMemberLoading } = useCheckConfigMember(validateId, 'supplier')
  ...
  const _renderChildren = () => {
    switch (key) {
      ...
      case 'supplier':
        return <Supplier id={id} validateId={validateId} />
      default:
        break
    }
  }
...
export default SupplierArchivesDetails
