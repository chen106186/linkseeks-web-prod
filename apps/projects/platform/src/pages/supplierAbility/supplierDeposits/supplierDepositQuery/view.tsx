...
const SupplierDepositQuery: React.FC<any> = (props) => {
  ...
  const defaultColumns: ColumnType<PostMemberSupplierAbilityMaintenancePageResponseDetail>[] = [
    ...
    {
      title: intl.formatMessage({
        id: 'supplier.management.maintain.query.registerTime',
      }),
    ...
    {
      title: intl.formatMessage({
        id: 'supplier.management.maintain.query.supplierCode',
      }),
...
export default SupplierDepositQuery
