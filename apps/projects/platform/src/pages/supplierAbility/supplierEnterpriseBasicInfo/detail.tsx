...
import {
  ...
  getMemberSupplierAbilityLevelSubConfiguration,
  GetMemberSupplierAbilityInfoDetailBasicResponse,
} from '@apps/apis'
...
const MemberQueryDetailed: React.FC<any> = (props) => {
  ...
  const tabsFilter = () => {
    getMemberSupplierAbilityLevelSubConfiguration({ validateId }).then((res) => {
      if (res.code === 1000) {
