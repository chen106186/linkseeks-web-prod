        ...
        topLayout: {
          ...
          properties: {
            ...
            name: {
              ...
              'x-component': 'Search',
              'x-component-props': {
                placeholder: intl.formatMessage({ id: 'supplier.enterpriseBasicInfo.search', defaultMessage: '搜索' }),
                tip: translate('web.resource.member.tip_guishugongyingshangmingchen'),
              },
            },
          },
        },
        [FORM_FILTER_PATH]: {
          ...
          properties: {
            outerStatus: {
              ...
              'x-component-props': {
                placeholder: intl.formatMessage({
                  id: 'supplier.enterpriseBasicInfo.reviewStatus',
                  defaultMessage: '审核状态(全部)',
                }),
                allowClear: true,
                style: {
                  width: 160,
            ...
            '[startDate, endDate]': {
              ...
              'x-component-props': {
                placeholder: intl.formatMessage({
                  id: 'supplier.enterpriseBasicInfo.timeFrame',
            ...
            submit: {
              ...
              'x-component-props': {
                children: intl.formatMessage({ id: 'supplier.enterpriseBasicInfo.inquire', defaultMessage: '查询' }),
              },
            },
          },
        },
