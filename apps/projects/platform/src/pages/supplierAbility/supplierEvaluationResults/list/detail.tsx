...
import { getMemberSupplierAppraisalResultGet, GetMemberSupplierAppraisalResultGetResponse } from '@apps/apis'
...
const EvaluateDetail = () => {
  ...
  const { loading, initialValue } = useInitialValue<GetMemberSupplierAppraisalResultGetResponse, { id: string }>(
