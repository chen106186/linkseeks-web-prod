...
import { getMemberSupplierAppraisalResultPage, GetMemberSupplierAppraisalResultPageResponseDetail } from '@apps/apis'
...
const List: React.FC<any> = () => {
  ...
  const commonColumns: ColumnsType<GetMemberSupplierAppraisalResultPageResponseDetail> = [
    {
