...
import type { GetMemberSupplierAbilitySubPageResponseDetail } from '@apps/apis'
...
const SupplierImportIndex: React.FC<any> = (props) => {
  ...
  const defaultColumns: ColumnType<GetMemberSupplierAbilitySubPageResponseDetail>[] = [
    {
    ...
    {
      title: intl.formatMessage({
        id: 'supplier.profile.registerAccount',
        defaultMessage: '注册账号',
      }),
      dataIndex: 'account',
    },
