...
import { ElementType } from '@/utils/createRegisterFieldSchema'
            ...
            invitationCodeState: {
              ...
              'x-component-props': {
                placeholder: intl.formatMessage({
                  id: 'supplier.import.invite.query.invitationCodeState.placeholder',
                  defaultMessage: '邀请状态',
                }),
                allowClear: true,
              },
        ...
        [FORM_FILTER_PATH]: {
          ...
          properties: {
            '[startDate, endDate]': {
              ...
              'x-component-props': {
                placeholder: intl.formatMessage({
                  id: 'supplier.import.invite.dateRange',
                  defaultMessage: '邀请时间',
                }),
                allowClear: true,
                style: {
