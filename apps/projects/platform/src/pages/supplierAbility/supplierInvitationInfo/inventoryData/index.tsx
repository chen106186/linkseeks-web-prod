  ...
  const handleSubmit = (values: ValueType) => {
    ...
    const msg = message.loading({
      content: intl.formatMessage({
        id: 'supplier.invitationInfo.inventoryData.save.message',
    ...
    <Spin spinning={loading || agreementLoading}>
      <PageHeaderWrapper
        ...
        title={`${
          !validateId
            ? intl.formatMessage({
                id: 'supplier.supplierQuery.applysupplier.apply',
                defaultMessage: '我收到的邀请信息',
              })
            : intl.formatMessage({ id: 'supplier.supplierQuery.applysupplier.change', defaultMessage: '变更供应商' })
        }`}
        extra={
          <Space>
            {currenStep === 0 && !validateId ? (
              ...
              >
                {`${intl.formatMessage({
                  id: 'supplier.invitationInfo.inventoryData.agress',
            ...
            {currenStep === 1 ? (
              <>
                {!validateId && (
                  ...
                  >
                    {intl.formatMessage({
                      id: 'supplier.supplierQuery.applysupplier.step1.prev',
                      defaultMessage: '上一步：供应商入库协议',
                    })}
                  </Button>
                )}
                <Button
                ...
                >
                  {intl.formatMessage({
                    id: 'supplier.invitationInfo.inventoryData.step1.next',
            ...
            {currenStep === 2 ? (
              <>
                ...
                {!validateId && (
                  ...
                  >
                    {intl.formatMessage({
                      id: 'supplier.invitationInfo.inventoryData.step2.prev',
                ...
                >
                  {intl.formatMessage({
                    id: 'supplier.invitationInfo.inventoryData.step2.next',
            ...
            {currenStep === 3 ? (
              <>
                ...
                >
                  {intl.formatMessage({
                    id: 'supplier.invitationInfo.inventoryData.step3.prev',
                ...
                >
                  {intl.formatMessage({
                    id: 'supplier.invitationInfo.inventoryData.step3.next',
                    defaultMessage: '确认提交',
                  })}
                </Button>
              </>
