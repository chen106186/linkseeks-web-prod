...
export interface SupplierAssessmentProjectFormProps {
  /**
   * 值
   */
  value?: ValueType
...
export type SupplierAssessmentProjectFormRef = {
  /**
   * 触发表单 submit 事件
   */
  submit: () => void
...
const SupplierAssessmentProjectForm: React.ForwardRefRenderFunction<
  SupplierAssessmentProjectFormRef,
  SupplierAssessmentProjectFormProps
> = (props, ref) => {
...
const SupplierAssessmentProjectFormForWard = React.forwardRef<
  SupplierAssessmentProjectFormRef,
  SupplierAssessmentProjectFormProps
>(SupplierAssessmentProjectForm)

export default SupplierAssessmentProjectFormForWard
