...
import SupplierAssessmentProjectField from '../../../components/SupplierAssessmentProjectField'
import { convertDataToGroups } from '../../../components/SupplierAssessmentProjectForm/utils'
import ModifiesEvaluatorField, { EvaluatorValueType } from '../../../components/ModifiesEvaluatorField'
import SupplierAssessmentHistoryVirtualField from '../SupplierAssessmentHistoryVirtualField'
...
interface SupplierModifiesFormProps {
  /**
   * title
   */
  title: string
...
const SupplierModifiesForm: React.FC<SupplierModifiesFormProps> = (props) => {
      ...
      >
        <NiceForm
          ...
          components={{
            ...
            FormilyUploadFiles,
            AnchorPageItemCard,
            SupplierSelect: SupplierSelectField,
            SupplierAssessmentProject: SupplierAssessmentProjectField,
            SupplierAssessmentHistory: SupplierAssessmentHistoryVirtualField,
...
export default SupplierModifiesForm
