...
import { getMemberSupplierLifecycleSummaryDetail, postMemberSupplierLifecycleWaitConfirmConfirm } from '@apps/apis'
...
const SupplierModifiesConfirmVerify: React.FC<any> = (props) => {
  ...
  const handleSubmit = (value: VerifyData) => {
    ...
    postMemberSupplierLifecycleWaitConfirmConfirm(
      {
        id: +id,
        ...value,
      },
...
export default SupplierModifiesConfirmVerify
