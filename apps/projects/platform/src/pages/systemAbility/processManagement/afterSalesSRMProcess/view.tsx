...
import {
  getOrderPurchaseProcessAfterSaleSrmPage,
...
const ProcessList = () => {
  ...
  const columns: ColumnType<any>[] = [
    _processId,
    _name(`/systemAbility/processManagement/afterSalesSRMProcess/detail?id=`),
    {
      ..._processName,
    ...
    _isDefault(
      intl.formatMessage({
        id: 'processRuleSetting.dangcaigoushouhoudantijiaoshi',
        defaultMessage: '当采购售后单提交时',
      }),
    ),
    _createTime,
    ...
    _operation({ urlKey: 'afterSalesSRMProcess' }, (processId: any) => {
  ...
  return (
    <TableLayout
      reload={ref}
      columns={columns}
      fetch={getOrderPurchaseProcessAfterSaleSrmPage}
      schema={schema}
      controllerBtns={controllerBtns('add', '/systemAbility/processManagement/afterSalesSRMProcess/add')}
      rowKey="processId"
    />
  )
}
