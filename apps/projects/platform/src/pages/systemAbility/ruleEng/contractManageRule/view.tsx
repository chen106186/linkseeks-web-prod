...
import { getContractRuleEngineProcessPage } from '@apps/apis'
...
const ContractManageRule: React.FC = () => {
  ...
  const renderOptionButton = (record: any) => {
    ...
    const operationHandler = {
      配置: () => {
        configOperationHandler(record, 'CONTRACT_MANAGE')
      },
    }
    return (
      <TableOperation
  ...
  const columns: ColumnType<any>[] = [
    ...
    {
      ...column_processName,
      title: translate('web.resource.system.hetongguanliliuchengmingcheng'),
    },
    // 状态
    column_status,
    // 操作时间
  ...
  return <CommonTable fetchApi={getContractRuleEngineProcessPage} columns={columns} />
}
