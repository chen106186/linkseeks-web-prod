...
import { getProductMaterialProcessEnginePage } from '@apps/apis'
...
const BuyingRequisitionRule: React.FC = () => {
  ...
  const renderOptionButton = (record: any) => {
    ...
    const operationHandler = {
      配置: () => {
        configOperationHandler(record, 'MATERIAL_MANAGE')
      },
    }
    return (
      <TableOperation
  ...
  const columns: ColumnType<any>[] = [
    ...
    {
      ...column_processName,
      title: translate('web.resource.system.wuliaoliuchengmingcheng'),
    },
    // 状态
    column_status,
    // 操作时间
  ...
  return <CommonTable fetchApi={getProductMaterialProcessEnginePage} columns={columns} />
}
