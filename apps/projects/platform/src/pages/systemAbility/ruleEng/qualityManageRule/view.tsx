...
import { getOrderQualityProcessEnginePage } from '@apps/apis'
...
const ProcessRule: React.FC = () => {
  const renderOptionButton = (record: any) => {
    ...
    const operationHandler = {
      配置: () => {
        configOperationHandler(record, 'QUALITY_MANAGE')
      },
    }
    return (
      <TableOperation
  ...
  return <CommonTable fetchApi={getOrderQualityProcessEnginePage} columns={columns} />
}
