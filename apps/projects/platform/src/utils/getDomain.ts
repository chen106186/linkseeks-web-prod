 ...
 * 获取顶域
 */
export const getTopDomain = (defaultTopDomain: string = 'lingxidev.com', isPort: boolean = false) => {
  return location.host ? getTopDomainByHost(location.host, isPort) : defaultTopDomain
}
