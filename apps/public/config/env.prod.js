const env = {
  BACK_GATEWAY: process.env.BACK_GATEWAY || 'https://yunjinglian.com',
  YAPI_REQUEST_BACK_GATEWAY:
    process.env.YAPI_REQUEST_BACK_GATEWAY || process.env.BACK_GATEWAY || 'https://yunjinglian.com',
  SOCKET_URL: process.env.SOCKET_URL || 'wss://yunjinglian.com',
