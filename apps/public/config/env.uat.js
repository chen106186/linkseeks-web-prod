const env = {
  BACK_GATEWAY: process.env.BACK_GATEWAY || 'http://lingxi-gateway-uat-2023-v3.shushangyun.com:12880',
  YAPI_REQUEST_BACK_GATEWAY:
    process.env.YAPI_REQUEST_BACK_GATEWAY ||
    process.env.BACK_GATEWAY ||
    'http://lingxi-gateway-uat-2023-v3.shushangyun.com:12880',
  SOCKET_URL: process.env.SOCKET_URL || 'ws://lingxi-gateway-uat-2023-v3.shushangyun.com:12880',
  SITE_URL: process.env.SITE_URL || 'http://lingxi-www-uat-2023-v3.shushangyun.com:12880',
  MEMBER_URL: process.env.MEMBER_URL || 'http://lingxi-platform-uat-2023-v3.shushangyun.com:12880',
