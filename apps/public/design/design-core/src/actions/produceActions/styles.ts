...
export const changeStylesByKey = (payload: { style: any; key: string }) =>
  createActions({
    type: ACTION_TYPES.changeStylesByKey,
    payload,
  })
...
export const resizeChange = (payload: ResizePayload) => createActions({ type: ACTION_TYPES.resizeChange, payload })
