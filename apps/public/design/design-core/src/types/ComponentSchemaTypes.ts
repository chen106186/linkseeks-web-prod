import { NODE_PROPS_TYPES, PROPS_TYPES, PROPS_SETTING_TYPES } from './ConfigTypes'
...
export interface PropInfoType {
  ...
  label?: string
  //属性的类型
  type: PROPS_TYPES | PROPS_SETTING_TYPES | PROPS_TYPES[]
  //属性的功能的描述信息
  tip?: string
...
export interface ComponentSchemaType extends Omit<NodeProps, 'type' | 'tip' | 'params' | 'label'> {
