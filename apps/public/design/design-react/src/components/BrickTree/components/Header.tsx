...
import { SelectedInfoBaseType } from '@apps/design-core'
...
function Header(props: HeaderProps) {
  ...
  const { selectedInfo, hoverKey } = useSelector<any, any>(['selectedInfo', 'hoverKey'], (prevState, nextState) =>
  ...
  return (
    ...
    >
      <div
        onClick={() => handleSelectedStatus(null, isSelected, specialProps, propName)}
