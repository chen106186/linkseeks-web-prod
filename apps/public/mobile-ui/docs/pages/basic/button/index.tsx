...
import { ShareAppMessageReturn, getEnv, ENV_TYPE, showModal, showToast } from '@tarojs/taro'
        ...
        <View className="doc-body">
          ...
          <View className="panel">
            ...
            <View className="panel__content">
              ...
              <View className="btn-item">
                <Button type="primary" loading onClick={this.onButtonClick.bind(this)}>
                  Loading
                </Button>
              </View>
              <View className="btn-item">
            ...
            <View className="panel">
              ...
              <View className="panel__content">
                ...
                <View className="btn-demo-fab">
                  <Fab onClick={this.onButtonClick.bind(this)}>
          ...
          {isWEAPP && (
            <View className="panel">
              ...
              <View className="panel__content">
                ...
                <View className="btn-item">
                  <Button openType="getUserInfo" onGetUserInfo={this.onGetUserInfo.bind(this)} type="primary">
                    登录授权
                  </Button>
                </View>
                <View className="btn-item">
                  <Button openType="contact" onContact={this.onContact.bind(this)} type="secondary">
                    联系 Taro UI 客服
                  </Button>
                </View>
                <View className="btn-item">
                  <Button openType="openSetting" onOpenSetting={this.onOpenSetting.bind(this)} type="secondary">
                    打开设置
                  </Button>
                </View>
                <View className="btn-item">
