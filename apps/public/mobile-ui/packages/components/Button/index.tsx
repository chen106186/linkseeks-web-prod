...
import { GodButtonProps, GodButtonState } from '../../types/button'
...
export default class GodButton extends React.Component<GodButtonProps, GodButtonState> {
  public static defaultProps: GodButtonProps
  public static propTypes: InferProps<GodButtonProps>

  public constructor(props: GodButtonProps) {
    super(props)
    this.state = {
  ...
  public render(): JSX.Element {
    ...
    const loadingSize = size === 'small' ? 12 : 24

    let loadingComponent: JSX.Element | null = null
    if (loading) {
      loadingComponent = (
        <View className="at-button__icon">
          <GodLoading color={loadingColor} size={loadingSize} />
        </View>
      )
      rootClassName.push('at-button--icon')
    }

    const webButton = <Button className="at-button__wxbutton" lang={lang} formType={formType}></Button>
