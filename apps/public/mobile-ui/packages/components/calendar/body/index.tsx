...
import { AtCalendarBodyListGroup, AtCalendarBodyProps, AtCalendarBodyState, Calendar } from '../../../types/calendar'
...
export default class AtCalendarBody extends React.Component<AtCalendarBodyProps, Readonly<AtCalendarBodyState>> {
  ...
  private getGroups = (generateDate: number, selectedDate: Calendar.SelectedDate): AtCalendarBodyListGroup => {
    ...
    const nowList: Calendar.ListInfo<Calendar.Item> = this.generateFunc(generateDate, selectedDate, true)
  ...
  public render(): JSX.Element {
    ...
    const { isAnimate, offsetSize, listGroup, isSelect, isHolidaySelect, holidays, disableDays, disableWeek } =
      this.state

    if (!isSwiper) {
      return (
        <View className={classnames('main', 'at-calendar-slider__main', `at-calendar-slider__main--${ENV}`)}>
          <AtCalendarDayList />
          <View className="main__body body">
            <View className="body__slider body__slider--now">
              <AtCalendarDateList
                ...
                isSelect={isSelect}
                isHolidaySelect={isHolidaySelect}
                holidays={holidays}
    ...
    if (IS_WEB) {
      return (
        <View
          className={classnames('main', 'at-calendar-slider__main', `at-calendar-slider__main--${ENV}`)}
