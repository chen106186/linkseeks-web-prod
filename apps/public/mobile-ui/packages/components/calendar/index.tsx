...
> {
  ...
  private handleDayClick = (item: Calendar.Item): void => {
    ...
    const { isDisabled, isDisableDays, isDisabledWeek, isDisabledHolidays, value } = item

    if (isDisabled) return
    if (isDisabledWeek || isDisableDays || isDisabledHolidays) return
    ...
    if (typeof this.props.onDayClick === 'function') {
      this.props.onDayClick({ value: item.value, isDisableDays: item.isDisableDays, isDisabled: item.isDisabled } as any)
    }
  }
  ...
  private handleDayLongClick = (item: Calendar.Item): void => {
    if (typeof this.props.onDayLongClick === 'function') {
      this.props.onDayLongClick({ value: item.value, isDisableDays: item.isDisableDays, isDisabled: item.isDisabled } as any)
    }
  }
