...
import { GodDrawerProps, GodDrawerState } from '../../types/drawer'
...
export default class AtDrawer extends React.Component<
  ...
  GodDrawerState
> {
  public static propTypes: InferProps<GodDrawerProps>
  public static defaultProps: GodDrawerProps

  public constructor(props: GodDrawerProps) {
    super(props)
    this.state = {
      animShow: false,
      _show: props.show
  ...
  public UNSAFE_componentWillReceiveProps(nextProps: GodDrawerProps): void {
