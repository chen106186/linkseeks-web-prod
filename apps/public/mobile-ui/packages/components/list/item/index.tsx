...
import { GodListItemProps } from '../../../types/list'
import { mergeStyle } from '../../../common/utils'

export default class GodListItem extends React.Component<GodListItemProps> {
  public static defaultProps: GodListItemProps
  public static propTypes: InferProps<GodListItemProps>
