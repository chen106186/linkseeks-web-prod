...
import { GodSearchBarProps, GodSearchBarState } from '../../types/search-bar'
...
export default class GodSearchBar extends React.Component<
  GodSearchBarProps,
  GodSearchBarState
> {
  public static defaultProps: GodSearchBarProps
  public static propTypes: InferProps<GodSearchBarProps>

  public constructor(props: GodSearchBarProps) {
    super(props)
    this.state = {
      isFocus: !!props.focus
    }
