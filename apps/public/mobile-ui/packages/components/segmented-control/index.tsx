...
import { GodSegmentedControlProps } from '../../types/segmented-control'
import { mergeStyle, pxTransform } from '../../common/utils'

export default class GodSegmentedControl extends React.Component<
  GodSegmentedControlProps
> {
  public static defaultProps: GodSegmentedControlProps
  public static propTypes: InferProps<GodSegmentedControlProps>
...
GodSegmentedControl.defaultProps = {
  customStyle: '',
  className: '',
  current: 0,
  color: '',
