...
import { GodStepsProps } from '../../types/steps'

export default class GodSteps extends React.Component<GodStepsProps> {
  public static defaultProps: GodStepsProps
  public static propTypes: InferProps<GodStepsProps>
