...
import { GodSwitchProps } from '../../types/switch'

export default class GodSwitch extends React.Component<GodSwitchProps> {
  public static defaultProps: GodSwitchProps
  public static propTypes: InferProps<GodSwitchProps>
