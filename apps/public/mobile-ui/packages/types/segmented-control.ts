...
export interface GodSegmentedControlProps extends GodComponent {
  /**
...
declare const GodSegmentedControl: ComponentClass<GodSegmentedControlProps>

export default GodSegmentedControl
