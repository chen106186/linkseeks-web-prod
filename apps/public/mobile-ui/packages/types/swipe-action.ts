...
export interface GodSwipeActionProps extends GodComponent {
  /**
   * 是否开启
   * @default false
   */
...
export interface GodSwipeActionState {
  componentId: string
  offsetSize: number
  _isOpened: boolean
  moveXH5: number
...
export interface GodSwipeActionOptionsProps extends GodComponent {
  componentId: string
  options: SwipeActionOption[]
}

declare const GodSwipeAction: ComponentClass<GodSwipeActionProps>

export default GodSwipeAction
