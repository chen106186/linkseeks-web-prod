...
export interface SharedConfig {
  /**
   * 是否需要生成 接口——分类id的 映射文件， 用于 babel-yapi-import-plugin收集
   *
   * @default false
   */
   ...
   * 是否需要自动分割文件夹
   *
   * 按照tags分割, 或者按照id分割, 会自动创建文件夹，通过index返回, 默认为true。
   *
   * @example 'src/api/xxx/index.ts'
   */
  allowAutoSpitFile?: boolean
